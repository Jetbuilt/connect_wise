...
> <Array(<SkillInfo>, Integer, Hash)> get_system_skills_by_id_info_with_http_info(id, client_id, opts)
...
> <Array<SkillInfo>> get_system_skills_info(client_id, opts)
