...
| [**get_system_workflows_triggers**](WorkflowTriggersApi.md#get_system_workflows_triggers) | **GET** /system/workflows/triggers | Get List of WorkflowTrigger |
...
## get_system_workflows_triggers

> <Array<WorkflowTrigger>> get_system_workflows_triggers(client_id, opts)
...
begin
  # Get List of WorkflowTrigger
  result = api_instance.get_system_workflows_triggers(client_id, opts)
  p result
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowTriggersApi->get_system_workflows_triggers: #{e}"
end
```

#### Using the get_system_workflows_triggers_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<WorkflowTrigger>>, Integer, Hash)> get_system_workflows_triggers_with_http_info(client_id, opts)

```ruby
begin
  # Get List of WorkflowTrigger
  data, status_code, headers = api_instance.get_system_workflows_triggers_with_http_info(client_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<WorkflowTrigger>>
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowTriggersApi->get_system_workflows_triggers_with_http_info: #{e}"
end
```
