...
| [**get_system_workflows_events**](WorkflowEventsApi.md#get_system_workflows_events) | **GET** /system/workflows/events | Get List of WorkflowEvent |
| [**get_system_workflows_events_by_id**](WorkflowEventsApi.md#get_system_workflows_events_by_id) | **GET** /system/workflows/events/{id} | Get WorkflowEvent |
...
## get_system_workflows_events

> <Array<WorkflowEvent>> get_system_workflows_events(client_id, opts)
...
begin
  # Get List of WorkflowEvent
  result = api_instance.get_system_workflows_events(client_id, opts)
  p result
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowEventsApi->get_system_workflows_events: #{e}"
end
```

#### Using the get_system_workflows_events_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<WorkflowEvent>>, Integer, Hash)> get_system_workflows_events_with_http_info(client_id, opts)

```ruby
begin
  # Get List of WorkflowEvent
  data, status_code, headers = api_instance.get_system_workflows_events_with_http_info(client_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<WorkflowEvent>>
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowEventsApi->get_system_workflows_events_with_http_info: #{e}"
end
```
...
## get_system_workflows_events_by_id

> <WorkflowEvent> get_system_workflows_events_by_id(id, client_id, opts)
...
begin
  # Get WorkflowEvent
  result = api_instance.get_system_workflows_events_by_id(id, client_id, opts)
  p result
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowEventsApi->get_system_workflows_events_by_id: #{e}"
end
```

#### Using the get_system_workflows_events_by_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WorkflowEvent>, Integer, Hash)> get_system_workflows_events_by_id_with_http_info(id, client_id, opts)

```ruby
begin
  # Get WorkflowEvent
  data, status_code, headers = api_instance.get_system_workflows_events_by_id_with_http_info(id, client_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WorkflowEvent>
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowEventsApi->get_system_workflows_events_by_id_with_http_info: #{e}"
end
```
