...
> <Array(<Array<WorkflowNotifyType>>, Integer, Hash)> get_system_workflows_notify_types_with_http_info(client_id, opts)
...
> <Array<WorkflowNotifyType>> get_system_workflows_notify_types_by_id(id, client_id, opts)
