# ConnectWise::AccountingUnpostedProcurementTaxableLevelsApi
...
#### Using the get_finance_accounting_unpostedprocurement_by_parent_id_taxable_levels_with_http_info variant
