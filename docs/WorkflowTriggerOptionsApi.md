...
| [**get_system_workflows_triggers_options**](WorkflowTriggerOptionsApi.md#get_system_workflows_triggers_options) | **GET** /system/workflows/triggers/options | Get List of WorkflowTriggerOption |
...
## get_system_workflows_triggers_options

> <Array<WorkflowTriggerOption>> get_system_workflows_triggers_options(client_id, opts)
...
begin
  # Get List of WorkflowTriggerOption
  result = api_instance.get_system_workflows_triggers_options(client_id, opts)
  p result
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowTriggerOptionsApi->get_system_workflows_triggers_options: #{e}"
end
```

#### Using the get_system_workflows_triggers_options_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<WorkflowTriggerOption>>, Integer, Hash)> get_system_workflows_triggers_options_with_http_info(client_id, opts)

```ruby
begin
  # Get List of WorkflowTriggerOption
  data, status_code, headers = api_instance.get_system_workflows_triggers_options_with_http_info(client_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<WorkflowTriggerOption>>
rescue ConnectWise::ApiError => e
  puts "Error when calling WorkflowTriggerOptionsApi->get_system_workflows_triggers_options_with_http_info: #{e}"
end
```
