...
api_instance = ConnectWise::CatalogsItemApi.new
client_id = 'client_id_example' # String | 
catalog_item = ConnectWise::CatalogItem.new({identifier: 'identifier_example', description: 'description_example', customer_description: 'customer_description_example'}) # CatalogItem | catalogItem
