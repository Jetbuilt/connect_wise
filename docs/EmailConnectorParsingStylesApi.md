...
parent_id = 56 # Integer | emailConnectorId
client_id = 'client_id_example' # String | 
email_connector_parsing_style = ConnectWise::EmailConnectorParsingStyle.new({parse_rule: 'parse_rule_example', priority: 37}) # EmailConnectorParsingStyle | emailConnectorParsingStyle
