...
> <Array(<RmaStatusInfo>, Integer, Hash)> get_procurement_rma_statuses_by_id_info_with_http_info(id, client_id, opts)
...
> <Array<RmaStatusInfo>> get_procurement_rma_statuses_info(client_id, opts)
