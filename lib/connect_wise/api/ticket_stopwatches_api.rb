  ...
  class TicketStopwatchesApi
    ...
    def delete_time_ticketstopwatches_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketStopwatchesApi.delete_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.delete_time_ticketstopwatches_by_id"
      end
    ...
    def get_time_ticketstopwatches_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches"
      end
    ...
    def get_time_ticketstopwatches_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_by_id"
      end
    ...
    def get_time_ticketstopwatches_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_count"
      end
    ...
    def patch_time_ticketstopwatches_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_time_ticketstopwatches_by_id_with_http_info(id, client_id, patch_operation,
                                                                                       opts)
      data
    end
    ...
    def patch_time_ticketstopwatches_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
    ...
    def post_time_ticketstopwatches_with_http_info(client_id, ticket_stopwatch, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.post_time_ticketstopwatches"
      end
      # verify the required parameter 'ticket_stopwatch' is set
      if @api_client.config.client_side_validation && ticket_stopwatch.nil?
        raise ArgumentError,
              "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.post_time_ticketstopwatches"
      end
    ...
    def put_time_ticketstopwatches_by_id(id, client_id, ticket_stopwatch, opts = {})
      data, _status_code, _headers = put_time_ticketstopwatches_by_id_with_http_info(id, client_id, ticket_stopwatch,
                                                                                     opts)
      data
    end
    ...
    def put_time_ticketstopwatches_by_id_with_http_info(id, client_id, ticket_stopwatch, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'ticket_stopwatch' is set
      if @api_client.config.client_side_validation && ticket_stopwatch.nil?
        raise ArgumentError,
              "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
