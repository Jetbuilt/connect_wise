  ...
  class TicketStopwatchesApi
    ...
    def delete_time_ticketstopwatches_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.delete_time_ticketstopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.delete_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.delete_time_ticketstopwatches_by_id"
      end
      # resource path
    ...
    def get_time_ticketstopwatches_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.get_time_ticketstopwatches ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches"
      end
      # resource path
    ...
    def get_time_ticketstopwatches_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.get_time_ticketstopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/ticketstopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_time_ticketstopwatches_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.get_time_ticketstopwatches_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.get_time_ticketstopwatches_count"
      end
      # resource path
    ...
    def patch_time_ticketstopwatches_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.patch_time_ticketstopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling TicketStopwatchesApi.patch_time_ticketstopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/ticketstopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_time_ticketstopwatches_with_http_info(client_id, ticket_stopwatch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.post_time_ticketstopwatches ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.post_time_ticketstopwatches"
      end
      # verify the required parameter 'ticket_stopwatch' is set
      if @api_client.config.client_side_validation && ticket_stopwatch.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.post_time_ticketstopwatches"
      end
      # resource path
      local_var_path = '/time/ticketstopwatches'
    ...
    def put_time_ticketstopwatches_by_id_with_http_info(id, client_id, ticket_stopwatch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketStopwatchesApi.put_time_ticketstopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
      # verify the required parameter 'ticket_stopwatch' is set
      if @api_client.config.client_side_validation && ticket_stopwatch.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_stopwatch' when calling TicketStopwatchesApi.put_time_ticketstopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/ticketstopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
