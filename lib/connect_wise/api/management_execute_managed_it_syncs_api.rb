...
module ConnectWise
  class ManagementExecuteManagedItSyncsApi
    ...
    def post_company_management_by_id_execute_managed_it_sync(id, client_id, opts = {})
      data, _status_code, _headers = post_company_management_by_id_execute_managed_it_sync_with_http_info(id,
                                                                                                          client_id, opts)
      data
    end
    ...
    def post_company_management_by_id_execute_managed_it_sync_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ManagementExecuteManagedItSyncsApi.post_company_management_by_id_execute_managed_it_sync ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ManagementExecuteManagedItSyncsApi.post_company_management_by_id_execute_managed_it_sync"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ManagementExecuteManagedItSyncsApi.post_company_management_by_id_execute_managed_it_sync"
      end
