  ...
  class CustomReportsApi
    ...
    def delete_system_custom_reports_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.delete_system_custom_reports_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomReportsApi.delete_system_custom_reports_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.delete_system_custom_reports_by_id"
      end
      # resource path
    ...
    def get_system_custom_reports_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.get_system_custom_reports ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.get_system_custom_reports"
      end
      # resource path
    ...
    def get_system_custom_reports_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.get_system_custom_reports_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomReportsApi.get_system_custom_reports_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.get_system_custom_reports_by_id"
      end
      # resource path
      local_var_path = '/system/customReports/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_system_custom_reports_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.get_system_custom_reports_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.get_system_custom_reports_count"
      end
      # resource path
    ...
    def patch_system_custom_reports_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.patch_system_custom_reports_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomReportsApi.patch_system_custom_reports_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.patch_system_custom_reports_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CustomReportsApi.patch_system_custom_reports_by_id"
      end
      # resource path
      local_var_path = '/system/customReports/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_system_custom_reports_with_http_info(client_id, custom_report, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.post_system_custom_reports ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.post_system_custom_reports"
      end
      # verify the required parameter 'custom_report' is set
      if @api_client.config.client_side_validation && custom_report.nil?
        fail ArgumentError, "Missing the required parameter 'custom_report' when calling CustomReportsApi.post_system_custom_reports"
      end
      # resource path
      local_var_path = '/system/customReports'
    ...
    def put_system_custom_reports_by_id_with_http_info(id, client_id, custom_report, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomReportsApi.put_system_custom_reports_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CustomReportsApi.put_system_custom_reports_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CustomReportsApi.put_system_custom_reports_by_id"
      end
      # verify the required parameter 'custom_report' is set
      if @api_client.config.client_side_validation && custom_report.nil?
        fail ArgumentError, "Missing the required parameter 'custom_report' when calling CustomReportsApi.put_system_custom_reports_by_id"
      end
      # resource path
      local_var_path = '/system/customReports/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
