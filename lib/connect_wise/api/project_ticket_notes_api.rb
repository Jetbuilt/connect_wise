  ...
  class ProjectTicketNotesApi
    ...
    def get_project_tickets_by_parent_id_all_notes_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProjectTicketNotesApi.get_project_tickets_by_parent_id_all_notes"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectTicketNotesApi.get_project_tickets_by_parent_id_all_notes"
      end
      # resource path
    ...
    def post_project_ticket_note_by_id_mark_as_with_http_info(id, client_id, project_ticket_note, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectTicketNotesApi.post_project_ticket_note_by_id_mark_as"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectTicketNotesApi.post_project_ticket_note_by_id_mark_as"
      end
      ...
      if @api_client.config.client_side_validation && project_ticket_note.nil?
        fail ArgumentError, "Missing the required parameter 'project_ticket_note' when calling ProjectTicketNotesApi.post_project_ticket_note_by_id_mark_as"
      end
      # resource path
