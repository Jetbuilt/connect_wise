  ...
  class PortalConfigurationOpportunitySetupsApi
    ...
    def get_company_portal_configurations_by_parent_id_opportunity_setups_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.get_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.get_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # resource path
    ...
    def get_company_portal_configurations_by_parent_id_opportunity_setups_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PortalConfigurationOpportunitySetupsApi.get_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.get_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.get_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # resource path
    ...
    def patch_company_portal_configurations_by_parent_id_opportunity_setups_with_http_info(parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # resource path
      local_var_path = '/company/portalConfigurations/{parentId}/opportunitySetups'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def patch_company_portal_configurations_by_parent_id_opportunity_setups_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling PortalConfigurationOpportunitySetupsApi.patch_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # resource path
      local_var_path = '/company/portalConfigurations/{parentId}/opportunitySetups/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_company_portal_configurations_by_parent_id_opportunity_setups_with_http_info(parent_id, client_id, portal_configuration_opportunity_setup, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      ...
      if @api_client.config.client_side_validation && portal_configuration_opportunity_setup.nil?
        fail ArgumentError, "Missing the required parameter 'portal_configuration_opportunity_setup' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups"
      end
      # resource path
      local_var_path = '/company/portalConfigurations/{parentId}/opportunitySetups'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_company_portal_configurations_by_parent_id_opportunity_setups_by_id_with_http_info(id, parent_id, client_id, portal_configuration_opportunity_setup, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # verify the required parameter 'portal_configuration_opportunity_setup' is set
      if @api_client.config.client_side_validation && portal_configuration_opportunity_setup.nil?
        fail ArgumentError, "Missing the required parameter 'portal_configuration_opportunity_setup' when calling PortalConfigurationOpportunitySetupsApi.put_company_portal_configurations_by_parent_id_opportunity_setups_by_id"
      end
      # resource path
      local_var_path = '/company/portalConfigurations/{parentId}/opportunitySetups/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
