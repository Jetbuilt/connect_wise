...
module ConnectWise
  class WorkflowNotifyTypesApi
    ...
    def get_system_workflows_notify_types_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: WorkflowNotifyTypesApi.get_system_workflows_notify_types ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowNotifyTypesApi.get_system_workflows_notify_types" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_workflows_notify_types_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: WorkflowNotifyTypesApi.get_system_workflows_notify_types_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling WorkflowNotifyTypesApi.get_system_workflows_notify_types_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowNotifyTypesApi.get_system_workflows_notify_types_by_id" if @api_client.config.client_side_validation && client_id.nil?
