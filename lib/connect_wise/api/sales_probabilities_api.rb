  ...
  class SalesProbabilitiesApi
    ...
    def delete_sales_probabilities_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesProbabilitiesApi.delete_sales_probabilities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.delete_sales_probabilities_by_id"
      end
      # resource path
    ...
    def get_sales_probabilities_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.get_sales_probabilities"
      end
      # resource path
    ...
    def get_sales_probabilities_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesProbabilitiesApi.get_sales_probabilities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.get_sales_probabilities_by_id"
      end
      # resource path
      local_var_path = '/sales/probabilities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_sales_probabilities_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.get_sales_probabilities_count"
      end
      # resource path
    ...
    def patch_sales_probabilities_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesProbabilitiesApi.patch_sales_probabilities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.patch_sales_probabilities_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling SalesProbabilitiesApi.patch_sales_probabilities_by_id"
      end
      # resource path
      local_var_path = '/sales/probabilities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_sales_probabilities_with_http_info(client_id, sales_probability, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.post_sales_probabilities"
      end
      # verify the required parameter 'sales_probability' is set
      if @api_client.config.client_side_validation && sales_probability.nil?
        fail ArgumentError, "Missing the required parameter 'sales_probability' when calling SalesProbabilitiesApi.post_sales_probabilities"
      end
      # resource path
      local_var_path = '/sales/probabilities'
    ...
    def put_sales_probabilities_by_id_with_http_info(id, client_id, sales_probability, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesProbabilitiesApi.put_sales_probabilities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesProbabilitiesApi.put_sales_probabilities_by_id"
      end
      # verify the required parameter 'sales_probability' is set
      if @api_client.config.client_side_validation && sales_probability.nil?
        fail ArgumentError, "Missing the required parameter 'sales_probability' when calling SalesProbabilitiesApi.put_sales_probabilities_by_id"
      end
      # resource path
      local_var_path = '/sales/probabilities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
