  ...
  class ManagedDeviceAccountsApi
    ...
    def delete_system_members_by_parent_id_managed_device_accounts_bulk_with_http_info(parent_id, client_id, id_collection, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ManagedDeviceAccountsApi.delete_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ManagedDeviceAccountsApi.delete_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      # verify the required parameter 'id_collection' is set
      if @api_client.config.client_side_validation && id_collection.nil?
        fail ArgumentError, "Missing the required parameter 'id_collection' when calling ManagedDeviceAccountsApi.delete_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      # resource path
    ...
    def get_system_members_by_parent_id_managed_device_accounts_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ManagedDeviceAccountsApi.get_system_members_by_parent_id_managed_device_accounts"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ManagedDeviceAccountsApi.get_system_members_by_parent_id_managed_device_accounts"
      end
      # resource path
    ...
    def put_system_members_by_parent_id_managed_device_accounts_bulk_with_http_info(parent_id, client_id, managed_device_account, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ManagedDeviceAccountsApi.put_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ManagedDeviceAccountsApi.put_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      ...
      if @api_client.config.client_side_validation && managed_device_account.nil?
        fail ArgumentError, "Missing the required parameter 'managed_device_account' when calling ManagedDeviceAccountsApi.put_system_members_by_parent_id_managed_device_accounts_bulk"
      end
      # resource path
      local_var_path = '/system/members/{parentId}/managedDeviceAccounts/bulk'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
