  ...
  class CatalogsItemApi
    ...
    def delete_procurement_catalog_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.delete_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.delete_procurement_catalog_by_id"
      end
      # resource path
    ...
    def get_procurement_catalog_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog"
      end
      # resource path
    ...
    def get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand_with_http_info(catalog_item_identifier, client_id, warehouse_bin_id, opts = {})
      ...
      if @api_client.config.client_side_validation && catalog_item_identifier.nil?
        fail ArgumentError, "Missing the required parameter 'catalog_item_identifier' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end
      # verify the required parameter 'warehouse_bin_id' is set
      if @api_client.config.client_side_validation && warehouse_bin_id.nil?
        fail ArgumentError, "Missing the required parameter 'warehouse_bin_id' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end
      # resource path
    ...
    def get_procurement_catalog_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.get_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_id"
      end
      # resource path
      local_var_path = '/procurement/catalog/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_procurement_catalog_by_id_info_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.get_procurement_catalog_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_id_info"
      end
      # resource path
    ...
    def get_procurement_catalog_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_count"
      end
      # resource path
    ...
    def get_procurement_catalog_info_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_info"
      end
      # resource path
    ...
    def get_procurement_catalog_info_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_info_count"
      end
      # resource path
    ...
    def patch_procurement_catalog_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
      # resource path
      local_var_path = '/procurement/catalog/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_procurement_catalog_with_http_info(client_id, catalog_item, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog"
      end
      # verify the required parameter 'catalog_item' is set
      if @api_client.config.client_side_validation && catalog_item.nil?
        fail ArgumentError, "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.post_procurement_catalog"
      end
      # resource path
      local_var_path = '/procurement/catalog'
    ...
    def post_procurement_catalog_by_id_pricing_with_http_info(id, client_id, catalog_pricing, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
      # verify the required parameter 'catalog_pricing' is set
      if @api_client.config.client_side_validation && catalog_pricing.nil?
        fail ArgumentError, "Missing the required parameter 'catalog_pricing' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
      # resource path
    ...
    def put_procurement_catalog_by_id_with_http_info(id, client_id, catalog_item, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
      # verify the required parameter 'catalog_item' is set
      if @api_client.config.client_side_validation && catalog_item.nil?
        fail ArgumentError, "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
      # resource path
      local_var_path = '/procurement/catalog/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
