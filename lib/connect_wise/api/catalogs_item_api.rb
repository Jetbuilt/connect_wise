  ...
  class CatalogsItemApi
    ...
    def delete_procurement_catalog_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.delete_procurement_catalog_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.delete_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.delete_procurement_catalog_by_id"
      end
    ...
    def delete_procurement_catalog_by_parent_id_vendors_by_id_with_http_info(parent_id, id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.delete_procurement_catalog_by_parent_id_vendors_by_id ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CatalogsItemApi.delete_procurement_catalog_by_parent_id_vendors_by_id"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.delete_procurement_catalog_by_parent_id_vendors_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.delete_procurement_catalog_by_parent_id_vendors_by_id"
      end

      # resource path
      local_var_path = '/procurement/catalog/{parentId}/vendors/{id}'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s)).sub(
    ...
    def get_procurement_catalog_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog"
      end
    ...
    # @option opts [Integer] :page_id
    # @return [Count]
    def get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand(catalog_item_identifier, client_id,
                                                                            warehouse_bin_id, opts = {})
      data, _status_code, _headers = get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand_with_http_info(
        catalog_item_identifier, client_id, warehouse_bin_id, opts
      )
      data
    end
    ...
    def get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand_with_http_info(catalog_item_identifier,
                                                                                           client_id, warehouse_bin_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand ...'
      end
      ...
      if @api_client.config.client_side_validation && catalog_item_identifier.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_item_identifier' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end
      # verify the required parameter 'warehouse_bin_id' is set
      if @api_client.config.client_side_validation && warehouse_bin_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'warehouse_bin_id' when calling CatalogsItemApi.get_procurement_catalog_by_catalog_item_identifier_quantity_on_hand"
      end

      # resource path
      local_var_path = '/procurement/catalog/{catalogItemIdentifier}/quantityOnHand'.sub('{' + 'catalogItemIdentifier' + '}', CGI.escape(catalog_item_identifier.to_s)).sub(
        '{' + 'warehouseBinId' + '}', CGI.escape(warehouse_bin_id.to_s)
      )
    ...
    def get_procurement_catalog_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.get_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_id"
      end
    ...
    def get_procurement_catalog_by_id_info_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_by_id_info ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.get_procurement_catalog_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_by_id_info"
      end
    ...
    def get_procurement_catalog_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_count"
      end
    ...
    def get_procurement_catalog_info_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_info ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_info"
      end
    ...
    def get_procurement_catalog_info_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_info_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_info_count"
      end
    ...
    def get_procurement_catalog_vendors_by_parent_id(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_procurement_catalog_vendors_by_parent_id_with_http_info(parent_id, client_id,
                                                                                                 opts)
      data
    end
    ...
    def get_procurement_catalog_vendors_by_parent_id_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.get_procurement_catalog_vendors_by_parent_id ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CatalogsItemApi.get_procurement_catalog_vendors_by_parent_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.get_procurement_catalog_vendors_by_parent_id"
      end
    ...
    def patch_procurement_catalog_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_procurement_catalog_by_id_with_http_info(id, client_id, patch_operation,
                                                                                    opts)
      data
    end
    ...
    def patch_procurement_catalog_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.patch_procurement_catalog_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling CatalogsItemApi.patch_procurement_catalog_by_id"
      end
    ...
    def post_procurement_catalog_with_http_info(client_id, catalog_item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.post_procurement_catalog ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog"
      end
      # verify the required parameter 'catalog_item' is set
      if @api_client.config.client_side_validation && catalog_item.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.post_procurement_catalog"
      end
    ...
    def post_procurement_catalog_by_id_copy_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.post_procurement_catalog_by_id_copy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.post_procurement_catalog_by_id_copy"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog_by_id_copy"
      end
    ...
    def post_procurement_catalog_by_id_pricing(id, client_id, catalog_pricing, opts = {})
      data, _status_code, _headers = post_procurement_catalog_by_id_pricing_with_http_info(id, client_id,
                                                                                           catalog_pricing, opts)
      data
    end
    ...
    def post_procurement_catalog_by_id_pricing_with_http_info(id, client_id, catalog_pricing, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.post_procurement_catalog_by_id_pricing ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
      # verify the required parameter 'catalog_pricing' is set
      if @api_client.config.client_side_validation && catalog_pricing.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_pricing' when calling CatalogsItemApi.post_procurement_catalog_by_id_pricing"
      end
    ...
    def post_procurement_catalog_vendors_with_http_info(client_id, catalog_vendors, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.post_procurement_catalog_vendors ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.post_procurement_catalog_vendors"
      end
      # verify the required parameter 'catalog_vendors' is set
      if @api_client.config.client_side_validation && catalog_vendors.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_vendors' when calling CatalogsItemApi.post_procurement_catalog_vendors"
      end
    ...
    def put_procurement_catalog_by_id_with_http_info(id, client_id, catalog_item, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.put_procurement_catalog_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
      # verify the required parameter 'catalog_item' is set
      if @api_client.config.client_side_validation && catalog_item.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.put_procurement_catalog_by_id"
      end
    ...
    def put_procurement_catalog_by_parent_id_vendors_by_id(id, parent_id, client_id, catalog_item, opts = {})
      data, _status_code, _headers = put_procurement_catalog_by_parent_id_vendors_by_id_with_http_info(id, parent_id,
                                                                                                       client_id, catalog_item, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CatalogVendors, Integer, Hash)>] CatalogVendors data, response status code and response headers
    def put_procurement_catalog_by_parent_id_vendors_by_id_with_http_info(id, parent_id, client_id, catalog_item,
                                                                          opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CatalogsItemApi.put_procurement_catalog_by_parent_id_vendors_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CatalogsItemApi.put_procurement_catalog_by_parent_id_vendors_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CatalogsItemApi.put_procurement_catalog_by_parent_id_vendors_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CatalogsItemApi.put_procurement_catalog_by_parent_id_vendors_by_id"
      end
      # verify the required parameter 'catalog_item' is set
      if @api_client.config.client_side_validation && catalog_item.nil?
        raise ArgumentError,
              "Missing the required parameter 'catalog_item' when calling CatalogsItemApi.put_procurement_catalog_by_parent_id_vendors_by_id"
      end

      # resource path
      local_var_path = '/procurement/catalog/{parentId}/vendors/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
