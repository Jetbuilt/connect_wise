  ...
  class OthersApi
    ...
    def get_system_my_company_other_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OthersApi.get_system_my_company_other"
      end
    ...
    def get_system_my_company_other_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OthersApi.get_system_my_company_other_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OthersApi.get_system_my_company_other_by_id"
      end
    ...
    def get_system_my_company_other_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OthersApi.get_system_my_company_other_count"
      end
    ...
    def patch_system_my_company_other_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_system_my_company_other_by_id_with_http_info(id, client_id, patch_operation,
                                                                                        opts)
      data
    end
    ...
    def patch_system_my_company_other_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OthersApi.patch_system_my_company_other_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OthersApi.patch_system_my_company_other_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling OthersApi.patch_system_my_company_other_by_id"
      end
    ...
    def put_system_my_company_other_by_id_with_http_info(id, client_id, other, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OthersApi.put_system_my_company_other_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OthersApi.put_system_my_company_other_by_id"
      end
      # verify the required parameter 'other' is set
      if @api_client.config.client_side_validation && other.nil?
        raise ArgumentError,
              "Missing the required parameter 'other' when calling OthersApi.put_system_my_company_other_by_id"
      end
