  ...
  class CompaniesApi
    ...
    def delete_company_companies_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompaniesApi.delete_company_companies_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.delete_company_companies_by_id"
      end
    ...
    def get_company_companies_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies"
      end
    ...
    def get_company_companies_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.get_company_companies_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies_by_id"
      end
    ...
    def get_company_companies_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompaniesApi.get_company_companies_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies_by_id_usages"
      end
    ...
    def get_company_companies_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompaniesApi.get_company_companies_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies_by_id_usages_list"
      end
    ...
    def get_company_companies_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies_count"
      end
    ...
    def get_company_companies_default_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.get_company_companies_default"
      end
    ...
    def patch_company_companies_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompaniesApi.patch_company_companies_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.patch_company_companies_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling CompaniesApi.patch_company_companies_by_id"
      end
    ...
    def post_company_companies_with_http_info(client_id, company, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.post_company_companies"
      end
      # verify the required parameter 'company' is set
      if @api_client.config.client_side_validation && company.nil?
        raise ArgumentError, "Missing the required parameter 'company' when calling CompaniesApi.post_company_companies"
      end
    ...
    def post_company_companies_by_id_merge(id, client_id, company_merge, opts = {})
      data, _status_code, _headers = post_company_companies_by_id_merge_with_http_info(id, client_id, company_merge,
                                                                                       opts)
      data
    end
    ...
    def post_company_companies_by_id_merge_with_http_info(id, client_id, company_merge, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompaniesApi.post_company_companies_by_id_merge"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.post_company_companies_by_id_merge"
      end
      # verify the required parameter 'company_merge' is set
      if @api_client.config.client_side_validation && company_merge.nil?
        raise ArgumentError,
              "Missing the required parameter 'company_merge' when calling CompaniesApi.post_company_companies_by_id_merge"
      end
    ...
    def put_company_companies_by_id_with_http_info(id, client_id, company, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling CompaniesApi.put_company_companies_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompaniesApi.put_company_companies_by_id"
      end
      # verify the required parameter 'company' is set
      if @api_client.config.client_side_validation && company.nil?
        raise ArgumentError,
              "Missing the required parameter 'company' when calling CompaniesApi.put_company_companies_by_id"
      end
