...
module ConnectWise
  class ProcurementSettingsApi
    ...
    def get_procurement_settings_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ProcurementSettingsApi.get_procurement_settings ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ProcurementSettingsApi.get_procurement_settings" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_procurement_settings_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ProcurementSettingsApi.get_procurement_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling ProcurementSettingsApi.get_procurement_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ProcurementSettingsApi.get_procurement_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_procurement_settings_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ProcurementSettingsApi.get_procurement_settings_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ProcurementSettingsApi.get_procurement_settings_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_procurement_settings_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: ProcurementSettingsApi.patch_procurement_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling ProcurementSettingsApi.patch_procurement_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ProcurementSettingsApi.patch_procurement_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling ProcurementSettingsApi.patch_procurement_settings_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def put_procurement_settings_by_id_with_http_info(id, client_id, procurement_setting, opts = {})
      @api_client.config.logger.debug 'Calling API: ProcurementSettingsApi.put_procurement_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling ProcurementSettingsApi.put_procurement_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ProcurementSettingsApi.put_procurement_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'procurement_setting' is set
      raise ArgumentError, "Missing the required parameter 'procurement_setting' when calling ProcurementSettingsApi.put_procurement_settings_by_id" if @api_client.config.client_side_validation && procurement_setting.nil?
