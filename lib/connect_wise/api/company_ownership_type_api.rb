...
module ConnectWise
  class CompanyOwnershipTypeApi
    ...
    def delete_company_ownership_types_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.delete_company_ownership_types_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.delete_company_ownership_types_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.delete_company_ownership_types_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_ownership_types_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.get_company_ownership_types ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_ownership_types_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.get_company_ownership_types_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_ownership_types_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.get_company_ownership_types_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_company_ownership_types_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.patch_company_ownership_types_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_company_ownership_types_with_http_info(client_id, ownership_type, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.post_company_ownership_types ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.post_company_ownership_types" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'ownership_type' is set
      raise ArgumentError, "Missing the required parameter 'ownership_type' when calling CompanyOwnershipTypeApi.post_company_ownership_types" if @api_client.config.client_side_validation && ownership_type.nil?
    ...
    def put_company_ownership_types_by_id_with_http_info(id, client_id, ownership_type, opts = {})
      @api_client.config.logger.debug 'Calling API: CompanyOwnershipTypeApi.put_company_ownership_types_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'ownership_type' is set
      raise ArgumentError, "Missing the required parameter 'ownership_type' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id" if @api_client.config.client_side_validation && ownership_type.nil?
