  ...
  class CompanyOwnershipTypeApi
    ...
    def delete_company_ownership_types_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.delete_company_ownership_types_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.delete_company_ownership_types_by_id"
      end
    ...
    def get_company_ownership_types_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types"
      end
    ...
    def get_company_ownership_types_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_by_id"
      end
    ...
    def get_company_ownership_types_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.get_company_ownership_types_count"
      end
    ...
    def patch_company_ownership_types_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_company_ownership_types_by_id_with_http_info(id, client_id, patch_operation,
                                                                                        opts)
      data
    end
    ...
    def patch_company_ownership_types_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling CompanyOwnershipTypeApi.patch_company_ownership_types_by_id"
      end
    ...
    def post_company_ownership_types_with_http_info(client_id, ownership_type, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.post_company_ownership_types"
      end
      # verify the required parameter 'ownership_type' is set
      if @api_client.config.client_side_validation && ownership_type.nil?
        raise ArgumentError,
              "Missing the required parameter 'ownership_type' when calling CompanyOwnershipTypeApi.post_company_ownership_types"
      end
    ...
    def put_company_ownership_types_by_id(id, client_id, ownership_type, opts = {})
      data, _status_code, _headers = put_company_ownership_types_by_id_with_http_info(id, client_id, ownership_type,
                                                                                      opts)
      data
    end
    ...
    def put_company_ownership_types_by_id_with_http_info(id, client_id, ownership_type, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id"
      end
      # verify the required parameter 'ownership_type' is set
      if @api_client.config.client_side_validation && ownership_type.nil?
        raise ArgumentError,
              "Missing the required parameter 'ownership_type' when calling CompanyOwnershipTypeApi.put_company_ownership_types_by_id"
      end
