  ...
  class HolidaysApi
    ...
    def delete_schedule_holiday_lists_by_parent_id_holidays_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling HolidaysApi.delete_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.delete_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.delete_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # resource path
    ...
    def get_schedule_holiday_lists_by_parent_id_holidays_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays"
      end
      # resource path
    ...
    def get_schedule_holiday_lists_by_parent_id_holidays_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # resource path
      local_var_path = '/schedule/holidayLists/{parentId}/holidays/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_schedule_holiday_lists_by_parent_id_holidays_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.get_schedule_holiday_lists_by_parent_id_holidays_count"
      end
      # resource path
    ...
    def patch_schedule_holiday_lists_by_parent_id_holidays_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling HolidaysApi.patch_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.patch_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.patch_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling HolidaysApi.patch_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # resource path
      local_var_path = '/schedule/holidayLists/{parentId}/holidays/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_schedule_holiday_lists_by_parent_id_holidays_with_http_info(parent_id, client_id, holiday, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.post_schedule_holiday_lists_by_parent_id_holidays"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.post_schedule_holiday_lists_by_parent_id_holidays"
      end
      # verify the required parameter 'holiday' is set
      if @api_client.config.client_side_validation && holiday.nil?
        fail ArgumentError, "Missing the required parameter 'holiday' when calling HolidaysApi.post_schedule_holiday_lists_by_parent_id_holidays"
      end
      # resource path
      local_var_path = '/schedule/holidayLists/{parentId}/holidays'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_schedule_holiday_lists_by_parent_id_holidays_by_id_with_http_info(id, parent_id, client_id, holiday, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling HolidaysApi.put_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling HolidaysApi.put_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidaysApi.put_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # verify the required parameter 'holiday' is set
      if @api_client.config.client_side_validation && holiday.nil?
        fail ArgumentError, "Missing the required parameter 'holiday' when calling HolidaysApi.put_schedule_holiday_lists_by_parent_id_holidays_by_id"
      end
      # resource path
      local_var_path = '/schedule/holidayLists/{parentId}/holidays/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
