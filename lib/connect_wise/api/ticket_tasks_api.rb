...
module ConnectWise
  class TicketTasksApi
    ...
    def post_service_tickets_by_parent_id_tasks(parent_id, client_id, service_task, opts = {})
      data, _status_code, _headers = post_service_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, service_task, opts)
      data
    end
    ...
    def post_service_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, service_task, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'service_task' when calling TicketTasksApi.post_service_tickets_by_parent_id_tasks" if @api_client.config.client_side_validation && service_task.nil?
    ...
    def put_service_tickets_by_parent_id_tasks_by_id(id, parent_id, client_id, service_task, opts = {})
      data, _status_code, _headers = put_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, service_task, opts)
      data
    end
    ...
    def put_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, service_task, opts = {})
      ...
      # verify the required parameter 'service_task' is set
      raise ArgumentError, "Missing the required parameter 'service_task' when calling TicketTasksApi.put_service_tickets_by_parent_id_tasks_by_id" if @api_client.config.client_side_validation && service_task.nil?
