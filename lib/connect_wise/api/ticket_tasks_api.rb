  ...
  class TicketTasksApi
    ...
    def delete_project_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.delete_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.delete_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.delete_project_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
    ...
    def delete_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.delete_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.delete_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.delete_service_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
    ...
    def get_project_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks"
      end
      # resource path
    ...
    def get_project_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/project/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_project_tickets_by_parent_id_tasks_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_project_tickets_by_parent_id_tasks_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_tasks_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.get_service_tickets_by_parent_id_tasks_count"
      end
      # resource path
    ...
    def patch_project_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.patch_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.patch_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.patch_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling TicketTasksApi.patch_project_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/project/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def patch_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.patch_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.patch_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.patch_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling TicketTasksApi.patch_service_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_project_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, ticket_task, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.post_project_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.post_project_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'ticket_task' is set
      if @api_client.config.client_side_validation && ticket_task.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_task' when calling TicketTasksApi.post_project_tickets_by_parent_id_tasks"
      end
      # resource path
      local_var_path = '/project/tickets/{parentId}/tasks'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_service_tickets_by_parent_id_tasks_with_http_info(parent_id, client_id, task, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.post_service_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.post_service_tickets_by_parent_id_tasks"
      end
      # verify the required parameter 'task' is set
      if @api_client.config.client_side_validation && task.nil?
        fail ArgumentError, "Missing the required parameter 'task' when calling TicketTasksApi.post_service_tickets_by_parent_id_tasks"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/tasks'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_project_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, ticket_task, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.put_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.put_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.put_project_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'ticket_task' is set
      if @api_client.config.client_side_validation && ticket_task.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_task' when calling TicketTasksApi.put_project_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/project/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_service_tickets_by_parent_id_tasks_by_id_with_http_info(id, parent_id, client_id, task, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketTasksApi.put_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketTasksApi.put_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketTasksApi.put_service_tickets_by_parent_id_tasks_by_id"
      end
      # verify the required parameter 'task' is set
      if @api_client.config.client_side_validation && task.nil?
        fail ArgumentError, "Missing the required parameter 'task' when calling TicketTasksApi.put_service_tickets_by_parent_id_tasks_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/tasks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
