...
module ConnectWise
  class ConfigurationTypesApi
    ...
    def post_company_configurations_types_copy(client_id, configuration_type_copy, opts = {})
      data, _status_code, _headers = post_company_configurations_types_copy_with_http_info(client_id, configuration_type_copy, opts)
      data
    end
    ...
    def post_company_configurations_types_copy_with_http_info(client_id, configuration_type_copy, opts = {})
      @api_client.config.logger.debug 'Calling API: ConfigurationTypesApi.post_company_configurations_types_copy ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling ConfigurationTypesApi.post_company_configurations_types_copy" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'configuration_type_copy' is set
      raise ArgumentError, "Missing the required parameter 'configuration_type_copy' when calling ConfigurationTypesApi.post_company_configurations_types_copy" if @api_client.config.client_side_validation && configuration_type_copy.nil?
