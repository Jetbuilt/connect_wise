  ...
  class PhaseStatusesApi
    ...
    def delete_project_phase_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.delete_project_phase_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.delete_project_phase_statuses_by_id"
      end
      # resource path
    ...
    def get_project_phase_statuses_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.get_project_phase_statuses"
      end
      # resource path
    ...
    def get_project_phase_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id"
      end
      # resource path
      local_var_path = '/project/phaseStatuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_project_phase_statuses_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id_usages"
      end
      # resource path
    ...
    def get_project_phase_statuses_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.get_project_phase_statuses_by_id_usages_list"
      end
      # resource path
    ...
    def get_project_phase_statuses_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.get_project_phase_statuses_count"
      end
      # resource path
    ...
    def patch_project_phase_statuses_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.patch_project_phase_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.patch_project_phase_statuses_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling PhaseStatusesApi.patch_project_phase_statuses_by_id"
      end
      # resource path
      local_var_path = '/project/phaseStatuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_project_phase_statuses_with_http_info(client_id, phase_status, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.post_project_phase_statuses"
      end
      # verify the required parameter 'phase_status' is set
      if @api_client.config.client_side_validation && phase_status.nil?
        fail ArgumentError, "Missing the required parameter 'phase_status' when calling PhaseStatusesApi.post_project_phase_statuses"
      end
      # resource path
      local_var_path = '/project/phaseStatuses'
    ...
    def put_project_phase_statuses_by_id_with_http_info(id, client_id, phase_status, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PhaseStatusesApi.put_project_phase_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PhaseStatusesApi.put_project_phase_statuses_by_id"
      end
      # verify the required parameter 'phase_status' is set
      if @api_client.config.client_side_validation && phase_status.nil?
        fail ArgumentError, "Missing the required parameter 'phase_status' when calling PhaseStatusesApi.put_project_phase_statuses_by_id"
      end
      # resource path
      local_var_path = '/project/phaseStatuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
