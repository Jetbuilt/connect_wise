  ...
  class HolidayListInfosApi
    ...
    def get_sales_schedule_holidaylists_info_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HolidayListInfosApi.get_sales_schedule_holidaylists_info_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidayListInfosApi.get_sales_schedule_holidaylists_info_count"
      end
      # resource path
    ...
    def get_schedule_holidaylists_by_id_info_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HolidayListInfosApi.get_schedule_holidaylists_by_id_info ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling HolidayListInfosApi.get_schedule_holidaylists_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidayListInfosApi.get_schedule_holidaylists_by_id_info"
      end
      # resource path
    ...
    def get_schedule_holidaylists_info_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: HolidayListInfosApi.get_schedule_holidaylists_info ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling HolidayListInfosApi.get_schedule_holidaylists_info"
      end
      # resource path
