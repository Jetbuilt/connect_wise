  ...
  class LdapConfigurationsApi
    ...
    def delete_system_ldap_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LdapConfigurationsApi.delete_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.delete_system_ldap_configurations_by_id"
      end
      # resource path
    ...
    def get_system_ldap_configurations_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations"
      end
      # resource path
    ...
    def get_system_ldap_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LdapConfigurationsApi.get_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations_by_id"
      end
      # resource path
      local_var_path = '/system/ldapConfigurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_system_ldap_configurations_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations_count"
      end
      # resource path
    ...
    def patch_system_ldap_configurations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
      # resource path
      local_var_path = '/system/ldapConfigurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_system_ldap_configurations_with_http_info(client_id, ldap_configuration, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.post_system_ldap_configurations"
      end
      ...
      if @api_client.config.client_side_validation && ldap_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'ldap_configuration' when calling LdapConfigurationsApi.post_system_ldap_configurations"
      end
      # resource path
      local_var_path = '/system/ldapConfigurations'
    ...
    def post_system_ldap_configurations_test_link_with_http_info(client_id, ldap_configuration_test_link, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.post_system_ldap_configurations_test_link"
      end
      ...
      if @api_client.config.client_side_validation && ldap_configuration_test_link.nil?
        fail ArgumentError, "Missing the required parameter 'ldap_configuration_test_link' when calling LdapConfigurationsApi.post_system_ldap_configurations_test_link"
      end
      # resource path
    ...
    def put_system_ldap_configurations_by_id_with_http_info(id, client_id, ldap_configuration, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'ldap_configuration' is set
      if @api_client.config.client_side_validation && ldap_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'ldap_configuration' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
      # resource path
      local_var_path = '/system/ldapConfigurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
