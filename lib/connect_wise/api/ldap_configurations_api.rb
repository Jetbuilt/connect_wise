  ...
  class LdapConfigurationsApi
    ...
    def delete_system_ldap_configurations_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.delete_system_ldap_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling LdapConfigurationsApi.delete_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.delete_system_ldap_configurations_by_id"
      end
    ...
    def get_system_ldap_configurations_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.get_system_ldap_configurations ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations"
      end
    ...
    def get_system_ldap_configurations_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.get_system_ldap_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling LdapConfigurationsApi.get_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations_by_id"
      end
    ...
    def get_system_ldap_configurations_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.get_system_ldap_configurations_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.get_system_ldap_configurations_count"
      end
    ...
    def patch_system_ldap_configurations_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_system_ldap_configurations_by_id_with_http_info(id, client_id,
    ...
    def patch_system_ldap_configurations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.patch_system_ldap_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling LdapConfigurationsApi.patch_system_ldap_configurations_by_id"
      end
    ...
    def post_system_ldap_configurations_with_http_info(client_id, ldap_configuration, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.post_system_ldap_configurations ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.post_system_ldap_configurations"
      end
      ...
      if @api_client.config.client_side_validation && ldap_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'ldap_configuration' when calling LdapConfigurationsApi.post_system_ldap_configurations"
      end
    ...
    def post_system_ldap_configurations_test_link(client_id, ldap_configuration_test_link, opts = {})
      data, _status_code, _headers = post_system_ldap_configurations_test_link_with_http_info(client_id,
                                                                                              ldap_configuration_test_link, opts)
      data
    end
    ...
    def post_system_ldap_configurations_test_link_with_http_info(client_id, ldap_configuration_test_link, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.post_system_ldap_configurations_test_link ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.post_system_ldap_configurations_test_link"
      end
      # verify the required parameter 'ldap_configuration_test_link' is set
      if @api_client.config.client_side_validation && ldap_configuration_test_link.nil?
        raise ArgumentError,
              "Missing the required parameter 'ldap_configuration_test_link' when calling LdapConfigurationsApi.post_system_ldap_configurations_test_link"
      end
    ...
    def put_system_ldap_configurations_by_id(id, client_id, ldap_configuration, opts = {})
      data, _status_code, _headers = put_system_ldap_configurations_by_id_with_http_info(id, client_id,
                                                                                         ldap_configuration, opts)
      data
    end
    ...
    def put_system_ldap_configurations_by_id_with_http_info(id, client_id, ldap_configuration, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LdapConfigurationsApi.put_system_ldap_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
      # verify the required parameter 'ldap_configuration' is set
      if @api_client.config.client_side_validation && ldap_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'ldap_configuration' when calling LdapConfigurationsApi.put_system_ldap_configurations_by_id"
      end
