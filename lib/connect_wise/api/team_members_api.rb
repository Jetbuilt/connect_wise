  ...
  class TeamMembersApi
    ...
    def post_service_team_members_with_http_info(client_id, team_member, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TeamMembersApi.post_service_team_members"
      end
      # verify the required parameter 'team_member' is set
      if @api_client.config.client_side_validation && team_member.nil?
        raise ArgumentError,
              "Missing the required parameter 'team_member' when calling TeamMembersApi.post_service_team_members"
      end
