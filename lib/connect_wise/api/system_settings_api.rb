...
module ConnectWise
  class SystemSettingsApi
    ...
    def get_system_settings_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SystemSettingsApi.get_system_settings ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SystemSettingsApi.get_system_settings" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_settings_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SystemSettingsApi.get_system_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SystemSettingsApi.get_system_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SystemSettingsApi.get_system_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_settings_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SystemSettingsApi.get_system_settings_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SystemSettingsApi.get_system_settings_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_settings_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: SystemSettingsApi.patch_system_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SystemSettingsApi.patch_system_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SystemSettingsApi.patch_system_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling SystemSettingsApi.patch_system_settings_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def put_system_settings_by_id_with_http_info(id, client_id, system_setting, opts = {})
      @api_client.config.logger.debug 'Calling API: SystemSettingsApi.put_system_settings_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SystemSettingsApi.put_system_settings_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SystemSettingsApi.put_system_settings_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'system_setting' is set
      raise ArgumentError, "Missing the required parameter 'system_setting' when calling SystemSettingsApi.put_system_settings_by_id" if @api_client.config.client_side_validation && system_setting.nil?
