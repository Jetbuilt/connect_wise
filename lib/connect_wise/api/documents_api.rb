  ...
  class DocumentsApi
    ...
    def delete_system_documents_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DocumentsApi.delete_system_documents_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.delete_system_documents_by_id"
      end
    ...
    def get_system_documents_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError, "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents"
      end

      allowable_values = %w[Activity Agreement Company Config Configuration Contact CustomImage
                            Document Expense HTMLTemplate Invoice Opportunity Project ProjectActivity PurchaseOrder Rma SalesOrder Service Ticket ProjectTicket ServiceTemplate StandardServiceTemplate SrDetail TimeEntry JobHeader MarketingManagerAudit KnowledgeBase ToolbarIcon Meeting MeetingNote ProductSetup ProjectTemplateTicket BillingSetup ServiceBoard WordTemplate Member PortalImagePortalLogo PortalImageReportLogo TopNavigationLogo PhaseStatus ProjectStatus TicketStatus Schedule Priority Unassigned]
      if @api_client.config.client_side_validation && opts[:record_type] && !allowable_values.include?(opts[:record_type])
        raise ArgumentError, "invalid value for \"record_type\", must be one of #{allowable_values}"
      end
    ...
    def get_system_documents_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling DocumentsApi.get_system_documents_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents_by_id"
      end
    ...
    def get_system_documents_by_id_download_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DocumentsApi.get_system_documents_by_id_download"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents_by_id_download"
      end
      ...
      unless header_params['Accept']
        header_params['Accept'] =
          @api_client.select_header_accept(['application/octet-stream'])
      end
      header_params[:clientId] = client_id
    ...
    def get_system_documents_by_id_thumbnail_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DocumentsApi.get_system_documents_by_id_thumbnail"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents_by_id_thumbnail"
      end
    ...
    def get_system_documents_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents_count"
      end
    ...
    def get_system_documents_uploadsample_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.get_system_documents_uploadsample"
      end
    ...
    def post_system_documents_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.post_system_documents"
      end
    ...
    def post_system_documents_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling DocumentsApi.post_system_documents_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DocumentsApi.post_system_documents_by_id"
      end
