  ...
  class MyMembersApi
    ...
    def get_system_my_members_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MyMembersApi.get_system_my_members ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MyMembersApi.get_system_my_members"
      end
      # resource path
