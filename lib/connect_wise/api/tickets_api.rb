  ...
  class TicketsApi
    ...
    def delete_service_tickets_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.delete_service_tickets_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.delete_service_tickets_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.delete_service_tickets_by_id"
      end
    ...
    def delete_service_tickets_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/configurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_service_tickets_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets"
      end
    ...
    def get_service_tickets_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.get_service_tickets_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_id"
      end
    ...
    def get_service_tickets_by_parent_id_activities(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_activities_with_http_info(parent_id, client_id,
                                                                                                opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_activities_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_activities ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities"
      end
    ...
    def get_service_tickets_by_parent_id_activities_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_activities_count_with_http_info(parent_id,
                                                                                                      client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_activities_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_activities_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/activities/count'.sub('{' + 'parentId' + '}',
    ...
    def get_service_tickets_by_parent_id_configurations(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_configurations_with_http_info(parent_id,
                                                                                                    client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_configurations_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_configurations ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/configurations'.sub('{' + 'parentId' + '}',
                                                                        CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_configurations_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_configurations_by_id_with_http_info(id,
    ...
    def get_service_tickets_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_configurations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
    ...
    def get_service_tickets_by_parent_id_configurations_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_configurations_count_with_http_info(parent_id,
                                                                                                          client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_configurations_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_configurations_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/configurations/count'.sub('{' + 'parentId' + '}',
                                                                              CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_documents(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_documents_with_http_info(parent_id, client_id,
                                                                                               opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_documents_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_documents ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents"
      end
    ...
    def get_service_tickets_by_parent_id_documents_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_documents_count_with_http_info(parent_id,
                                                                                                     client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_documents_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_documents_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/documents/count'.sub('{' + 'parentId' + '}',
                                                                         CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_products(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_products_with_http_info(parent_id, client_id,
                                                                                              opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_products_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_products ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_products"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_products"
      end
    ...
    def get_service_tickets_by_parent_id_products_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_products_count_with_http_info(parent_id,
                                                                                                    client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_products_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_products_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_products_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_products_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/products/count'.sub('{' + 'parentId' + '}',
                                                                        CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_scheduleentries(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_scheduleentries_with_http_info(parent_id,
                                                                                                     client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_scheduleentries_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_scheduleentries ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/scheduleentries'.sub('{' + 'parentId' + '}',
                                                                         CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_scheduleentries_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_scheduleentries_count_with_http_info(parent_id,
                                                                                                           client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_scheduleentries_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_scheduleentries_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/scheduleentries/count'.sub('{' + 'parentId' + '}',
                                                                               CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_timeentries(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_timeentries_with_http_info(parent_id, client_id,
                                                                                                 opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_timeentries_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_timeentries ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries"
      end
    ...
    def get_service_tickets_by_parent_id_timeentries_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_tickets_by_parent_id_timeentries_count_with_http_info(parent_id,
                                                                                                       client_id, opts)
      data
    end
    ...
    def get_service_tickets_by_parent_id_timeentries_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_by_parent_id_timeentries_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries_count"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/timeentries/count'.sub('{' + 'parentId' + '}',
                                                                           CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_calculate_sla_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_calculate_sla ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_calculate_sla"
      end
    ...
    def get_service_tickets_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_count"
      end
    ...
    def patch_service_tickets_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.patch_service_tickets_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.patch_service_tickets_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.patch_service_tickets_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling TicketsApi.patch_service_tickets_by_id"
      end
    ...
    def post_service_tickets_with_http_info(client_id, ticket, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets"
      end
      # verify the required parameter 'ticket' is set
      if @api_client.config.client_side_validation && ticket.nil?
        raise ArgumentError, "Missing the required parameter 'ticket' when calling TicketsApi.post_service_tickets"
      end
    ...
    def post_service_tickets_by_id_copy_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_by_id_copy ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling TicketsApi.post_service_tickets_by_id_copy"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_id_copy"
      end
    ...
    def post_service_tickets_by_parent_id_attach_children(parent_id, client_id, ticket_bundle, opts = {})
      data, _status_code, _headers = post_service_tickets_by_parent_id_attach_children_with_http_info(parent_id,
                                                                                                      client_id, ticket_bundle, opts)
      data
    end
    ...
    def post_service_tickets_by_parent_id_attach_children_with_http_info(parent_id, client_id, ticket_bundle, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_by_parent_id_attach_children ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end
      # verify the required parameter 'ticket_bundle' is set
      if @api_client.config.client_side_validation && ticket_bundle.nil?
        raise ArgumentError,
              "Missing the required parameter 'ticket_bundle' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end

      # resource path
      local_var_path = '/service/tickets/{parentId}/attachChildren'.sub('{' + 'parentId' + '}',
                                                                        CGI.escape(parent_id.to_s))
    ...
    def post_service_tickets_by_parent_id_configurations(parent_id, client_id, configuration_reference, opts = {})
      data, _status_code, _headers = post_service_tickets_by_parent_id_configurations_with_http_info(parent_id,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConfigurationReference, Integer, Hash)>] ConfigurationReference data, response status code and response headers
    def post_service_tickets_by_parent_id_configurations_with_http_info(parent_id, client_id, configuration_reference,
                                                                        opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_by_parent_id_configurations ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
      ...
      if @api_client.config.client_side_validation && configuration_reference.nil?
        raise ArgumentError,
              "Missing the required parameter 'configuration_reference' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
    ...
    def post_service_tickets_by_parent_id_convert(parent_id, client_id, convert_to_project, opts = {})
      data, _status_code, _headers = post_service_tickets_by_parent_id_convert_with_http_info(parent_id, client_id,
                                                                                              convert_to_project, opts)
      data
    end
    ...
    def post_service_tickets_by_parent_id_convert_with_http_info(parent_id, client_id, convert_to_project, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_by_parent_id_convert ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
      # verify the required parameter 'convert_to_project' is set
      if @api_client.config.client_side_validation && convert_to_project.nil?
        raise ArgumentError,
              "Missing the required parameter 'convert_to_project' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
    ...
    def post_service_tickets_by_parent_id_merge(parent_id, client_id, ticket_merge, opts = {})
      data, _status_code, _headers = post_service_tickets_by_parent_id_merge_with_http_info(parent_id, client_id,
                                                                                            ticket_merge, opts)
      data
    end
    ...
    def post_service_tickets_by_parent_id_merge_with_http_info(parent_id, client_id, ticket_merge, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_by_parent_id_merge ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
      # verify the required parameter 'ticket_merge' is set
      if @api_client.config.client_side_validation && ticket_merge.nil?
        raise ArgumentError,
              "Missing the required parameter 'ticket_merge' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
    ...
    def post_service_tickets_search_with_http_info(client_id, filter_values, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets_search ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_search"
      end
      # verify the required parameter 'filter_values' is set
      if @api_client.config.client_side_validation && filter_values.nil?
        raise ArgumentError,
              "Missing the required parameter 'filter_values' when calling TicketsApi.post_service_tickets_search"
      end
    ...
    def put_service_tickets_by_id_with_http_info(id, client_id, ticket, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.put_service_tickets_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.put_service_tickets_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling TicketsApi.put_service_tickets_by_id"
      end
      # verify the required parameter 'ticket' is set
      if @api_client.config.client_side_validation && ticket.nil?
        raise ArgumentError, "Missing the required parameter 'ticket' when calling TicketsApi.put_service_tickets_by_id"
      end
