  ...
  class TicketsApi
    ...
    def delete_service_tickets_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.delete_service_tickets_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.delete_service_tickets_by_id"
      end
      # resource path
    ...
    def delete_service_tickets_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.delete_service_tickets_by_parent_id_configurations_by_id"
      end
      # resource path
    ...
    def get_service_tickets_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.get_service_tickets ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets"
      end
      # resource path
    ...
    def get_service_tickets_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.get_service_tickets_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_service_tickets_by_parent_id_activities_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_activities_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_activities_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_configurations_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/configurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_service_tickets_by_parent_id_configurations_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_configurations_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_documents_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_documents_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_documents_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_products_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_products"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_products"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_products_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_products_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_products_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_scheduleentries_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_scheduleentries_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_scheduleentries_count"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_timeentries_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries"
      end
      # resource path
    ...
    def get_service_tickets_by_parent_id_timeentries_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_by_parent_id_timeentries_count"
      end
      # resource path
    ...
    def get_service_tickets_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.get_service_tickets_count"
      end
      # resource path
    ...
    def patch_service_tickets_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.patch_service_tickets_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.patch_service_tickets_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling TicketsApi.patch_service_tickets_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_service_tickets_with_http_info(client_id, ticket, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TicketsApi.post_service_tickets ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets"
      end
      # verify the required parameter 'ticket' is set
      if @api_client.config.client_side_validation && ticket.nil?
        fail ArgumentError, "Missing the required parameter 'ticket' when calling TicketsApi.post_service_tickets"
      end
      # resource path
      local_var_path = '/service/tickets'
    ...
    def post_service_tickets_by_parent_id_attach_children_with_http_info(parent_id, client_id, ticket_bundle, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end
      # verify the required parameter 'ticket_bundle' is set
      if @api_client.config.client_side_validation && ticket_bundle.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_bundle' when calling TicketsApi.post_service_tickets_by_parent_id_attach_children"
      end
      # resource path
    ...
    def post_service_tickets_by_parent_id_configurations_with_http_info(parent_id, client_id, configuration_reference, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
      ...
      if @api_client.config.client_side_validation && configuration_reference.nil?
        fail ArgumentError, "Missing the required parameter 'configuration_reference' when calling TicketsApi.post_service_tickets_by_parent_id_configurations"
      end
      # resource path
      local_var_path = '/service/tickets/{parentId}/configurations'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_service_tickets_by_parent_id_convert_with_http_info(parent_id, client_id, convert_to_project, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
      ...
      if @api_client.config.client_side_validation && convert_to_project.nil?
        fail ArgumentError, "Missing the required parameter 'convert_to_project' when calling TicketsApi.post_service_tickets_by_parent_id_convert"
      end
      # resource path
    ...
    def post_service_tickets_by_parent_id_merge_with_http_info(parent_id, client_id, ticket_merge, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
      # verify the required parameter 'ticket_merge' is set
      if @api_client.config.client_side_validation && ticket_merge.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_merge' when calling TicketsApi.post_service_tickets_by_parent_id_merge"
      end
      # resource path
    ...
    def post_service_tickets_search_with_http_info(client_id, filter_values, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.post_service_tickets_search"
      end
      # verify the required parameter 'filter_values' is set
      if @api_client.config.client_side_validation && filter_values.nil?
        fail ArgumentError, "Missing the required parameter 'filter_values' when calling TicketsApi.post_service_tickets_search"
      end
      # resource path
    ...
    def put_service_tickets_by_id_with_http_info(id, client_id, ticket, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TicketsApi.put_service_tickets_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling TicketsApi.put_service_tickets_by_id"
      end
      # verify the required parameter 'ticket' is set
      if @api_client.config.client_side_validation && ticket.nil?
        fail ArgumentError, "Missing the required parameter 'ticket' when calling TicketsApi.put_service_tickets_by_id"
      end
      # resource path
      local_var_path = '/service/tickets/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
