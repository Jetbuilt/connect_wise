...
module ConnectWise
  class PurchasingDemandsApi
    ...
    def post_procurement_purchasing_demands_with_http_info(client_id, purchasing_demand, opts = {})
      @api_client.config.logger.debug 'Calling API: PurchasingDemandsApi.post_procurement_purchasing_demands ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling PurchasingDemandsApi.post_procurement_purchasing_demands" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'purchasing_demand' is set
      raise ArgumentError, "Missing the required parameter 'purchasing_demand' when calling PurchasingDemandsApi.post_procurement_purchasing_demands" if @api_client.config.client_side_validation && purchasing_demand.nil?
