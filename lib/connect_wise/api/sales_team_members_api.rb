  ...
  class SalesTeamMembersApi
    ...
    def delete_sales_sales_teams_by_parent_id_members_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesTeamMembersApi.delete_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.delete_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.delete_sales_sales_teams_by_parent_id_members_by_id"
      end
      # resource path
    ...
    def get_sales_sales_teams_by_parent_id_members_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members"
      end
      # resource path
    ...
    def get_sales_sales_teams_by_parent_id_members_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members_by_id"
      end
      # resource path
      local_var_path = '/sales/salesTeams/{parentId}/members/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_sales_sales_teams_by_parent_id_members_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.get_sales_sales_teams_by_parent_id_members_count"
      end
      # resource path
    ...
    def patch_sales_sales_teams_by_parent_id_members_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesTeamMembersApi.patch_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.patch_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.patch_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling SalesTeamMembersApi.patch_sales_sales_teams_by_parent_id_members_by_id"
      end
      # resource path
      local_var_path = '/sales/salesTeams/{parentId}/members/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_sales_sales_teams_by_parent_id_members_with_http_info(parent_id, client_id, sales_team_member, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.post_sales_sales_teams_by_parent_id_members"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.post_sales_sales_teams_by_parent_id_members"
      end
      # verify the required parameter 'sales_team_member' is set
      if @api_client.config.client_side_validation && sales_team_member.nil?
        fail ArgumentError, "Missing the required parameter 'sales_team_member' when calling SalesTeamMembersApi.post_sales_sales_teams_by_parent_id_members"
      end
      # resource path
      local_var_path = '/sales/salesTeams/{parentId}/members'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_sales_sales_teams_by_parent_id_members_by_id_with_http_info(id, parent_id, client_id, sales_team_member, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SalesTeamMembersApi.put_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling SalesTeamMembersApi.put_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SalesTeamMembersApi.put_sales_sales_teams_by_parent_id_members_by_id"
      end
      # verify the required parameter 'sales_team_member' is set
      if @api_client.config.client_side_validation && sales_team_member.nil?
        fail ArgumentError, "Missing the required parameter 'sales_team_member' when calling SalesTeamMembersApi.put_sales_sales_teams_by_parent_id_members_by_id"
      end
      # resource path
      local_var_path = '/sales/salesTeams/{parentId}/members/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
