...
module ConnectWise
  class ProjectBoardTeamInfosApi
    ...
    def get_project_boards_by_parent_id_teams_by_id_info(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_project_boards_by_parent_id_teams_by_id_info_with_http_info(id, parent_id,
                                                                                                     client_id, opts)
      data
    end
    ...
    def get_project_boards_by_parent_id_teams_by_id_info_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info"
      end

      # resource path
      local_var_path = '/project/boards/{parentId}/teams/{id}/info'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_project_boards_by_parent_id_teams_by_id_info_count(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_project_boards_by_parent_id_teams_by_id_info_count_with_http_info(id,
    ...
    def get_project_boards_by_parent_id_teams_by_id_info_count_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info_count ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info_count"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_by_id_info_count"
      end

      # resource path
      local_var_path = '/project/boards/{parentId}/teams/{id}/info/count'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
        '{' + 'parentId' + '}', CGI.escape(parent_id.to_s)
      )
    ...
    def get_project_boards_by_parent_id_teams_info(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_project_boards_by_parent_id_teams_info_with_http_info(parent_id, client_id,
                                                                                               opts)
      data
    end
    ...
    def get_project_boards_by_parent_id_teams_info_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_info ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectBoardTeamInfosApi.get_project_boards_by_parent_id_teams_info"
      end
