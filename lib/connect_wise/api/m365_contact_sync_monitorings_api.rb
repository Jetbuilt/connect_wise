...
module ConnectWise
  class M365ContactSyncMonitoringsApi
    ...
    def delete_system_contactsync_monitoring_type_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.delete_system_contactsync_monitoring_type_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling M365ContactSyncMonitoringsApi.delete_system_contactsync_monitoring_type_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.delete_system_contactsync_monitoring_type_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_contactsync_monitoring_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_contactsync_monitoring_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_contactsync_monitoring_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_contactsync_monitoring_notificationtype_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_notificationtype ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_notificationtype" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_contactsync_monitoring_type_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_type_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_type_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.get_system_contactsync_monitoring_type_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_contactsync_monitoring_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.patch_system_contactsync_monitoring ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.patch_system_contactsync_monitoring" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def post_system_contactsync_monitoring_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: M365ContactSyncMonitoringsApi.post_system_contactsync_monitoring ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling M365ContactSyncMonitoringsApi.post_system_contactsync_monitoring" if @api_client.config.client_side_validation && client_id.nil?
