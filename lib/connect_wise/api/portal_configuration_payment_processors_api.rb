...
module ConnectWise
  class PortalConfigurationPaymentProcessorsApi
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors(client_id, opts = {})
      data, _status_code, _headers = get_company_portal_configurations_invoice_setup_payment_processors_with_http_info(
        client_id, opts
      )
      data
    end
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors"
      end
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_by_id(id, client_id, opts = {})
      data, _status_code, _headers = get_company_portal_configurations_invoice_setup_payment_processors_by_id_with_http_info(
        id, client_id, opts
      )
      data
    end
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_by_id_with_http_info(id, client_id,
                                                                                                opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_by_id"
      end

      # resource path
      local_var_path = '/company/portalConfigurations/invoiceSetup/paymentProcessors/{id}'.sub('{' + 'id' + '}',
                                                                                               CGI.escape(id.to_s))
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_count(client_id, opts = {})
      data, _status_code, _headers = get_company_portal_configurations_invoice_setup_payment_processors_count_with_http_info(
        client_id, opts
      )
      data
    end
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_count"
      end
