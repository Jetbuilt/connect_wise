  ...
  class PortalConfigurationPaymentProcessorsApi
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors"
      end
      # resource path
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_by_id"
      end
      # resource path
    ...
    def get_company_portal_configurations_invoice_setup_payment_processors_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PortalConfigurationPaymentProcessorsApi.get_company_portal_configurations_invoice_setup_payment_processors_count"
      end
      # resource path
