  ...
  class SubCategoriesApi
    ...
    def delete_procurement_subcategories_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.delete_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.delete_procurement_subcategories_by_id"
      end
    ...
    def get_procurement_subcategories_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories"
      end
    ...
    def get_procurement_subcategories_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id"
      end
    ...
    def get_procurement_subcategories_by_id_info_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_info"
      end
    ...
    def get_procurement_subcategories_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages"
      end
    ...
    def get_procurement_subcategories_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages_list"
      end
    ...
    def get_procurement_subcategories_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_count"
      end
    ...
    def get_procurement_subcategories_info_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_info"
      end
    ...
    def get_procurement_subcategories_info_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_info_count"
      end
    ...
    def patch_procurement_subcategories_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_procurement_subcategories_by_id_with_http_info(id, client_id,
    ...
    def patch_procurement_subcategories_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
    ...
    def post_procurement_subcategories_with_http_info(client_id, sub_category, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.post_procurement_subcategories"
      end
      # verify the required parameter 'sub_category' is set
      if @api_client.config.client_side_validation && sub_category.nil?
        raise ArgumentError,
              "Missing the required parameter 'sub_category' when calling SubCategoriesApi.post_procurement_subcategories"
      end
    ...
    def put_procurement_subcategories_by_id(id, client_id, sub_category, opts = {})
      data, _status_code, _headers = put_procurement_subcategories_by_id_with_http_info(id, client_id, sub_category,
                                                                                        opts)
      data
    end
    ...
    def put_procurement_subcategories_by_id_with_http_info(id, client_id, sub_category, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
      # verify the required parameter 'sub_category' is set
      if @api_client.config.client_side_validation && sub_category.nil?
        raise ArgumentError,
              "Missing the required parameter 'sub_category' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
