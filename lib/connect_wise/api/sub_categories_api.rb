  ...
  class SubCategoriesApi
    ...
    def delete_procurement_subcategories_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.delete_procurement_subcategories_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.delete_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.delete_procurement_subcategories_by_id"
      end
      # resource path
    ...
    def get_procurement_subcategories_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories"
      end
      # resource path
    ...
    def get_procurement_subcategories_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id"
      end
      # resource path
      local_var_path = '/procurement/subcategories/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_procurement_subcategories_by_id_info_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_by_id_info ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_info"
      end
      # resource path
    ...
    def get_procurement_subcategories_by_id_usages_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_by_id_usages ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages"
      end
      # resource path
    ...
    def get_procurement_subcategories_by_id_usages_list_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_by_id_usages_list ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_by_id_usages_list"
      end
      # resource path
    ...
    def get_procurement_subcategories_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_count"
      end
      # resource path
    ...
    def get_procurement_subcategories_info_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_info ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_info"
      end
      # resource path
    ...
    def get_procurement_subcategories_info_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.get_procurement_subcategories_info_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.get_procurement_subcategories_info_count"
      end
      # resource path
    ...
    def patch_procurement_subcategories_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.patch_procurement_subcategories_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling SubCategoriesApi.patch_procurement_subcategories_by_id"
      end
      # resource path
      local_var_path = '/procurement/subcategories/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_procurement_subcategories_with_http_info(client_id, sub_category, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.post_procurement_subcategories ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.post_procurement_subcategories"
      end
      # verify the required parameter 'sub_category' is set
      if @api_client.config.client_side_validation && sub_category.nil?
        fail ArgumentError, "Missing the required parameter 'sub_category' when calling SubCategoriesApi.post_procurement_subcategories"
      end
      # resource path
      local_var_path = '/procurement/subcategories/'
    ...
    def put_procurement_subcategories_by_id_with_http_info(id, client_id, sub_category, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SubCategoriesApi.put_procurement_subcategories_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
      # verify the required parameter 'sub_category' is set
      if @api_client.config.client_side_validation && sub_category.nil?
        fail ArgumentError, "Missing the required parameter 'sub_category' when calling SubCategoriesApi.put_procurement_subcategories_by_id"
      end
      # resource path
      local_var_path = '/procurement/subcategories/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
