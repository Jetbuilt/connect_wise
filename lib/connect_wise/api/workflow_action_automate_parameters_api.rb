...
module ConnectWise
  class WorkflowActionAutomateParametersApi
    ...
    def get_system_workflow_actions_automate_parameters_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: WorkflowActionAutomateParametersApi.get_system_workflow_actions_automate_parameters ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_automate_parameters" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_workflow_actions_automate_parameters_by_id(id, client_id, opts = {})
      data, _status_code, _headers = get_system_workflow_actions_automate_parameters_by_id_with_http_info(id, client_id, opts)
      data
    end
    ...
    def get_system_workflow_actions_automate_parameters_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: WorkflowActionAutomateParametersApi.get_system_workflow_actions_automate_parameters_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_automate_parameters_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_automate_parameters_by_id" if @api_client.config.client_side_validation && client_id.nil?
