  ...
  class WorkflowActionAutomateParametersApi
    ...
    def delete_system_workflow_actions_by_parent_id_automate_parameters_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionAutomateParametersApi.delete_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.delete_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.delete_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # resource path
    ...
    def get_system_workflow_actions_by_parent_id_automate_parameters_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters"
      end
      # resource path
    ...
    def get_system_workflow_actions_by_parent_id_automate_parameters_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # resource path
      local_var_path = '/system/workflowActions/{parentId}/automateParameters/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_system_workflow_actions_by_parent_id_automate_parameters_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.get_system_workflow_actions_by_parent_id_automate_parameters_count"
      end
      # resource path
    ...
    def patch_system_workflow_actions_by_parent_id_automate_parameters_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionAutomateParametersApi.patch_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.patch_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.patch_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling WorkflowActionAutomateParametersApi.patch_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # resource path
      local_var_path = '/system/workflowActions/{parentId}/automateParameters/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_system_workflow_actions_by_parent_id_automate_parameters_with_http_info(parent_id, client_id, workflow_action_automate_parameter, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.post_system_workflow_actions_by_parent_id_automate_parameters"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.post_system_workflow_actions_by_parent_id_automate_parameters"
      end
      ...
      if @api_client.config.client_side_validation && workflow_action_automate_parameter.nil?
        fail ArgumentError, "Missing the required parameter 'workflow_action_automate_parameter' when calling WorkflowActionAutomateParametersApi.post_system_workflow_actions_by_parent_id_automate_parameters"
      end
      # resource path
      local_var_path = '/system/workflowActions/{parentId}/automateParameters'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_system_workflow_actions_by_parent_id_automate_parameters_by_id_with_http_info(id, parent_id, client_id, workflow_action_automate_parameter, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WorkflowActionAutomateParametersApi.put_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionAutomateParametersApi.put_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionAutomateParametersApi.put_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # verify the required parameter 'workflow_action_automate_parameter' is set
      if @api_client.config.client_side_validation && workflow_action_automate_parameter.nil?
        fail ArgumentError, "Missing the required parameter 'workflow_action_automate_parameter' when calling WorkflowActionAutomateParametersApi.put_system_workflow_actions_by_parent_id_automate_parameters_by_id"
      end
      # resource path
      local_var_path = '/system/workflowActions/{parentId}/automateParameters/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
