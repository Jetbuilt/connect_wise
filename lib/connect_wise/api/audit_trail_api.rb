  ...
  class AuditTrailApi
    ...
    def get_system_audittrail_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AuditTrailApi.get_system_audittrail"
      end

      allowable_values = %w[None Ticket Contact Company Opportunity Time Activity ProductCatalog
                            ProjectTicket Purchasing Configuration Schedule Agreement AgreementAddition Project Invoice PurchaseOrder Expense ProductItem Survey Member PurchaseOrderLineItem]
    ...
    def get_system_audittrail_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AuditTrailApi.get_system_audittrail_count"
      end
