...
module ConnectWise
  class AuditTrailApi
    ...
    def get_system_audittrail_with_http_info(client_id, get_request, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'get_request' when calling AuditTrailApi.get_system_audittrail" if @api_client.config.client_side_validation && get_request.nil?
    ...
    def get_system_audittrail_count_with_http_info(client_id, get_request, opts = {})
      ...
      # verify the required parameter 'get_request' is set
      raise ArgumentError, "Missing the required parameter 'get_request' when calling AuditTrailApi.get_system_audittrail_count" if @api_client.config.client_side_validation && get_request.nil?
