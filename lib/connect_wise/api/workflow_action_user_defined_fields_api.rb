...
module ConnectWise
  class WorkflowActionUserDefinedFieldsApi
    ...
    def get_system_workflows_userdefinedfields_by_grandparent_id_actions_by_parent_id_with_http_info(parent_id, grandparent_id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: WorkflowActionUserDefinedFieldsApi.get_system_workflows_userdefinedfields_by_grandparent_id_actions_by_parent_id ...' if @api_client.config.debugging
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling WorkflowActionUserDefinedFieldsApi.get_system_workflows_userdefinedfields_by_grandparent_id_actions_by_parent_id" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'grandparent_id' is set
      raise ArgumentError, "Missing the required parameter 'grandparent_id' when calling WorkflowActionUserDefinedFieldsApi.get_system_workflows_userdefinedfields_by_grandparent_id_actions_by_parent_id" if @api_client.config.client_side_validation && grandparent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling WorkflowActionUserDefinedFieldsApi.get_system_workflows_userdefinedfields_by_grandparent_id_actions_by_parent_id" if @api_client.config.client_side_validation && client_id.nil?
