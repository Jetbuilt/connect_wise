  ...
  class DepartmentsApi
    ...
    def delete_system_departments_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.delete_system_departments_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.delete_system_departments_by_id"
      end
    ...
    def get_system_departments_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments"
      end
    ...
    def get_system_departments_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id"
      end
    ...
    def get_system_departments_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id_usages"
      end
    ...
    def get_system_departments_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id_usages_list"
      end
    ...
    def get_system_departments_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_count"
      end
    ...
    def patch_system_departments_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.patch_system_departments_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.patch_system_departments_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling DepartmentsApi.patch_system_departments_by_id"
      end
    ...
    def post_system_departments_with_http_info(client_id, department, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.post_system_departments"
      end
      # verify the required parameter 'department' is set
      if @api_client.config.client_side_validation && department.nil?
        raise ArgumentError,
              "Missing the required parameter 'department' when calling DepartmentsApi.post_system_departments"
      end
    ...
    def put_system_departments_by_id_with_http_info(id, client_id, department, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling DepartmentsApi.put_system_departments_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling DepartmentsApi.put_system_departments_by_id"
      end
      # verify the required parameter 'department' is set
      if @api_client.config.client_side_validation && department.nil?
        raise ArgumentError,
              "Missing the required parameter 'department' when calling DepartmentsApi.put_system_departments_by_id"
      end
