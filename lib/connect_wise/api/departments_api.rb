...
module ConnectWise
  class DepartmentsApi
    ...
    def delete_system_departments_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.delete_system_departments_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.delete_system_departments_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.delete_system_departments_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_departments_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.get_system_departments ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_departments_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.get_system_departments_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_departments_by_id_usages_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.get_system_departments_by_id_usages ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id_usages" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id_usages" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_departments_by_id_usages_list_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.get_system_departments_by_id_usages_list ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.get_system_departments_by_id_usages_list" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_by_id_usages_list" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_departments_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.get_system_departments_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.get_system_departments_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_departments_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.patch_system_departments_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.patch_system_departments_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.patch_system_departments_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling DepartmentsApi.patch_system_departments_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_system_departments_with_http_info(client_id, department, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.post_system_departments ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.post_system_departments" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'department' is set
      raise ArgumentError, "Missing the required parameter 'department' when calling DepartmentsApi.post_system_departments" if @api_client.config.client_side_validation && department.nil?
    ...
    def put_system_departments_by_id_with_http_info(id, client_id, department, opts = {})
      @api_client.config.logger.debug 'Calling API: DepartmentsApi.put_system_departments_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling DepartmentsApi.put_system_departments_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling DepartmentsApi.put_system_departments_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'department' is set
      raise ArgumentError, "Missing the required parameter 'department' when calling DepartmentsApi.put_system_departments_by_id" if @api_client.config.client_side_validation && department.nil?
