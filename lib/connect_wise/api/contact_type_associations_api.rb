  ...
  class ContactTypeAssociationsApi
    ...
    def delete_company_contact_type_associations_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.delete_company_contact_type_associations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.delete_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.delete_company_contact_type_associations_by_id"
      end
    ...
    def get_company_contact_type_associations_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.get_company_contact_type_associations ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations"
      end
    ...
    def get_company_contact_type_associations_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.get_company_contact_type_associations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_by_id"
      end
    ...
    def get_company_contact_type_associations_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.get_company_contact_type_associations_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_count"
      end
    ...
    def patch_company_contact_type_associations_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_company_contact_type_associations_by_id_with_http_info(id, client_id,
    ...
    def patch_company_contact_type_associations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
    ...
    def post_company_contact_type_associations(client_id, company_contact_type_association, opts = {})
      data, _status_code, _headers = post_company_contact_type_associations_with_http_info(client_id,
                                                                                           company_contact_type_association, opts)
      data
    end
    ...
    def post_company_contact_type_associations_with_http_info(client_id, company_contact_type_association, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.post_company_contact_type_associations ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.post_company_contact_type_associations"
      end
      # verify the required parameter 'company_contact_type_association' is set
      if @api_client.config.client_side_validation && company_contact_type_association.nil?
        raise ArgumentError,
              "Missing the required parameter 'company_contact_type_association' when calling ContactTypeAssociationsApi.post_company_contact_type_associations"
      end
    ...
    def put_company_contact_type_associations_by_id(id, client_id, company_contact_type_association, opts = {})
      data, _status_code, _headers = put_company_contact_type_associations_by_id_with_http_info(id, client_id,
                                                                                                company_contact_type_association, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CompanyContactTypeAssociation, Integer, Hash)>] CompanyContactTypeAssociation data, response status code and response headers
    def put_company_contact_type_associations_by_id_with_http_info(id, client_id, company_contact_type_association,
                                                                   opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactTypeAssociationsApi.put_company_contact_type_associations_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'company_contact_type_association' is set
      if @api_client.config.client_side_validation && company_contact_type_association.nil?
        raise ArgumentError,
              "Missing the required parameter 'company_contact_type_association' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
