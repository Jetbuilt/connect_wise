  ...
  class ContactTypeAssociationsApi
    ...
    def delete_company_contact_type_associations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.delete_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.delete_company_contact_type_associations_by_id"
      end
      # resource path
    ...
    def get_company_contact_type_associations_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations"
      end
      # resource path
    ...
    def get_company_contact_type_associations_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_by_id"
      end
      # resource path
      local_var_path = '/company/contactTypeAssociations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_company_contact_type_associations_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.get_company_contact_type_associations_count"
      end
      # resource path
    ...
    def patch_company_contact_type_associations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ContactTypeAssociationsApi.patch_company_contact_type_associations_by_id"
      end
      # resource path
      local_var_path = '/company/contactTypeAssociations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_company_contact_type_associations_with_http_info(client_id, company_contact_type_association, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.post_company_contact_type_associations"
      end
      ...
      if @api_client.config.client_side_validation && company_contact_type_association.nil?
        fail ArgumentError, "Missing the required parameter 'company_contact_type_association' when calling ContactTypeAssociationsApi.post_company_contact_type_associations"
      end
      # resource path
      local_var_path = '/company/contactTypeAssociations'
    ...
    def put_company_contact_type_associations_by_id_with_http_info(id, client_id, company_contact_type_association, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
      # verify the required parameter 'company_contact_type_association' is set
      if @api_client.config.client_side_validation && company_contact_type_association.nil?
        fail ArgumentError, "Missing the required parameter 'company_contact_type_association' when calling ContactTypeAssociationsApi.put_company_contact_type_associations_by_id"
      end
      # resource path
      local_var_path = '/company/contactTypeAssociations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
