  ...
  class ReportingServicesApi
    ...
    def get_system_mycompany_reporting_services_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ReportingServicesApi.get_system_mycompany_reporting_services"
      end
      # resource path
    ...
    def get_system_mycompany_reporting_services_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ReportingServicesApi.get_system_mycompany_reporting_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ReportingServicesApi.get_system_mycompany_reporting_services_by_id"
      end
      # resource path
    ...
    def patch_system_mycompany_reporting_services_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ReportingServicesApi.patch_system_mycompany_reporting_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ReportingServicesApi.patch_system_mycompany_reporting_services_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ReportingServicesApi.patch_system_mycompany_reporting_services_by_id"
      end
      # resource path
      local_var_path = '/system/mycompany/reportingServices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_system_mycompany_reporting_services_by_id_test_connection_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ReportingServicesApi.post_system_mycompany_reporting_services_by_id_test_connection"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ReportingServicesApi.post_system_mycompany_reporting_services_by_id_test_connection"
      end
      # resource path
    ...
    def put_system_mycompany_reporting_services_by_id_with_http_info(id, client_id, reporting_service, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ReportingServicesApi.put_system_mycompany_reporting_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ReportingServicesApi.put_system_mycompany_reporting_services_by_id"
      end
      # verify the required parameter 'reporting_service' is set
      if @api_client.config.client_side_validation && reporting_service.nil?
        fail ArgumentError, "Missing the required parameter 'reporting_service' when calling ReportingServicesApi.put_system_mycompany_reporting_services_by_id"
      end
      # resource path
      local_var_path = '/system/mycompany/reportingServices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
