  ...
  class ScheduleStopwatchApi
    ...
    def delete_time_schedulestopwatches_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.delete_time_schedulestopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleStopwatchApi.delete_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.delete_time_schedulestopwatches_by_id"
      end
      # resource path
    ...
    def get_time_schedulestopwatches_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.get_time_schedulestopwatches ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.get_time_schedulestopwatches"
      end
      # resource path
    ...
    def get_time_schedulestopwatches_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.get_time_schedulestopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleStopwatchApi.get_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.get_time_schedulestopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/schedulestopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_time_schedulestopwatches_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.get_time_schedulestopwatches_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.get_time_schedulestopwatches_count"
      end
      # resource path
    ...
    def patch_time_schedulestopwatches_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.patch_time_schedulestopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleStopwatchApi.patch_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.patch_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ScheduleStopwatchApi.patch_time_schedulestopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/schedulestopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_time_schedulestopwatches_with_http_info(client_id, schedule_stopwatch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.post_time_schedulestopwatches ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.post_time_schedulestopwatches"
      end
      ...
      if @api_client.config.client_side_validation && schedule_stopwatch.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_stopwatch' when calling ScheduleStopwatchApi.post_time_schedulestopwatches"
      end
      # resource path
      local_var_path = '/time/schedulestopwatches'
    ...
    def put_time_schedulestopwatches_by_id_with_http_info(id, client_id, schedule_stopwatch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScheduleStopwatchApi.put_time_schedulestopwatches_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ScheduleStopwatchApi.put_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ScheduleStopwatchApi.put_time_schedulestopwatches_by_id"
      end
      # verify the required parameter 'schedule_stopwatch' is set
      if @api_client.config.client_side_validation && schedule_stopwatch.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_stopwatch' when calling ScheduleStopwatchApi.put_time_schedulestopwatches_by_id"
      end
      # resource path
      local_var_path = '/time/schedulestopwatches/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
