  ...
  class OpportunitiesApi
    ...
    def delete_sales_opportunities_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.delete_sales_opportunities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.delete_sales_opportunities_by_id"
      end
      # resource path
    ...
    def get_sales_opportunities_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.get_sales_opportunities"
      end
      # resource path
    ...
    def get_sales_opportunities_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.get_sales_opportunities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.get_sales_opportunities_by_id"
      end
      # resource path
      local_var_path = '/sales/opportunities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_sales_opportunities_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.get_sales_opportunities_count"
      end
      # resource path
    ...
    def get_sales_opportunities_default_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.get_sales_opportunities_default"
      end
      # resource path
    ...
    def patch_sales_opportunities_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.patch_sales_opportunities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.patch_sales_opportunities_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling OpportunitiesApi.patch_sales_opportunities_by_id"
      end
      # resource path
      local_var_path = '/sales/opportunities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_sales_opportunities_with_http_info(client_id, opportunity, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.post_sales_opportunities"
      end
      # verify the required parameter 'opportunity' is set
      if @api_client.config.client_side_validation && opportunity.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity' when calling OpportunitiesApi.post_sales_opportunities"
      end
      # resource path
      local_var_path = '/sales/opportunities'
    ...
    def post_sales_opportunities_by_id_convert_to_agreement_with_http_info(id, client_id, opportunity_to_agreement_conversion, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_agreement"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_agreement"
      end
      ...
      if @api_client.config.client_side_validation && opportunity_to_agreement_conversion.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity_to_agreement_conversion' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_agreement"
      end
      # resource path
    ...
    def post_sales_opportunities_by_id_convert_to_project_with_http_info(id, client_id, opportunity_to_project_conversion, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_project"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_project"
      end
      ...
      if @api_client.config.client_side_validation && opportunity_to_project_conversion.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity_to_project_conversion' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_project"
      end
      # resource path
    ...
    def post_sales_opportunities_by_id_convert_to_sales_order_with_http_info(id, client_id, opportunity_to_sales_order_conversion, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_sales_order"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_sales_order"
      end
      ...
      if @api_client.config.client_side_validation && opportunity_to_sales_order_conversion.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity_to_sales_order_conversion' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_sales_order"
      end
      # resource path
    ...
    def post_sales_opportunities_by_id_convert_to_service_ticket_with_http_info(id, client_id, opportunity_to_service_ticket_conversion, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_service_ticket"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_service_ticket"
      end
      ...
      if @api_client.config.client_side_validation && opportunity_to_service_ticket_conversion.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity_to_service_ticket_conversion' when calling OpportunitiesApi.post_sales_opportunities_by_id_convert_to_service_ticket"
      end
      # resource path
    ...
    def put_sales_opportunities_by_id_with_http_info(id, client_id, opportunity, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OpportunitiesApi.put_sales_opportunities_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling OpportunitiesApi.put_sales_opportunities_by_id"
      end
      # verify the required parameter 'opportunity' is set
      if @api_client.config.client_side_validation && opportunity.nil?
        fail ArgumentError, "Missing the required parameter 'opportunity' when calling OpportunitiesApi.put_sales_opportunities_by_id"
      end
      # resource path
      local_var_path = '/sales/opportunities/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
