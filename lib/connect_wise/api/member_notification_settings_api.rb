  ...
  class MemberNotificationSettingsApi
    ...
    def delete_system_members_by_parent_id_notification_settings_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MemberNotificationSettingsApi.delete_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.delete_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.delete_system_members_by_parent_id_notification_settings_by_id"
      end
      # resource path
    ...
    def get_system_members_by_parent_id_notification_settings_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings"
      end
      # resource path
    ...
    def get_system_members_by_parent_id_notification_settings_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings_by_id"
      end
      # resource path
      local_var_path = '/system/members/{parentId}/notificationSettings/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_system_members_by_parent_id_notification_settings_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.get_system_members_by_parent_id_notification_settings_count"
      end
      # resource path
    ...
    def patch_system_members_by_parent_id_notification_settings_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MemberNotificationSettingsApi.patch_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.patch_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.patch_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling MemberNotificationSettingsApi.patch_system_members_by_parent_id_notification_settings_by_id"
      end
      # resource path
      local_var_path = '/system/members/{parentId}/notificationSettings/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_system_members_by_parent_id_notification_settings_with_http_info(parent_id, client_id, member_notification_setting, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.post_system_members_by_parent_id_notification_settings"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.post_system_members_by_parent_id_notification_settings"
      end
      ...
      if @api_client.config.client_side_validation && member_notification_setting.nil?
        fail ArgumentError, "Missing the required parameter 'member_notification_setting' when calling MemberNotificationSettingsApi.post_system_members_by_parent_id_notification_settings"
      end
      # resource path
      local_var_path = '/system/members/{parentId}/notificationSettings'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_system_members_by_parent_id_notification_settings_by_id_with_http_info(id, parent_id, client_id, member_notification_setting, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MemberNotificationSettingsApi.put_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MemberNotificationSettingsApi.put_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberNotificationSettingsApi.put_system_members_by_parent_id_notification_settings_by_id"
      end
      # verify the required parameter 'member_notification_setting' is set
      if @api_client.config.client_side_validation && member_notification_setting.nil?
        fail ArgumentError, "Missing the required parameter 'member_notification_setting' when calling MemberNotificationSettingsApi.put_system_members_by_parent_id_notification_settings_by_id"
      end
      # resource path
      local_var_path = '/system/members/{parentId}/notificationSettings/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
