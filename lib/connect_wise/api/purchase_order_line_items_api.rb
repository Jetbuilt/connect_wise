  ...
  class PurchaseOrderLineItemsApi
    ...
    def delete_procurement_purchaseorders_by_parent_id_lineitems_bulk_with_http_info(parent_id, client_id, id_collection, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'id_collection' is set
      if @api_client.config.client_side_validation && id_collection.nil?
        fail ArgumentError, "Missing the required parameter 'id_collection' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # resource path
    ...
    def delete_procurement_purchaseorders_by_parent_id_lineitems_by_id_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # resource path
    ...
    def get_procurement_purchaseorders_by_parent_id_lineitems_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems"
      end
      # resource path
    ...
    def get_procurement_purchaseorders_by_parent_id_lineitems_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_procurement_purchaseorders_by_parent_id_lineitems_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.get_procurement_purchaseorders_by_parent_id_lineitems_count"
      end
      # resource path
    ...
    def patch_procurement_purchaseorders_by_parent_id_lineitems_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderLineItemsApi.patch_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.patch_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.patch_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling PurchaseOrderLineItemsApi.patch_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_procurement_purchaseorders_by_parent_id_lineitems_with_http_info(parent_id, client_id, purchase_order_line_item, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems"
      end
      ...
      if @api_client.config.client_side_validation && purchase_order_line_item.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_line_item' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_procurement_purchaseorders_by_parent_id_lineitems_bulk_with_http_info(parent_id, client_id, purchase_order_line_item, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'purchase_order_line_item' is set
      if @api_client.config.client_side_validation && purchase_order_line_item.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_line_item' when calling PurchaseOrderLineItemsApi.post_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems/bulk'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_procurement_purchaseorders_by_parent_id_lineitems_bulk_with_http_info(parent_id, client_id, purchase_order_line_item, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # verify the required parameter 'purchase_order_line_item' is set
      if @api_client.config.client_side_validation && purchase_order_line_item.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_line_item' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_bulk"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems/bulk'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_procurement_purchaseorders_by_parent_id_lineitems_by_id_with_http_info(id, parent_id, client_id, purchase_order_line_item, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # verify the required parameter 'purchase_order_line_item' is set
      if @api_client.config.client_side_validation && purchase_order_line_item.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_line_item' when calling PurchaseOrderLineItemsApi.put_procurement_purchaseorders_by_parent_id_lineitems_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
