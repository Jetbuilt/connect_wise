...
module ConnectWise
  class PurchaseOrderLineItemsApi
    ...
    def delete_procurement_purchaseorders_by_parent_id_lineitems_with_http_info(parent_id, client_id, id, opts = {})
      @api_client.config.logger.debug 'Calling API: PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems ...' if @api_client.config.debugging
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderLineItemsApi.delete_procurement_purchaseorders_by_parent_id_lineitems" if @api_client.config.client_side_validation && id.nil?

      # resource path
      local_var_path = '/procurement/purchaseorders/{parentId}/lineitems'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s)).sub('{' + 'id' + '}', CGI.escape(id.to_s))
