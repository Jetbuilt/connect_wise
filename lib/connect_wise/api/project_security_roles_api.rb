  ...
  class ProjectSecurityRolesApi
    ...
    def delete_project_security_roles_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.delete_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.delete_project_security_roles_by_id"
      end
    ...
    def get_project_security_roles_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles"
      end
    ...
    def get_project_security_roles_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.get_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles_by_id"
      end
    ...
    def get_project_security_roles_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles_count"
      end
    ...
    def patch_project_security_roles_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_project_security_roles_by_id_with_http_info(id, client_id, patch_operation,
                                                                                       opts)
      data
    end
    ...
    def patch_project_security_roles_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
    ...
    def post_project_security_roles_with_http_info(client_id, project_security_role, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.post_project_security_roles"
      end
      ...
      if @api_client.config.client_side_validation && project_security_role.nil?
        raise ArgumentError,
              "Missing the required parameter 'project_security_role' when calling ProjectSecurityRolesApi.post_project_security_roles"
      end
    ...
    def put_project_security_roles_by_id(id, client_id, project_security_role, opts = {})
      data, _status_code, _headers = put_project_security_roles_by_id_with_http_info(id, client_id,
                                                                                     project_security_role, opts)
      data
    end
    ...
    def put_project_security_roles_by_id_with_http_info(id, client_id, project_security_role, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
      # verify the required parameter 'project_security_role' is set
      if @api_client.config.client_side_validation && project_security_role.nil?
        raise ArgumentError,
              "Missing the required parameter 'project_security_role' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
