  ...
  class ProjectSecurityRolesApi
    ...
    def delete_project_security_roles_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.delete_project_security_roles_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.delete_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.delete_project_security_roles_by_id"
      end
      # resource path
    ...
    def get_project_security_roles_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.get_project_security_roles ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles"
      end
      # resource path
    ...
    def get_project_security_roles_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.get_project_security_roles_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.get_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles_by_id"
      end
      # resource path
      local_var_path = '/project/securityRoles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_project_security_roles_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.get_project_security_roles_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.get_project_security_roles_count"
      end
      # resource path
    ...
    def patch_project_security_roles_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.patch_project_security_roles_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ProjectSecurityRolesApi.patch_project_security_roles_by_id"
      end
      # resource path
      local_var_path = '/project/securityRoles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_project_security_roles_with_http_info(client_id, project_security_role, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.post_project_security_roles ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.post_project_security_roles"
      end
      ...
      if @api_client.config.client_side_validation && project_security_role.nil?
        fail ArgumentError, "Missing the required parameter 'project_security_role' when calling ProjectSecurityRolesApi.post_project_security_roles"
      end
      # resource path
      local_var_path = '/project/securityRoles'
    ...
    def put_project_security_roles_by_id_with_http_info(id, client_id, project_security_role, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectSecurityRolesApi.put_project_security_roles_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
      # verify the required parameter 'project_security_role' is set
      if @api_client.config.client_side_validation && project_security_role.nil?
        fail ArgumentError, "Missing the required parameter 'project_security_role' when calling ProjectSecurityRolesApi.put_project_security_roles_by_id"
      end
      # resource path
      local_var_path = '/project/securityRoles/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
