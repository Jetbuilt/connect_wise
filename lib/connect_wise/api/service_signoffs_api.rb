  ...
  class ServiceSignoffsApi
    ...
    def delete_service_service_signoff_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.delete_service_service_signoff_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.delete_service_service_signoff_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.delete_service_service_signoff_by_id"
      end
      # resource path
    ...
    def get_service_service_signoff_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.get_service_service_signoff ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.get_service_service_signoff"
      end
      # resource path
    ...
    def get_service_service_signoff_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.get_service_service_signoff_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id"
      end
      # resource path
      local_var_path = '/service/serviceSignoff/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_service_service_signoff_by_id_usages_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.get_service_service_signoff_by_id_usages ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id_usages"
      end
      # resource path
    ...
    def get_service_service_signoff_by_id_usages_list_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.get_service_service_signoff_by_id_usages_list ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.get_service_service_signoff_by_id_usages_list"
      end
      # resource path
    ...
    def get_service_service_signoff_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.get_service_service_signoff_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.get_service_service_signoff_count"
      end
      # resource path
    ...
    def patch_service_service_signoff_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.patch_service_service_signoff_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.patch_service_service_signoff_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.patch_service_service_signoff_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ServiceSignoffsApi.patch_service_service_signoff_by_id"
      end
      # resource path
      local_var_path = '/service/serviceSignoff/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_service_service_signoff_with_http_info(client_id, service_signoff, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.post_service_service_signoff ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.post_service_service_signoff"
      end
      # verify the required parameter 'service_signoff' is set
      if @api_client.config.client_side_validation && service_signoff.nil?
        fail ArgumentError, "Missing the required parameter 'service_signoff' when calling ServiceSignoffsApi.post_service_service_signoff"
      end
      # resource path
      local_var_path = '/service/serviceSignoff'
    ...
    def put_service_service_signoff_by_id_with_http_info(id, client_id, service_signoff, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServiceSignoffsApi.put_service_service_signoff_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSignoffsApi.put_service_service_signoff_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSignoffsApi.put_service_service_signoff_by_id"
      end
      # verify the required parameter 'service_signoff' is set
      if @api_client.config.client_side_validation && service_signoff.nil?
        fail ArgumentError, "Missing the required parameter 'service_signoff' when calling ServiceSignoffsApi.put_service_service_signoff_by_id"
      end
      # resource path
      local_var_path = '/service/serviceSignoff/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
