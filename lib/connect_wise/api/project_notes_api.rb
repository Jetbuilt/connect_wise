  ...
  class ProjectNotesApi
    ...
    def delete_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectNotesApi.delete_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.delete_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.delete_project_projects_by_parent_id_notes_by_id"
      end

      # resource path
      local_var_path = '/project/projects/{parentId}/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_project_projects_by_parent_id_notes_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes"
      end
    ...
    def get_project_projects_by_parent_id_notes_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id,
                                                                                                  client_id, opts)
      data
    end
    ...
    def get_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes_by_id"
      end
    ...
    def get_project_projects_by_parent_id_notes_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_project_projects_by_parent_id_notes_count_with_http_info(parent_id, client_id,
                                                                                                  opts)
      data
    end
    ...
    def get_project_projects_by_parent_id_notes_count_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.get_project_projects_by_parent_id_notes_count"
      end

      # resource path
      local_var_path = '/project/projects/{parentId}/notes/count'.sub('{' + 'parentId' + '}',
    ...
    def patch_project_projects_by_parent_id_notes_by_id(id, parent_id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ProjectNote, Integer, Hash)>] ProjectNote data, response status code and response headers
    def patch_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, patch_operation,
                                                                       opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectNotesApi.patch_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.patch_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.patch_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling ProjectNotesApi.patch_project_projects_by_parent_id_notes_by_id"
      end
    ...
    def post_project_projects_by_parent_id_notes(parent_id, client_id, project_note, opts = {})
      data, _status_code, _headers = post_project_projects_by_parent_id_notes_with_http_info(parent_id, client_id,
                                                                                             project_note, opts)
      data
    end
    ...
    def post_project_projects_by_parent_id_notes_with_http_info(parent_id, client_id, project_note, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.post_project_projects_by_parent_id_notes"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.post_project_projects_by_parent_id_notes"
      end
      # verify the required parameter 'project_note' is set
      if @api_client.config.client_side_validation && project_note.nil?
        raise ArgumentError,
              "Missing the required parameter 'project_note' when calling ProjectNotesApi.post_project_projects_by_parent_id_notes"
      end
    ...
    def put_project_projects_by_parent_id_notes_by_id(id, parent_id, client_id, project_note, opts = {})
      data, _status_code, _headers = put_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id,
                                                                                                  client_id, project_note, opts)
      data
    end
    ...
    def put_project_projects_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, project_note, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ProjectNotesApi.put_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ProjectNotesApi.put_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ProjectNotesApi.put_project_projects_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'project_note' is set
      if @api_client.config.client_side_validation && project_note.nil?
        raise ArgumentError,
              "Missing the required parameter 'project_note' when calling ProjectNotesApi.put_project_projects_by_parent_id_notes_by_id"
      end
