  ...
  class CampaignFormsSubmittedApi
    ...
    def delete_marketing_campaigns_by_parent_id_forms_submitted_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignFormsSubmittedApi.delete_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.delete_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.delete_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # resource path
    ...
    def get_marketing_campaigns_by_parent_id_forms_submitted_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted"
      end
      # resource path
    ...
    def get_marketing_campaigns_by_parent_id_forms_submitted_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/formsSubmitted/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_marketing_campaigns_by_parent_id_forms_submitted_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.get_marketing_campaigns_by_parent_id_forms_submitted_count"
      end
      # resource path
    ...
    def patch_marketing_campaigns_by_parent_id_forms_submitted_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignFormsSubmittedApi.patch_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.patch_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.patch_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CampaignFormsSubmittedApi.patch_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/formsSubmitted/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_marketing_campaigns_by_parent_id_forms_submitted_with_http_info(parent_id, client_id, form_submitted, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.post_marketing_campaigns_by_parent_id_forms_submitted"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.post_marketing_campaigns_by_parent_id_forms_submitted"
      end
      # verify the required parameter 'form_submitted' is set
      if @api_client.config.client_side_validation && form_submitted.nil?
        fail ArgumentError, "Missing the required parameter 'form_submitted' when calling CampaignFormsSubmittedApi.post_marketing_campaigns_by_parent_id_forms_submitted"
      end
      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/formsSubmitted'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_marketing_campaigns_by_parent_id_forms_submitted_by_id_with_http_info(id, parent_id, client_id, form_submitted, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CampaignFormsSubmittedApi.put_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling CampaignFormsSubmittedApi.put_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CampaignFormsSubmittedApi.put_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # verify the required parameter 'form_submitted' is set
      if @api_client.config.client_side_validation && form_submitted.nil?
        fail ArgumentError, "Missing the required parameter 'form_submitted' when calling CampaignFormsSubmittedApi.put_marketing_campaigns_by_parent_id_forms_submitted_by_id"
      end
      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/formsSubmitted/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
