  ...
  class CampaignAuditsApi
    ...
    def delete_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CampaignAuditsApi.delete_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.delete_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.delete_marketing_campaigns_by_parent_id_audits_by_id"
      end

      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/audits/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_marketing_campaigns_by_parent_id_audits(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_marketing_campaigns_by_parent_id_audits_with_http_info(parent_id, client_id,
                                                                                                opts)
      data
    end
    ...
    def get_marketing_campaigns_by_parent_id_audits_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits"
      end
    ...
    def get_marketing_campaigns_by_parent_id_audits_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id,
                                                                                                      client_id, opts)
      data
    end
    ...
    def get_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits_by_id"
      end
    ...
    def get_marketing_campaigns_by_parent_id_audits_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_marketing_campaigns_by_parent_id_audits_count_with_http_info(parent_id,
                                                                                                      client_id, opts)
      data
    end
    ...
    def get_marketing_campaigns_by_parent_id_audits_count_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.get_marketing_campaigns_by_parent_id_audits_count"
      end

      # resource path
      local_var_path = '/marketing/campaigns/{parentId}/audits/count'.sub('{' + 'parentId' + '}',
    ...
    def patch_marketing_campaigns_by_parent_id_audits_by_id(id, parent_id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CampaignAudit, Integer, Hash)>] CampaignAudit data, response status code and response headers
    def patch_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id, client_id, patch_operation,
                                                                           opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CampaignAuditsApi.patch_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.patch_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.patch_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling CampaignAuditsApi.patch_marketing_campaigns_by_parent_id_audits_by_id"
      end
    ...
    def post_marketing_campaigns_by_parent_id_audits(parent_id, client_id, campaign_audit, opts = {})
      data, _status_code, _headers = post_marketing_campaigns_by_parent_id_audits_with_http_info(parent_id, client_id,
                                                                                                 campaign_audit, opts)
      data
    end
    ...
    def post_marketing_campaigns_by_parent_id_audits_with_http_info(parent_id, client_id, campaign_audit, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.post_marketing_campaigns_by_parent_id_audits"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.post_marketing_campaigns_by_parent_id_audits"
      end
      # verify the required parameter 'campaign_audit' is set
      if @api_client.config.client_side_validation && campaign_audit.nil?
        raise ArgumentError,
              "Missing the required parameter 'campaign_audit' when calling CampaignAuditsApi.post_marketing_campaigns_by_parent_id_audits"
      end
    ...
    def put_marketing_campaigns_by_parent_id_audits_by_id(id, parent_id, client_id, campaign_audit, opts = {})
      data, _status_code, _headers = put_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id,
                                                                                                      client_id, campaign_audit, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CampaignAudit, Integer, Hash)>] CampaignAudit data, response status code and response headers
    def put_marketing_campaigns_by_parent_id_audits_by_id_with_http_info(id, parent_id, client_id, campaign_audit,
                                                                         opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CampaignAuditsApi.put_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling CampaignAuditsApi.put_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CampaignAuditsApi.put_marketing_campaigns_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'campaign_audit' is set
      if @api_client.config.client_side_validation && campaign_audit.nil?
        raise ArgumentError,
              "Missing the required parameter 'campaign_audit' when calling CampaignAuditsApi.put_marketing_campaigns_by_parent_id_audits_by_id"
      end
