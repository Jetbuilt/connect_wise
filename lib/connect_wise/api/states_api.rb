...
module ConnectWise
  class StatesApi
    ...
    def delete_company_states_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.delete_company_states_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.delete_company_states_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.delete_company_states_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_states_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.get_company_states" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_states_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.get_company_states_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.get_company_states_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.get_company_states_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_states_by_id_usages_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.get_company_states_by_id_usages ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.get_company_states_by_id_usages" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.get_company_states_by_id_usages" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_states_by_id_usages_list_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.get_company_states_by_id_usages_list ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.get_company_states_by_id_usages_list" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.get_company_states_by_id_usages_list" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_company_states_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.get_company_states_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.get_company_states_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_company_states_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.patch_company_states_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.patch_company_states_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.patch_company_states_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling StatesApi.patch_company_states_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_company_states_with_http_info(client_id, state, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.post_company_states" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'state' is set
      raise ArgumentError, "Missing the required parameter 'state' when calling StatesApi.post_company_states" if @api_client.config.client_side_validation && state.nil?
    ...
    def put_company_states_by_id_with_http_info(id, client_id, state, opts = {})
      @api_client.config.logger.debug 'Calling API: StatesApi.put_company_states_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling StatesApi.put_company_states_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling StatesApi.put_company_states_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'state' is set
      raise ArgumentError, "Missing the required parameter 'state' when calling StatesApi.put_company_states_by_id" if @api_client.config.client_side_validation && state.nil?
