  ...
  class RmaTagsApi
    ...
    def delete_procurement_rma_tags_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling RmaTagsApi.delete_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.delete_procurement_rma_tags_by_id"
      end
      # resource path
    ...
    def get_procurement_rma_tags_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.get_procurement_rma_tags"
      end
      # resource path
    ...
    def get_procurement_rma_tags_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling RmaTagsApi.get_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.get_procurement_rma_tags_by_id"
      end
      # resource path
      local_var_path = '/procurement/rmaTags/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_procurement_rma_tags_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.get_procurement_rma_tags_count"
      end
      # resource path
    ...
    def get_procurement_rma_tags_default_with_http_info(client_id, product_id, billing_log_id, ticket_id, project_id, sales_order_id, company_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'product_id' is set
      if @api_client.config.client_side_validation && product_id.nil?
        fail ArgumentError, "Missing the required parameter 'product_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'billing_log_id' is set
      if @api_client.config.client_side_validation && billing_log_id.nil?
        fail ArgumentError, "Missing the required parameter 'billing_log_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'ticket_id' is set
      if @api_client.config.client_side_validation && ticket_id.nil?
        fail ArgumentError, "Missing the required parameter 'ticket_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'sales_order_id' is set
      if @api_client.config.client_side_validation && sales_order_id.nil?
        fail ArgumentError, "Missing the required parameter 'sales_order_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling RmaTagsApi.get_procurement_rma_tags_default"
      end
      # resource path
    ...
    def patch_procurement_rma_tags_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling RmaTagsApi.patch_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.patch_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling RmaTagsApi.patch_procurement_rma_tags_by_id"
      end
      # resource path
      local_var_path = '/procurement/rmaTags/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_procurement_rma_tags_with_http_info(client_id, rma_tag, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.post_procurement_rma_tags"
      end
      # verify the required parameter 'rma_tag' is set
      if @api_client.config.client_side_validation && rma_tag.nil?
        fail ArgumentError, "Missing the required parameter 'rma_tag' when calling RmaTagsApi.post_procurement_rma_tags"
      end
      # resource path
      local_var_path = '/procurement/rmaTags'
    ...
    def put_procurement_rma_tags_by_id_with_http_info(id, client_id, rma_tag, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling RmaTagsApi.put_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling RmaTagsApi.put_procurement_rma_tags_by_id"
      end
      # verify the required parameter 'rma_tag' is set
      if @api_client.config.client_side_validation && rma_tag.nil?
        fail ArgumentError, "Missing the required parameter 'rma_tag' when calling RmaTagsApi.put_procurement_rma_tags_by_id"
      end
      # resource path
      local_var_path = '/procurement/rmaTags/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
