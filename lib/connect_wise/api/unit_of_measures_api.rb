  ...
  class UnitOfMeasuresApi
    ...
    def delete_procurement_unit_of_measures_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.delete_procurement_unit_of_measures_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.delete_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.delete_procurement_unit_of_measures_by_id"
      end
      # resource path
    ...
    def get_procurement_unit_of_measures_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.get_procurement_unit_of_measures ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.get_procurement_unit_of_measures"
      end
      # resource path
    ...
    def get_procurement_unit_of_measures_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.get_procurement_unit_of_measures_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.get_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.get_procurement_unit_of_measures_by_id"
      end
      # resource path
      local_var_path = '/procurement/unitOfMeasures/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_procurement_unit_of_measures_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.get_procurement_unit_of_measures_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.get_procurement_unit_of_measures_count"
      end
      # resource path
    ...
    def patch_procurement_unit_of_measures_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.patch_procurement_unit_of_measures_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.patch_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.patch_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling UnitOfMeasuresApi.patch_procurement_unit_of_measures_by_id"
      end
      # resource path
      local_var_path = '/procurement/unitOfMeasures/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_procurement_unit_of_measures_with_http_info(client_id, unit_of_measure, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.post_procurement_unit_of_measures ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.post_procurement_unit_of_measures"
      end
      # verify the required parameter 'unit_of_measure' is set
      if @api_client.config.client_side_validation && unit_of_measure.nil?
        fail ArgumentError, "Missing the required parameter 'unit_of_measure' when calling UnitOfMeasuresApi.post_procurement_unit_of_measures"
      end
      # resource path
      local_var_path = '/procurement/unitOfMeasures'
    ...
    def put_procurement_unit_of_measures_by_id_with_http_info(id, client_id, unit_of_measure, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UnitOfMeasuresApi.put_procurement_unit_of_measures_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UnitOfMeasuresApi.put_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling UnitOfMeasuresApi.put_procurement_unit_of_measures_by_id"
      end
      # verify the required parameter 'unit_of_measure' is set
      if @api_client.config.client_side_validation && unit_of_measure.nil?
        fail ArgumentError, "Missing the required parameter 'unit_of_measure' when calling UnitOfMeasuresApi.put_procurement_unit_of_measures_by_id"
      end
      # resource path
      local_var_path = '/procurement/unitOfMeasures/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
