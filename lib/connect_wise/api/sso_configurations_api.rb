  ...
  class SsoConfigurationsApi
    ...
    def delete_system_sso_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.delete_system_sso_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.delete_system_sso_configurations_by_id"
      end
    ...
    def get_system_sso_configurations_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations"
      end
    ...
    def get_system_sso_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.get_system_sso_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations_by_id"
      end
    ...
    def get_system_sso_configurations_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations_count"
      end
    ...
    def patch_system_sso_configurations_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_system_sso_configurations_by_id_with_http_info(id, client_id,
    ...
    def patch_system_sso_configurations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id"
      end
    ...
    def post_system_sso_configurations_with_http_info(client_id, sso_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations"
      end
      # verify the required parameter 'sso_configuration' is set
      if @api_client.config.client_side_validation && sso_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations"
      end
    ...
    def post_system_sso_configurations_by_id_registertoken(id, client_id, sso_configuration, opts = {})
      data, _status_code, _headers = post_system_sso_configurations_by_id_registertoken_with_http_info(id, client_id,
                                                                                                       sso_configuration, opts)
      data
    end
    ...
    def post_system_sso_configurations_by_id_registertoken_with_http_info(id, client_id, sso_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken"
      end
      # verify the required parameter 'sso_configuration' is set
      if @api_client.config.client_side_validation && sso_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken"
      end
    ...
    def post_system_sso_configurations_by_id_submitmembers(id, client_id, sso_configuration, opts = {})
      data, _status_code, _headers = post_system_sso_configurations_by_id_submitmembers_with_http_info(id, client_id,
                                                                                                       sso_configuration, opts)
      data
    end
    ...
    def post_system_sso_configurations_by_id_submitmembers_with_http_info(id, client_id, sso_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers"
      end
      # verify the required parameter 'sso_configuration' is set
      if @api_client.config.client_side_validation && sso_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers"
      end
    ...
    def put_system_sso_configurations_by_id(id, client_id, sso_configuration, opts = {})
      data, _status_code, _headers = put_system_sso_configurations_by_id_with_http_info(id, client_id,
                                                                                        sso_configuration, opts)
      data
    end
    ...
    def put_system_sso_configurations_by_id_with_http_info(id, client_id, sso_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id"
      end
      # verify the required parameter 'sso_configuration' is set
      if @api_client.config.client_side_validation && sso_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id"
      end
