...
module ConnectWise
  class SsoConfigurationsApi
    ...
    def delete_system_sso_configurations_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.delete_system_sso_configurations_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.delete_system_sso_configurations_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.delete_system_sso_configurations_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_sso_configurations_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.get_system_sso_configurations ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_sso_configurations_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.get_system_sso_configurations_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.get_system_sso_configurations_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_sso_configurations_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.get_system_sso_configurations_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.get_system_sso_configurations_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_sso_configurations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.patch_system_sso_configurations_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling SsoConfigurationsApi.patch_system_sso_configurations_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_system_sso_configurations_with_http_info(client_id, sso_configuration, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.post_system_sso_configurations ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'sso_configuration' is set
      raise ArgumentError, "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations" if @api_client.config.client_side_validation && sso_configuration.nil?
    ...
    def post_system_sso_configurations_by_id_registertoken_with_http_info(id, client_id, sso_configuration, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'sso_configuration' is set
      raise ArgumentError, "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_registertoken" if @api_client.config.client_side_validation && sso_configuration.nil?
    ...
    def post_system_sso_configurations_by_id_submitmembers_with_http_info(id, client_id, sso_configuration, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'sso_configuration' is set
      raise ArgumentError, "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.post_system_sso_configurations_by_id_submitmembers" if @api_client.config.client_side_validation && sso_configuration.nil?
    ...
    def put_system_sso_configurations_by_id_with_http_info(id, client_id, sso_configuration, opts = {})
      @api_client.config.logger.debug 'Calling API: SsoConfigurationsApi.put_system_sso_configurations_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'sso_configuration' is set
      raise ArgumentError, "Missing the required parameter 'sso_configuration' when calling SsoConfigurationsApi.put_system_sso_configurations_by_id" if @api_client.config.client_side_validation && sso_configuration.nil?
