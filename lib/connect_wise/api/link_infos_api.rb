...
module ConnectWise
  class LinkInfosApi
    ...
    def get_system_info_links_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: LinkInfosApi.get_system_info_links ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_info_links_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: LinkInfosApi.get_system_info_links_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling LinkInfosApi.get_system_info_links_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_info_links_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: LinkInfosApi.get_system_info_links_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def post_system_info_links_by_id_resolveurl_with_http_info(id, client_id, link_resolve_url_info, opts = {})
      @api_client.config.logger.debug 'Calling API: LinkInfosApi.post_system_info_links_by_id_resolveurl ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'link_resolve_url_info' is set
      raise ArgumentError, "Missing the required parameter 'link_resolve_url_info' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl" if @api_client.config.client_side_validation && link_resolve_url_info.nil?
