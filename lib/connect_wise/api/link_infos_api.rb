  ...
  class LinkInfosApi
    ...
    def get_system_info_links_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links"
      end
    ...
    def get_system_info_links_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling LinkInfosApi.get_system_info_links_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links_by_id"
      end
    ...
    def get_system_info_links_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LinkInfosApi.get_system_info_links_count"
      end
    ...
    def post_system_info_links_by_id_resolveurl(id, client_id, link_resolve_url_info, opts = {})
      data, _status_code, _headers = post_system_info_links_by_id_resolveurl_with_http_info(id, client_id,
                                                                                            link_resolve_url_info, opts)
      data
    end
    ...
    def post_system_info_links_by_id_resolveurl_with_http_info(id, client_id, link_resolve_url_info, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl"
      end
      ...
      if @api_client.config.client_side_validation && link_resolve_url_info.nil?
        raise ArgumentError,
              "Missing the required parameter 'link_resolve_url_info' when calling LinkInfosApi.post_system_info_links_by_id_resolveurl"
      end
