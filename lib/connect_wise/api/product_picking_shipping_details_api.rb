  ...
  class ProductPickingShippingDetailsApi
    ...
    def delete_procurement_products_by_parent_id_picking_shipping_details_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.delete_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.delete_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.delete_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # resource path
    ...
    def get_procurement_products_by_parent_id_picking_shipping_details_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details"
      end
      # resource path
    ...
    def get_procurement_products_by_parent_id_picking_shipping_details_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # resource path
      local_var_path = '/procurement/products/{parentId}/pickingShippingDetails/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_procurement_products_by_parent_id_picking_shipping_details_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.get_procurement_products_by_parent_id_picking_shipping_details_count"
      end
      # resource path
    ...
    def patch_procurement_products_by_parent_id_picking_shipping_details_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.patch_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.patch_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.patch_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ProductPickingShippingDetailsApi.patch_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # resource path
      local_var_path = '/procurement/products/{parentId}/pickingShippingDetails/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_procurement_products_by_parent_id_picking_shipping_details_with_http_info(parent_id, client_id, product_picking_shipping_detail, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.post_procurement_products_by_parent_id_picking_shipping_details"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.post_procurement_products_by_parent_id_picking_shipping_details"
      end
      ...
      if @api_client.config.client_side_validation && product_picking_shipping_detail.nil?
        fail ArgumentError, "Missing the required parameter 'product_picking_shipping_detail' when calling ProductPickingShippingDetailsApi.post_procurement_products_by_parent_id_picking_shipping_details"
      end
      # resource path
      local_var_path = '/procurement/products/{parentId}/pickingShippingDetails'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_procurement_products_by_parent_id_picking_shipping_details_by_id_with_http_info(id, parent_id, client_id, product_picking_shipping_detail, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ProductPickingShippingDetailsApi.put_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ProductPickingShippingDetailsApi.put_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ProductPickingShippingDetailsApi.put_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # verify the required parameter 'product_picking_shipping_detail' is set
      if @api_client.config.client_side_validation && product_picking_shipping_detail.nil?
        fail ArgumentError, "Missing the required parameter 'product_picking_shipping_detail' when calling ProductPickingShippingDetailsApi.put_procurement_products_by_parent_id_picking_shipping_details_by_id"
      end
      # resource path
      local_var_path = '/procurement/products/{parentId}/pickingShippingDetails/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
