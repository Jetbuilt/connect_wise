  ...
  class ContactNotesApi
    ...
    def delete_company_contacts_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactNotesApi.delete_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.delete_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.delete_company_contacts_by_parent_id_notes_by_id"
      end
      # resource path
    ...
    def get_company_contacts_by_parent_id_notes_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes"
      end
      # resource path
    ...
    def get_company_contacts_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes_by_id"
      end
      # resource path
      local_var_path = '/company/contacts/{parentId}/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_company_contacts_by_parent_id_notes_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.get_company_contacts_by_parent_id_notes_count"
      end
      # resource path
    ...
    def patch_company_contacts_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactNotesApi.patch_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.patch_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.patch_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ContactNotesApi.patch_company_contacts_by_parent_id_notes_by_id"
      end
      # resource path
      local_var_path = '/company/contacts/{parentId}/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_company_contacts_by_parent_id_notes_with_http_info(parent_id, client_id, contact_note, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.post_company_contacts_by_parent_id_notes"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.post_company_contacts_by_parent_id_notes"
      end
      # verify the required parameter 'contact_note' is set
      if @api_client.config.client_side_validation && contact_note.nil?
        fail ArgumentError, "Missing the required parameter 'contact_note' when calling ContactNotesApi.post_company_contacts_by_parent_id_notes"
      end
      # resource path
      local_var_path = '/company/contacts/{parentId}/notes'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_company_contacts_by_parent_id_notes_by_id_with_http_info(id, parent_id, client_id, contact_note, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactNotesApi.put_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ContactNotesApi.put_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ContactNotesApi.put_company_contacts_by_parent_id_notes_by_id"
      end
      # verify the required parameter 'contact_note' is set
      if @api_client.config.client_side_validation && contact_note.nil?
        fail ArgumentError, "Missing the required parameter 'contact_note' when calling ContactNotesApi.put_company_contacts_by_parent_id_notes_by_id"
      end
      # resource path
      local_var_path = '/company/contacts/{parentId}/notes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
