  ...
  class PurchaseOrderStatusNotificationsApi
    ...
    def delete_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderStatusNotificationsApi.delete_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.delete_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.delete_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # resource path
    ...
    def get_procurement_purchaseorderstatuses_by_parent_id_notifications_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications"
      end
      # resource path
    ...
    def get_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorderstatuses/{parentId}/notifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_procurement_purchaseorderstatuses_by_parent_id_notifications_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.get_procurement_purchaseorderstatuses_by_parent_id_notifications_count"
      end
      # resource path
    ...
    def patch_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderStatusNotificationsApi.patch_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.patch_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.patch_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling PurchaseOrderStatusNotificationsApi.patch_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorderstatuses/{parentId}/notifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_procurement_purchaseorderstatuses_by_parent_id_notifications_with_http_info(parent_id, client_id, purchase_order_status_notification, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.post_procurement_purchaseorderstatuses_by_parent_id_notifications"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.post_procurement_purchaseorderstatuses_by_parent_id_notifications"
      end
      ...
      if @api_client.config.client_side_validation && purchase_order_status_notification.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_status_notification' when calling PurchaseOrderStatusNotificationsApi.post_procurement_purchaseorderstatuses_by_parent_id_notifications"
      end
      # resource path
      local_var_path = '/procurement/purchaseorderstatuses/{parentId}/notifications'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id_with_http_info(id, parent_id, client_id, purchase_order_status_notification, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PurchaseOrderStatusNotificationsApi.put_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling PurchaseOrderStatusNotificationsApi.put_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling PurchaseOrderStatusNotificationsApi.put_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # verify the required parameter 'purchase_order_status_notification' is set
      if @api_client.config.client_side_validation && purchase_order_status_notification.nil?
        fail ArgumentError, "Missing the required parameter 'purchase_order_status_notification' when calling PurchaseOrderStatusNotificationsApi.put_procurement_purchaseorderstatuses_by_parent_id_notifications_by_id"
      end
      # resource path
      local_var_path = '/procurement/purchaseorderstatuses/{parentId}/notifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
