  ...
  class CallbackEntriesApi
    ...
    def delete_system_callbacks_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CallbackEntriesApi.delete_system_callbacks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.delete_system_callbacks_by_id"
      end
      # resource path
    ...
    def get_system_callbacks_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.get_system_callbacks"
      end
      # resource path
    ...
    def get_system_callbacks_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CallbackEntriesApi.get_system_callbacks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.get_system_callbacks_by_id"
      end
      # resource path
      local_var_path = '/system/callbacks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_system_callbacks_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.get_system_callbacks_count"
      end
      # resource path
    ...
    def patch_system_callbacks_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CallbackEntriesApi.patch_system_callbacks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.patch_system_callbacks_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CallbackEntriesApi.patch_system_callbacks_by_id"
      end
      # resource path
      local_var_path = '/system/callbacks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_system_callbacks_with_http_info(client_id, callback_entry, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.post_system_callbacks"
      end
      # verify the required parameter 'callback_entry' is set
      if @api_client.config.client_side_validation && callback_entry.nil?
        fail ArgumentError, "Missing the required parameter 'callback_entry' when calling CallbackEntriesApi.post_system_callbacks"
      end
      # resource path
      local_var_path = '/system/callbacks'
    ...
    def put_system_callbacks_by_id_with_http_info(id, client_id, callback_entry, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CallbackEntriesApi.put_system_callbacks_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CallbackEntriesApi.put_system_callbacks_by_id"
      end
      # verify the required parameter 'callback_entry' is set
      if @api_client.config.client_side_validation && callback_entry.nil?
        fail ArgumentError, "Missing the required parameter 'callback_entry' when calling CallbackEntriesApi.put_system_callbacks_by_id"
      end
      # resource path
      local_var_path = '/system/callbacks/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
