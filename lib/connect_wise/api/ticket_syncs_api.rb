...
module ConnectWise
  class TicketSyncsApi
    ...
    def delete_service_ticket_syncs_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.delete_service_ticket_syncs_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling TicketSyncsApi.delete_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.delete_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_service_ticket_syncs_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.get_service_ticket_syncs ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.get_service_ticket_syncs" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_service_ticket_syncs_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.get_service_ticket_syncs_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling TicketSyncsApi.get_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.get_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_service_ticket_syncs_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.get_service_ticket_syncs_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.get_service_ticket_syncs_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_service_ticket_syncs_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.patch_service_ticket_syncs_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling TicketSyncsApi.patch_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.patch_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling TicketSyncsApi.patch_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_service_ticket_syncs_with_http_info(client_id, ticket_sync, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.post_service_ticket_syncs ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.post_service_ticket_syncs" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'ticket_sync' is set
      raise ArgumentError, "Missing the required parameter 'ticket_sync' when calling TicketSyncsApi.post_service_ticket_syncs" if @api_client.config.client_side_validation && ticket_sync.nil?
    ...
    def put_service_ticket_syncs_by_id_with_http_info(id, client_id, ticket_sync, opts = {})
      @api_client.config.logger.debug 'Calling API: TicketSyncsApi.put_service_ticket_syncs_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling TicketSyncsApi.put_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling TicketSyncsApi.put_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'ticket_sync' is set
      raise ArgumentError, "Missing the required parameter 'ticket_sync' when calling TicketSyncsApi.put_service_ticket_syncs_by_id" if @api_client.config.client_side_validation && ticket_sync.nil?
