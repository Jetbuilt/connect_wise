  ...
  class CertificationsApi
    ...
    def delete_system_certifications_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.delete_system_certifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.delete_system_certifications_by_id"
      end
      # resource path
    ...
    def get_system_certifications_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.get_system_certifications"
      end
      # resource path
    ...
    def get_system_certifications_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.get_system_certifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.get_system_certifications_by_id"
      end
      # resource path
      local_var_path = '/system/certifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_system_certifications_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.get_system_certifications_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.get_system_certifications_by_id_usages"
      end
      # resource path
    ...
    def get_system_certifications_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.get_system_certifications_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.get_system_certifications_by_id_usages_list"
      end
      # resource path
    ...
    def get_system_certifications_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.get_system_certifications_count"
      end
      # resource path
    ...
    def patch_system_certifications_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.patch_system_certifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.patch_system_certifications_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CertificationsApi.patch_system_certifications_by_id"
      end
      # resource path
      local_var_path = '/system/certifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_system_certifications_with_http_info(client_id, certification, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.post_system_certifications"
      end
      # verify the required parameter 'certification' is set
      if @api_client.config.client_side_validation && certification.nil?
        fail ArgumentError, "Missing the required parameter 'certification' when calling CertificationsApi.post_system_certifications"
      end
      # resource path
      local_var_path = '/system/certifications'
    ...
    def put_system_certifications_by_id_with_http_info(id, client_id, certification, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CertificationsApi.put_system_certifications_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CertificationsApi.put_system_certifications_by_id"
      end
      # verify the required parameter 'certification' is set
      if @api_client.config.client_side_validation && certification.nil?
        fail ArgumentError, "Missing the required parameter 'certification' when calling CertificationsApi.put_system_certifications_by_id"
      end
      # resource path
      local_var_path = '/system/certifications/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
