  ...
  class AdjustmentDetailsApi
    ...
    def delete_procurement_adjustments_by_parent_id_details_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.delete_procurement_adjustments_by_parent_id_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AdjustmentDetailsApi.delete_procurement_adjustments_by_parent_id_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AdjustmentDetailsApi.delete_procurement_adjustments_by_parent_id_details_by_id"
      end
      # resource path
    ...
    def get_procurement_adjustments_by_parent_id_details_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details"
      end
      # resource path
    ...
    def get_procurement_adjustments_by_parent_id_details_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details_by_id"
      end
      # resource path
      local_var_path = '/procurement/adjustments/{parentId}/details/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_procurement_adjustments_by_parent_id_details_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AdjustmentDetailsApi.get_procurement_adjustments_by_parent_id_details_count"
      end
      # resource path
    ...
    def post_procurement_adjustments_by_parent_id_details_with_http_info(parent_id, client_id, adjustment_detail, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AdjustmentDetailsApi.post_procurement_adjustments_by_parent_id_details"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AdjustmentDetailsApi.post_procurement_adjustments_by_parent_id_details"
      end
      # verify the required parameter 'adjustment_detail' is set
      if @api_client.config.client_side_validation && adjustment_detail.nil?
        fail ArgumentError, "Missing the required parameter 'adjustment_detail' when calling AdjustmentDetailsApi.post_procurement_adjustments_by_parent_id_details"
      end
      # resource path
      local_var_path = '/procurement/adjustments/{parentId}/details'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
