  ...
  class ServiceSurveyQuestionsApi
    ...
    def delete_service_surveys_by_parent_id_questions_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSurveyQuestionsApi.delete_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.delete_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.delete_service_surveys_by_parent_id_questions_by_id"
      end
      # resource path
    ...
    def get_service_surveys_by_parent_id_questions_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions"
      end
      # resource path
    ...
    def get_service_surveys_by_parent_id_questions_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions_by_id"
      end
      # resource path
      local_var_path = '/service/surveys/{parentId}/questions/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_service_surveys_by_parent_id_questions_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.get_service_surveys_by_parent_id_questions_count"
      end
      # resource path
    ...
    def patch_service_surveys_by_parent_id_questions_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSurveyQuestionsApi.patch_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.patch_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.patch_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling ServiceSurveyQuestionsApi.patch_service_surveys_by_parent_id_questions_by_id"
      end
      # resource path
      local_var_path = '/service/surveys/{parentId}/questions/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_service_surveys_by_parent_id_questions_with_http_info(parent_id, client_id, service_survey_question, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions"
      end
      ...
      if @api_client.config.client_side_validation && service_survey_question.nil?
        fail ArgumentError, "Missing the required parameter 'service_survey_question' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions"
      end
      # resource path
      local_var_path = '/service/surveys/{parentId}/questions'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_service_surveys_by_parent_id_questions_by_id_copy_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions_by_id_copy"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions_by_id_copy"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.post_service_surveys_by_parent_id_questions_by_id_copy"
      end
      # resource path
    ...
    def put_service_surveys_by_parent_id_questions_by_id_with_http_info(id, parent_id, client_id, service_survey_question, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServiceSurveyQuestionsApi.put_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ServiceSurveyQuestionsApi.put_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ServiceSurveyQuestionsApi.put_service_surveys_by_parent_id_questions_by_id"
      end
      # verify the required parameter 'service_survey_question' is set
      if @api_client.config.client_side_validation && service_survey_question.nil?
        fail ArgumentError, "Missing the required parameter 'service_survey_question' when calling ServiceSurveyQuestionsApi.put_service_surveys_by_parent_id_questions_by_id"
      end
      # resource path
      local_var_path = '/service/surveys/{parentId}/questions/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
