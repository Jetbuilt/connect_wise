  ...
  class MarketingContactsApi
    ...
    def delete_marketing_groups_by_parent_id_contacts_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MarketingContactsApi.delete_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.delete_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.delete_marketing_groups_by_parent_id_contacts_by_id"
      end
      # resource path
    ...
    def get_marketing_groups_by_parent_id_contacts_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts"
      end
      # resource path
    ...
    def get_marketing_groups_by_parent_id_contacts_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts_by_id"
      end
      # resource path
      local_var_path = '/marketing/groups/{parentId}/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_marketing_groups_by_parent_id_contacts_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.get_marketing_groups_by_parent_id_contacts_count"
      end
      # resource path
    ...
    def patch_marketing_groups_by_parent_id_contacts_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MarketingContactsApi.patch_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.patch_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.patch_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling MarketingContactsApi.patch_marketing_groups_by_parent_id_contacts_by_id"
      end
      # resource path
      local_var_path = '/marketing/groups/{parentId}/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_marketing_groups_by_parent_id_contacts_with_http_info(parent_id, client_id, marketing_contact, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.post_marketing_groups_by_parent_id_contacts"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.post_marketing_groups_by_parent_id_contacts"
      end
      # verify the required parameter 'marketing_contact' is set
      if @api_client.config.client_side_validation && marketing_contact.nil?
        fail ArgumentError, "Missing the required parameter 'marketing_contact' when calling MarketingContactsApi.post_marketing_groups_by_parent_id_contacts"
      end
      # resource path
      local_var_path = '/marketing/groups/{parentId}/contacts'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_marketing_groups_by_parent_id_contacts_by_id_with_http_info(id, parent_id, client_id, marketing_contact, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MarketingContactsApi.put_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling MarketingContactsApi.put_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MarketingContactsApi.put_marketing_groups_by_parent_id_contacts_by_id"
      end
      # verify the required parameter 'marketing_contact' is set
      if @api_client.config.client_side_validation && marketing_contact.nil?
        fail ArgumentError, "Missing the required parameter 'marketing_contact' when calling MarketingContactsApi.put_marketing_groups_by_parent_id_contacts_by_id"
      end
      # resource path
      local_var_path = '/marketing/groups/{parentId}/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
