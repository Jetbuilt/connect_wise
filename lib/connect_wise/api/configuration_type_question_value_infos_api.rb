  ...
  class ConfigurationTypeQuestionValueInfosApi
    ...
    def get_configurations_types_by_grandparent_id_questions_by_parent_id_values_by_id_info_with_http_info(grandparent_id, parent_id, id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && grandparent_id.nil?
        fail ArgumentError, "Missing the required parameter 'grandparent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_by_id_info"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_by_id_info"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_by_id_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_by_id_info"
      end
      # resource path
    ...
    def get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info_with_http_info(grandparent_id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'grandparent_id' is set
      if @api_client.config.client_side_validation && grandparent_id.nil?
        fail ArgumentError, "Missing the required parameter 'grandparent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info"
      end
      # resource path
    ...
    def get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info_count_with_http_info(grandparent_id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'grandparent_id' is set
      if @api_client.config.client_side_validation && grandparent_id.nil?
        fail ArgumentError, "Missing the required parameter 'grandparent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info_count"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling ConfigurationTypeQuestionValueInfosApi.get_configurations_types_by_grandparent_id_questions_by_parent_id_values_info_count"
      end
      # resource path
