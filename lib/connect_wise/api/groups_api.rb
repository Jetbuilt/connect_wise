...
module ConnectWise
  class GroupsApi
    ...
    def delete_marketing_groups_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.delete_marketing_groups_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.delete_marketing_groups_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.delete_marketing_groups_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_marketing_groups_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.get_marketing_groups" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_marketing_groups_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.get_marketing_groups_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.get_marketing_groups_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.get_marketing_groups_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_marketing_groups_by_id_usages_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.get_marketing_groups_by_id_usages ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.get_marketing_groups_by_id_usages" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.get_marketing_groups_by_id_usages" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_marketing_groups_by_id_usages_list_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.get_marketing_groups_by_id_usages_list ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.get_marketing_groups_by_id_usages_list" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.get_marketing_groups_by_id_usages_list" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_marketing_groups_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.get_marketing_groups_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.get_marketing_groups_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_marketing_groups_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.patch_marketing_groups_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.patch_marketing_groups_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.patch_marketing_groups_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling GroupsApi.patch_marketing_groups_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_marketing_groups_with_http_info(client_id, group, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.post_marketing_groups" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'group' is set
      raise ArgumentError, "Missing the required parameter 'group' when calling GroupsApi.post_marketing_groups" if @api_client.config.client_side_validation && group.nil?
    ...
    def put_marketing_groups_by_id_with_http_info(id, client_id, group, opts = {})
      @api_client.config.logger.debug 'Calling API: GroupsApi.put_marketing_groups_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling GroupsApi.put_marketing_groups_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling GroupsApi.put_marketing_groups_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'group' is set
      raise ArgumentError, "Missing the required parameter 'group' when calling GroupsApi.put_marketing_groups_by_id" if @api_client.config.client_side_validation && group.nil?
