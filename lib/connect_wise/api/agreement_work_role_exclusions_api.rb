  ...
  class AgreementWorkRoleExclusionsApi
    ...
    def delete_finance_agreements_by_parent_id_work_role_exclusions_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementWorkRoleExclusionsApi.delete_finance_agreements_by_parent_id_work_role_exclusions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementWorkRoleExclusionsApi.delete_finance_agreements_by_parent_id_work_role_exclusions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementWorkRoleExclusionsApi.delete_finance_agreements_by_parent_id_work_role_exclusions_by_id"
      end
      # resource path
    ...
    def get_finance_agreements_by_parent_id_work_role_exclusions_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementWorkRoleExclusionsApi.get_finance_agreements_by_parent_id_work_role_exclusions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementWorkRoleExclusionsApi.get_finance_agreements_by_parent_id_work_role_exclusions"
      end
      # resource path
    ...
    def get_finance_agreements_by_parent_id_work_role_exclusions_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementWorkRoleExclusionsApi.get_finance_agreements_by_parent_id_work_role_exclusions_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementWorkRoleExclusionsApi.get_finance_agreements_by_parent_id_work_role_exclusions_count"
      end
      # resource path
    ...
    def post_finance_agreements_by_parent_id_work_role_exclusions_with_http_info(parent_id, client_id, agreement_work_role_exclusion, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementWorkRoleExclusionsApi.post_finance_agreements_by_parent_id_work_role_exclusions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementWorkRoleExclusionsApi.post_finance_agreements_by_parent_id_work_role_exclusions"
      end
      ...
      if @api_client.config.client_side_validation && agreement_work_role_exclusion.nil?
        fail ArgumentError, "Missing the required parameter 'agreement_work_role_exclusion' when calling AgreementWorkRoleExclusionsApi.post_finance_agreements_by_parent_id_work_role_exclusions"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/workRoleExclusions'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
