...
module ConnectWise
  class AuthAnvilsApi
    ...
    def get_system_auth_anvils_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.get_system_auth_anvils ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.get_system_auth_anvils" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_auth_anvils_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.get_system_auth_anvils_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling AuthAnvilsApi.get_system_auth_anvils_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.get_system_auth_anvils_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_auth_anvils_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.get_system_auth_anvils_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.get_system_auth_anvils_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_auth_anvils_test_connection_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.get_system_auth_anvils_test_connection ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.get_system_auth_anvils_test_connection" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_auth_anvils_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.patch_system_auth_anvils_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling AuthAnvilsApi.patch_system_auth_anvils_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.patch_system_auth_anvils_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling AuthAnvilsApi.patch_system_auth_anvils_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def put_system_auth_anvils_by_id_with_http_info(id, client_id, auth_anvil, opts = {})
      @api_client.config.logger.debug 'Calling API: AuthAnvilsApi.put_system_auth_anvils_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling AuthAnvilsApi.put_system_auth_anvils_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AuthAnvilsApi.put_system_auth_anvils_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'auth_anvil' is set
      raise ArgumentError, "Missing the required parameter 'auth_anvil' when calling AuthAnvilsApi.put_system_auth_anvils_by_id" if @api_client.config.client_side_validation && auth_anvil.nil?
