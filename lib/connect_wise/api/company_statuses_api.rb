  ...
  class CompanyStatusesApi
    ...
    def delete_company_companies_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.delete_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.delete_company_companies_statuses_by_id"
      end
    ...
    def get_company_companies_statuses_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses"
      end
    ...
    def get_company_companies_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id"
      end
    ...
    def get_company_companies_statuses_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages"
      end
    ...
    def get_company_companies_statuses_by_id_usages_list(id, client_id, opts = {})
      data, _status_code, _headers = get_company_companies_statuses_by_id_usages_list_with_http_info(id, client_id,
                                                                                                     opts)
      data
    end
    ...
    def get_company_companies_statuses_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages_list"
      end
    ...
    def get_company_companies_statuses_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_count"
      end
    ...
    def patch_company_companies_statuses_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_company_companies_statuses_by_id_with_http_info(id, client_id,
    ...
    def patch_company_companies_statuses_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
    ...
    def post_company_companies_statuses_with_http_info(client_id, company_status, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.post_company_companies_statuses"
      end
      # verify the required parameter 'company_status' is set
      if @api_client.config.client_side_validation && company_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'company_status' when calling CompanyStatusesApi.post_company_companies_statuses"
      end
    ...
    def put_company_companies_statuses_by_id(id, client_id, company_status, opts = {})
      data, _status_code, _headers = put_company_companies_statuses_by_id_with_http_info(id, client_id, company_status,
                                                                                         opts)
      data
    end
    ...
    def put_company_companies_statuses_by_id_with_http_info(id, client_id, company_status, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
      # verify the required parameter 'company_status' is set
      if @api_client.config.client_side_validation && company_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'company_status' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
