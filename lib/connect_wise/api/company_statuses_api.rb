  ...
  class CompanyStatusesApi
    ...
    def delete_company_companies_statuses_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.delete_company_companies_statuses_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.delete_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.delete_company_companies_statuses_by_id"
      end
      # resource path
    ...
    def get_company_companies_statuses_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.get_company_companies_statuses ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses"
      end
      # resource path
    ...
    def get_company_companies_statuses_by_id_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.get_company_companies_statuses_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id"
      end
      # resource path
      local_var_path = '/company/companies/statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_company_companies_statuses_by_id_usages_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.get_company_companies_statuses_by_id_usages ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages"
      end
      # resource path
    ...
    def get_company_companies_statuses_by_id_usages_list_with_http_info(id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.get_company_companies_statuses_by_id_usages_list ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_by_id_usages_list"
      end
      # resource path
    ...
    def get_company_companies_statuses_count_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.get_company_companies_statuses_count ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.get_company_companies_statuses_count"
      end
      # resource path
    ...
    def patch_company_companies_statuses_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.patch_company_companies_statuses_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling CompanyStatusesApi.patch_company_companies_statuses_by_id"
      end
      # resource path
      local_var_path = '/company/companies/statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_company_companies_statuses_with_http_info(client_id, company_status, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.post_company_companies_statuses ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.post_company_companies_statuses"
      end
      # verify the required parameter 'company_status' is set
      if @api_client.config.client_side_validation && company_status.nil?
        fail ArgumentError, "Missing the required parameter 'company_status' when calling CompanyStatusesApi.post_company_companies_statuses"
      end
      # resource path
      local_var_path = '/company/companies/statuses'
    ...
    def put_company_companies_statuses_by_id_with_http_info(id, client_id, company_status, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CompanyStatusesApi.put_company_companies_statuses_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
      # verify the required parameter 'company_status' is set
      if @api_client.config.client_side_validation && company_status.nil?
        fail ArgumentError, "Missing the required parameter 'company_status' when calling CompanyStatusesApi.put_company_companies_statuses_by_id"
      end
      # resource path
      local_var_path = '/company/companies/statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
