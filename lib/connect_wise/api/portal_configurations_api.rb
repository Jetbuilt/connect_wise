  ...
  class PortalConfigurationsApi
    ...
    def delete_company_portal_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling PortalConfigurationsApi.delete_company_portal_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.delete_company_portal_configurations_by_id"
      end
    ...
    def get_company_portal_configurations_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.get_company_portal_configurations"
      end
    ...
    def get_company_portal_configurations_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling PortalConfigurationsApi.get_company_portal_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.get_company_portal_configurations_by_id"
      end
    ...
    def get_company_portal_configurations_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.get_company_portal_configurations_count"
      end
    ...
    def patch_company_portal_configurations_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_company_portal_configurations_by_id_with_http_info(id, client_id,
    ...
    def patch_company_portal_configurations_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling PortalConfigurationsApi.patch_company_portal_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.patch_company_portal_configurations_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling PortalConfigurationsApi.patch_company_portal_configurations_by_id"
      end
    ...
    def post_company_portal_configurations(client_id, portal_configuration, opts = {})
      data, _status_code, _headers = post_company_portal_configurations_with_http_info(client_id, portal_configuration,
                                                                                       opts)
      data
    end
    ...
    def post_company_portal_configurations_with_http_info(client_id, portal_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.post_company_portal_configurations"
      end
      ...
      if @api_client.config.client_side_validation && portal_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'portal_configuration' when calling PortalConfigurationsApi.post_company_portal_configurations"
      end
    ...
    def post_company_portal_configurations_copy(client_id, portal_configuration, opts = {})
      data, _status_code, _headers = post_company_portal_configurations_copy_with_http_info(client_id,
                                                                                            portal_configuration, opts)
      data
    end
    ...
    def post_company_portal_configurations_copy_with_http_info(client_id, portal_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.post_company_portal_configurations_copy"
      end
      # verify the required parameter 'portal_configuration' is set
      if @api_client.config.client_side_validation && portal_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'portal_configuration' when calling PortalConfigurationsApi.post_company_portal_configurations_copy"
      end
    ...
    def put_company_portal_configurations_by_id(id, client_id, portal_configuration, opts = {})
      data, _status_code, _headers = put_company_portal_configurations_by_id_with_http_info(id, client_id,
                                                                                            portal_configuration, opts)
      data
    end
    ...
    def put_company_portal_configurations_by_id_with_http_info(id, client_id, portal_configuration, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling PortalConfigurationsApi.put_company_portal_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling PortalConfigurationsApi.put_company_portal_configurations_by_id"
      end
      # verify the required parameter 'portal_configuration' is set
      if @api_client.config.client_side_validation && portal_configuration.nil?
        raise ArgumentError,
              "Missing the required parameter 'portal_configuration' when calling PortalConfigurationsApi.put_company_portal_configurations_by_id"
      end
