  ...
  class BoardStatusesApi
    ...
    def delete_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.delete_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.delete_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.delete_service_boards_by_parent_id_statuses_by_id"
      end

      # resource path
      local_var_path = '/service/boards/{parentId}/statuses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_service_boards_by_parent_id_statuses_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses"
      end
    ...
    def get_service_boards_by_parent_id_statuses_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id,
                                                                                                   client_id, opts)
      data
    end
    ...
    def get_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id"
      end
    ...
    def get_service_boards_by_parent_id_statuses_by_id_usages(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_boards_by_parent_id_statuses_by_id_usages_with_http_info(id,
    ...
    def get_service_boards_by_parent_id_statuses_by_id_usages_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages"
      end

      # resource path
      local_var_path = '/service/boards/{parentId}/statuses/{id}/usages'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
        '{' + 'parentId' + '}', CGI.escape(parent_id.to_s)
      )
    ...
    def get_service_boards_by_parent_id_statuses_by_id_usages_list(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_boards_by_parent_id_statuses_by_id_usages_list_with_http_info(id,
                                                                                                               parent_id, client_id, opts)
      data
    end
    ...
    def get_service_boards_by_parent_id_statuses_by_id_usages_list_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages_list"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_by_id_usages_list"
      end

      # resource path
      local_var_path = '/service/boards/{parentId}/statuses/{id}/usages/list'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
        '{' + 'parentId' + '}', CGI.escape(parent_id.to_s)
      )
    ...
    def get_service_boards_by_parent_id_statuses_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_service_boards_by_parent_id_statuses_count_with_http_info(parent_id,
                                                                                                   client_id, opts)
      data
    end
    ...
    def get_service_boards_by_parent_id_statuses_count_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.get_service_boards_by_parent_id_statuses_count"
      end

      # resource path
      local_var_path = '/service/boards/{parentId}/statuses/count'.sub('{' + 'parentId' + '}',
    ...
    def patch_service_boards_by_parent_id_statuses_by_id(id, parent_id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id,
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BoardStatus, Integer, Hash)>] BoardStatus data, response status code and response headers
    def patch_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id, client_id, patch_operation,
                                                                        opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.patch_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.patch_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.patch_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling BoardStatusesApi.patch_service_boards_by_parent_id_statuses_by_id"
      end
    ...
    def post_service_boards_by_parent_id_statuses(parent_id, client_id, board_status, opts = {})
      data, _status_code, _headers = post_service_boards_by_parent_id_statuses_with_http_info(parent_id, client_id,
                                                                                              board_status, opts)
      data
    end
    ...
    def post_service_boards_by_parent_id_statuses_with_http_info(parent_id, client_id, board_status, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.post_service_boards_by_parent_id_statuses"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.post_service_boards_by_parent_id_statuses"
      end
      # verify the required parameter 'board_status' is set
      if @api_client.config.client_side_validation && board_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'board_status' when calling BoardStatusesApi.post_service_boards_by_parent_id_statuses"
      end
    ...
    def put_service_boards_by_parent_id_statuses_by_id(id, parent_id, client_id, board_status, opts = {})
      data, _status_code, _headers = put_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id,
                                                                                                   client_id, board_status, opts)
      data
    end
    ...
    def put_service_boards_by_parent_id_statuses_by_id_with_http_info(id, parent_id, client_id, board_status, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling BoardStatusesApi.put_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling BoardStatusesApi.put_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling BoardStatusesApi.put_service_boards_by_parent_id_statuses_by_id"
      end
      # verify the required parameter 'board_status' is set
      if @api_client.config.client_side_validation && board_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'board_status' when calling BoardStatusesApi.put_service_boards_by_parent_id_statuses_by_id"
      end
