  ...
  class OpportunityStatusesApi
    ...
    def delete_sales_opportunities_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.delete_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.delete_sales_opportunities_statuses_by_id"
      end
    ...
    def get_sales_opportunities_statuses_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses"
      end
    ...
    def get_sales_opportunities_statuses_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id"
      end
    ...
    def get_sales_opportunities_statuses_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id_usages"
      end
    ...
    def get_sales_opportunities_statuses_by_id_usages_list(id, client_id, opts = {})
      data, _status_code, _headers = get_sales_opportunities_statuses_by_id_usages_list_with_http_info(id, client_id,
                                                                                                       opts)
      data
    end
    ...
    def get_sales_opportunities_statuses_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_by_id_usages_list"
      end
    ...
    def get_sales_opportunities_statuses_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.get_sales_opportunities_statuses_count"
      end
    ...
    def patch_sales_opportunities_statuses_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_sales_opportunities_statuses_by_id_with_http_info(id, client_id,
    ...
    def patch_sales_opportunities_statuses_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.patch_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.patch_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling OpportunityStatusesApi.patch_sales_opportunities_statuses_by_id"
      end
    ...
    def post_sales_opportunities_statuses(client_id, opportunity_status, opts = {})
      data, _status_code, _headers = post_sales_opportunities_statuses_with_http_info(client_id, opportunity_status,
                                                                                      opts)
      data
    end
    ...
    def post_sales_opportunities_statuses_with_http_info(client_id, opportunity_status, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.post_sales_opportunities_statuses"
      end
      ...
      if @api_client.config.client_side_validation && opportunity_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'opportunity_status' when calling OpportunityStatusesApi.post_sales_opportunities_statuses"
      end
    ...
    def put_sales_opportunities_statuses_by_id(id, client_id, opportunity_status, opts = {})
      data, _status_code, _headers = put_sales_opportunities_statuses_by_id_with_http_info(id, client_id,
                                                                                           opportunity_status, opts)
      data
    end
    ...
    def put_sales_opportunities_statuses_by_id_with_http_info(id, client_id, opportunity_status, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling OpportunityStatusesApi.put_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling OpportunityStatusesApi.put_sales_opportunities_statuses_by_id"
      end
      # verify the required parameter 'opportunity_status' is set
      if @api_client.config.client_side_validation && opportunity_status.nil?
        raise ArgumentError,
              "Missing the required parameter 'opportunity_status' when calling OpportunityStatusesApi.put_sales_opportunities_statuses_by_id"
      end
