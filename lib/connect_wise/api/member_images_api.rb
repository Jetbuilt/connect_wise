  ...
  class MemberImagesApi
    ...
    def get_system_members_by_id_image_with_http_info(id, client_id, use_default_flag, lastmodified, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling MemberImagesApi.get_system_members_by_id_image"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling MemberImagesApi.get_system_members_by_id_image"
      end
      # verify the required parameter 'use_default_flag' is set
      if @api_client.config.client_side_validation && use_default_flag.nil?
        fail ArgumentError, "Missing the required parameter 'use_default_flag' when calling MemberImagesApi.get_system_members_by_id_image"
      end
      # verify the required parameter 'lastmodified' is set
      if @api_client.config.client_side_validation && lastmodified.nil?
        fail ArgumentError, "Missing the required parameter 'lastmodified' when calling MemberImagesApi.get_system_members_by_id_image"
      end
      # resource path
