...
module ConnectWise
  class AgreementTypeWorkTypeExclusionsApi
    ...
    def delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id(id, parent_id, client_id, opts = {})
      delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(id, parent_id, client_id,
                                                                                            opts)
      nil
    end
    ...
    def delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(id, parent_id, client_id,
                                                                                              opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end

      # resource path
      local_var_path = '/finance/agreementTypes/{parentId}/workTypeExclusions/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions"
      end

      # resource path
      local_var_path = '/finance/agreementTypes/{parentId}/workTypeExclusions'.sub('{' + 'parentId' + '}',
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(id, parent_id, client_id,
                                                                                           opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id"
      end
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_finance_agreement_types_by_parent_id_work_type_exclusions_count_with_http_info(
        parent_id, client_id, opts
      )
      data
    end
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_count_with_http_info(parent_id, client_id,
                                                                                           opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_count"
      end

      # resource path
      local_var_path = '/finance/agreementTypes/{parentId}/workTypeExclusions/count'.sub('{' + 'parentId' + '}',
                                                                                         CGI.escape(parent_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [AgreementTypeWorkTypeExclusion]
    def post_finance_agreement_types_by_parent_id_work_type_exclusions(parent_id, client_id,
                                                                       agreement_type_work_type_exclusion, opts = {})
      data, _status_code, _headers = post_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(
        parent_id, client_id, agreement_type_work_type_exclusion, opts
      )
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AgreementTypeWorkTypeExclusion, Integer, Hash)>] AgreementTypeWorkTypeExclusion data, response status code and response headers
    def post_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(parent_id, client_id,
                                                                                      agreement_type_work_type_exclusion, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions"
      end
      ...
      if @api_client.config.client_side_validation && agreement_type_work_type_exclusion.nil?
        raise ArgumentError,
              "Missing the required parameter 'agreement_type_work_type_exclusion' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions"
      end
