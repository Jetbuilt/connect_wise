...
module ConnectWise
  class AgreementTypeWorkTypeExclusionsApi
    ...
    def delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(id, parent_id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.delete_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(parent_id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions ...' if @api_client.config.debugging
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id_with_http_info(id, parent_id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_agreement_types_by_parent_id_work_type_exclusions_count_with_http_info(parent_id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_count ...' if @api_client.config.debugging
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_count" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.get_finance_agreement_types_by_parent_id_work_type_exclusions_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def post_finance_agreement_types_by_parent_id_work_type_exclusions_with_http_info(parent_id, client_id, agreement_type_work_type_exclusion, opts = {})
      @api_client.config.logger.debug 'Calling API: AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions ...' if @api_client.config.debugging
      # verify the required parameter 'parent_id' is set
      raise ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions" if @api_client.config.client_side_validation && parent_id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'agreement_type_work_type_exclusion' is set
      raise ArgumentError, "Missing the required parameter 'agreement_type_work_type_exclusion' when calling AgreementTypeWorkTypeExclusionsApi.post_finance_agreement_types_by_parent_id_work_type_exclusions" if @api_client.config.client_side_validation && agreement_type_work_type_exclusion.nil?
