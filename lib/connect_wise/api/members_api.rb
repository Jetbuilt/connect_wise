  ...
  class MembersApi
    ...
    def delete_system_members_by_id_unused_time_sheets_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.delete_system_members_by_id_unused_time_sheets"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.delete_system_members_by_id_unused_time_sheets"
      end
    ...
    def get_system_members_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError, "Missing the required parameter 'client_id' when calling MembersApi.get_system_members"
      end
    ...
    def get_system_members_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling MembersApi.get_system_members_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_by_id"
      end
    ...
    def get_system_members_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.get_system_members_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_by_id_usages"
      end
    ...
    def get_system_members_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.get_system_members_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_by_id_usages_list"
      end
    ...
    def get_system_members_calendarsync_with_http_info(client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MembersApi.get_system_members_calendarsync ...'
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_calendarsync"
      end
    ...
    def get_system_members_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_count"
      end
    ...
    def get_system_members_with_sso_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_members_with_sso"
      end
    ...
    def get_system_membersmember_identifierregextypes(client_id, member_identifier, opts = {})
      data, _status_code, _headers = get_system_membersmember_identifierregextypes_with_http_info(client_id,
                                                                                                  member_identifier, opts)
      data
    end
    ...
    def get_system_membersmember_identifierregextypes_with_http_info(client_id, member_identifier, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.get_system_membersmember_identifierregextypes"
      end
      # verify the required parameter 'member_identifier' is set
      if @api_client.config.client_side_validation && member_identifier.nil?
        raise ArgumentError,
              "Missing the required parameter 'member_identifier' when calling MembersApi.get_system_membersmember_identifierregextypes"
      end

      # resource path
      local_var_path = '/system/members/{memberIdentifier:regex(^(types. |('.sub('{' + 'memberIdentifier' + '}',
                                                                                 CGI.escape(member_identifier.to_s))
    ...
    def patch_system_members_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling MembersApi.patch_system_members_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.patch_system_members_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling MembersApi.patch_system_members_by_id"
      end
    ...
    def post_system_members_with_http_info(client_id, member, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError, "Missing the required parameter 'client_id' when calling MembersApi.post_system_members"
      end
      # verify the required parameter 'member' is set
      if @api_client.config.client_side_validation && member.nil?
        raise ArgumentError, "Missing the required parameter 'member' when calling MembersApi.post_system_members"
      end
    ...
    def post_system_members_by_id_deactivate(id, client_id, member_deactivation, opts = {})
      data, _status_code, _headers = post_system_members_by_id_deactivate_with_http_info(id, client_id,
                                                                                         member_deactivation, opts)
      data
    end
    ...
    def post_system_members_by_id_deactivate_with_http_info(id, client_id, member_deactivation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.post_system_members_by_id_deactivate"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_id_deactivate"
      end
      ...
      if @api_client.config.client_side_validation && member_deactivation.nil?
        raise ArgumentError,
              "Missing the required parameter 'member_deactivation' when calling MembersApi.post_system_members_by_id_deactivate"
      end
    ...
    def post_system_members_by_id_link_sso_user(id, client_id, member_link_sso_user, opts = {})
      data, _status_code, _headers = post_system_members_by_id_link_sso_user_with_http_info(id, client_id,
                                                                                            member_link_sso_user, opts)
      data
    end
    ...
    def post_system_members_by_id_link_sso_user_with_http_info(id, client_id, member_link_sso_user, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.post_system_members_by_id_link_sso_user"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_id_link_sso_user"
      end
      ...
      if @api_client.config.client_side_validation && member_link_sso_user.nil?
        raise ArgumentError,
              "Missing the required parameter 'member_link_sso_user' when calling MembersApi.post_system_members_by_id_link_sso_user"
      end
    ...
    def post_system_members_by_id_submit(id, client_id, member_sso_token, opts = {})
      data, _status_code, _headers = post_system_members_by_id_submit_with_http_info(id, client_id, member_sso_token,
                                                                                     opts)
      data
    end
    ...
    def post_system_members_by_id_submit_with_http_info(id, client_id, member_sso_token, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.post_system_members_by_id_submit"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_id_submit"
      end
      # verify the required parameter 'member_sso_token' is set
      if @api_client.config.client_side_validation && member_sso_token.nil?
        raise ArgumentError,
              "Missing the required parameter 'member_sso_token' when calling MembersApi.post_system_members_by_id_submit"
      end
    ...
    def post_system_members_by_id_unlink_sso_user_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MembersApi.post_system_members_by_id_unlink_sso_user"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_id_unlink_sso_user"
      end
    ...
    def post_system_members_by_member_identifier_tokens(member_identifier, client_id, opts = {})
      data, _status_code, _headers = post_system_members_by_member_identifier_tokens_with_http_info(member_identifier,
                                                                                                    client_id, opts)
      data
    end
    ...
    def post_system_members_by_member_identifier_tokens_with_http_info(member_identifier, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && member_identifier.nil?
        raise ArgumentError,
              "Missing the required parameter 'member_identifier' when calling MembersApi.post_system_members_by_member_identifier_tokens"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_member_identifier_tokens"
      end

      # resource path
      local_var_path = '/system/members/{memberIdentifier}/tokens'.sub('{' + 'memberIdentifier' + '}',
                                                                       CGI.escape(member_identifier.to_s))
    ...
    def post_system_members_by_ssoid_deactivate_iam_member_with_http_info(ssoid, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MembersApi.post_system_members_by_ssoid_deactivate_iam_member ...'
      end
      # verify the required parameter 'ssoid' is set
      if @api_client.config.client_side_validation && ssoid.nil?
        raise ArgumentError,
              "Missing the required parameter 'ssoid' when calling MembersApi.post_system_members_by_ssoid_deactivate_iam_member"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.post_system_members_by_ssoid_deactivate_iam_member"
      end
    ...
    def put_system_members_by_id_with_http_info(id, client_id, member, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling MembersApi.put_system_members_by_id"
      end

      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MembersApi.put_system_members_by_id"
      end
      # verify the required parameter 'member' is set
      if @api_client.config.client_side_validation && member.nil?
        raise ArgumentError, "Missing the required parameter 'member' when calling MembersApi.put_system_members_by_id"
      end
