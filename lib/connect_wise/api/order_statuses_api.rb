...
module ConnectWise
  class OrderStatusesApi
    ...
    def delete_sales_orders_statuses_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.delete_sales_orders_statuses_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.delete_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.delete_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_sales_orders_statuses_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.get_sales_orders_statuses ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.get_sales_orders_statuses" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_sales_orders_statuses_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.get_sales_orders_statuses_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_sales_orders_statuses_by_id_usages_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.get_sales_orders_statuses_by_id_usages ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id_usages" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id_usages" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_sales_orders_statuses_by_id_usages_list_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.get_sales_orders_statuses_by_id_usages_list ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id_usages_list" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.get_sales_orders_statuses_by_id_usages_list" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_sales_orders_statuses_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.get_sales_orders_statuses_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.get_sales_orders_statuses_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_sales_orders_statuses_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.patch_sales_orders_statuses_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.patch_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.patch_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling OrderStatusesApi.patch_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_sales_orders_statuses_with_http_info(client_id, order_status, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.post_sales_orders_statuses ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.post_sales_orders_statuses" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'order_status' is set
      raise ArgumentError, "Missing the required parameter 'order_status' when calling OrderStatusesApi.post_sales_orders_statuses" if @api_client.config.client_side_validation && order_status.nil?
    ...
    def put_sales_orders_statuses_by_id_with_http_info(id, client_id, order_status, opts = {})
      @api_client.config.logger.debug 'Calling API: OrderStatusesApi.put_sales_orders_statuses_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling OrderStatusesApi.put_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling OrderStatusesApi.put_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'order_status' is set
      raise ArgumentError, "Missing the required parameter 'order_status' when calling OrderStatusesApi.put_sales_orders_statuses_by_id" if @api_client.config.client_side_validation && order_status.nil?
