  ...
  class CompanyPickerItemsApi
    ...
    def delete_company_company_picker_items_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyPickerItemsApi.delete_company_company_picker_items_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.delete_company_company_picker_items_by_id"
      end
      # resource path
    ...
    def get_company_company_picker_items_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.get_company_company_picker_items"
      end
      # resource path
    ...
    def get_company_company_picker_items_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CompanyPickerItemsApi.get_company_company_picker_items_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.get_company_company_picker_items_by_id"
      end
      # resource path
      local_var_path = '/company/companyPickerItems/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_company_company_picker_items_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.get_company_company_picker_items_count"
      end
      # resource path
    ...
    def post_company_company_picker_items_with_http_info(client_id, company_picker_item, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.post_company_company_picker_items"
      end
      ...
      if @api_client.config.client_side_validation && company_picker_item.nil?
        fail ArgumentError, "Missing the required parameter 'company_picker_item' when calling CompanyPickerItemsApi.post_company_company_picker_items"
      end
      # resource path
      local_var_path = '/company/companyPickerItems'
    ...
    def post_company_company_picker_items_clear_with_http_info(client_id, clear_picker_request, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling CompanyPickerItemsApi.post_company_company_picker_items_clear"
      end
      ...
      if @api_client.config.client_side_validation && clear_picker_request.nil?
        fail ArgumentError, "Missing the required parameter 'clear_picker_request' when calling CompanyPickerItemsApi.post_company_company_picker_items_clear"
      end
      # resource path
