  ...
  class InvoiceTemplatesApi
    ...
    def delete_finance_invoice_templates_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.delete_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.delete_finance_invoice_templates_by_id"
      end
    ...
    def get_finance_invoice_templates_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates"
      end
    ...
    def get_finance_invoice_templates_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id"
      end
    ...
    def get_finance_invoice_templates_by_id_usages_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages"
      end
    ...
    def get_finance_invoice_templates_by_id_usages_list_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages_list"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages_list"
      end
    ...
    def get_finance_invoice_templates_count_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_count"
      end
    ...
    def patch_finance_invoice_templates_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_finance_invoice_templates_by_id_with_http_info(id, client_id,
    ...
    def patch_finance_invoice_templates_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id"
      end
    ...
    def post_finance_invoice_templates_with_http_info(client_id, invoice_template, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.post_finance_invoice_templates"
      end
      # verify the required parameter 'invoice_template' is set
      if @api_client.config.client_side_validation && invoice_template.nil?
        raise ArgumentError,
              "Missing the required parameter 'invoice_template' when calling InvoiceTemplatesApi.post_finance_invoice_templates"
      end
    ...
    def put_finance_invoice_templates_by_id(id, client_id, invoice_template, opts = {})
      data, _status_code, _headers = put_finance_invoice_templates_by_id_with_http_info(id, client_id,
                                                                                        invoice_template, opts)
      data
    end
    ...
    def put_finance_invoice_templates_by_id_with_http_info(id, client_id, invoice_template, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id"
      end
      # verify the required parameter 'invoice_template' is set
      if @api_client.config.client_side_validation && invoice_template.nil?
        raise ArgumentError,
              "Missing the required parameter 'invoice_template' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id"
      end
