...
module ConnectWise
  class InvoiceTemplatesApi
    ...
    def delete_finance_invoice_templates_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.delete_finance_invoice_templates_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.delete_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.delete_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_invoice_templates_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.get_finance_invoice_templates ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_invoice_templates_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.get_finance_invoice_templates_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_invoice_templates_by_id_usages_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_invoice_templates_by_id_usages_list_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages_list ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages_list" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_by_id_usages_list" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_finance_invoice_templates_count_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.get_finance_invoice_templates_count ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.get_finance_invoice_templates_count" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_finance_invoice_templates_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.patch_finance_invoice_templates_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling InvoiceTemplatesApi.patch_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def post_finance_invoice_templates_with_http_info(client_id, invoice_template, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.post_finance_invoice_templates ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.post_finance_invoice_templates" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'invoice_template' is set
      raise ArgumentError, "Missing the required parameter 'invoice_template' when calling InvoiceTemplatesApi.post_finance_invoice_templates" if @api_client.config.client_side_validation && invoice_template.nil?
    ...
    def put_finance_invoice_templates_by_id_with_http_info(id, client_id, invoice_template, opts = {})
      @api_client.config.logger.debug 'Calling API: InvoiceTemplatesApi.put_finance_invoice_templates_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'invoice_template' is set
      raise ArgumentError, "Missing the required parameter 'invoice_template' when calling InvoiceTemplatesApi.put_finance_invoice_templates_by_id" if @api_client.config.client_side_validation && invoice_template.nil?
