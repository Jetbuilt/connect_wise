  ...
  class ExpenseReportAuditsApi
    ...
    def get_expense_reports_by_parent_id_audits_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits"
      end
    ...
    def get_expense_reports_by_parent_id_audits_by_id(id, parent_id, client_id, opts = {})
      data, _status_code, _headers = get_expense_reports_by_parent_id_audits_by_id_with_http_info(id, parent_id,
                                                                                                  client_id, opts)
      data
    end
    ...
    def get_expense_reports_by_parent_id_audits_by_id_with_http_info(id, parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_by_id"
      end

      # resource path
      local_var_path = '/expense/reports/{parentId}/audits/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub(
    ...
    def get_expense_reports_by_parent_id_audits_count(parent_id, client_id, opts = {})
      data, _status_code, _headers = get_expense_reports_by_parent_id_audits_count_with_http_info(parent_id, client_id,
                                                                                                  opts)
      data
    end
    ...
    def get_expense_reports_by_parent_id_audits_count_with_http_info(parent_id, client_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_count ...'
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'parent_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling ExpenseReportAuditsApi.get_expense_reports_by_parent_id_audits_count"
      end

      # resource path
      local_var_path = '/expense/reports/{parentId}/audits/count'.sub('{' + 'parentId' + '}',
