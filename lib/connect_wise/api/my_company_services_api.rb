...
module ConnectWise
  class MyCompanyServicesApi
    ...
    def get_system_mycompany_services_with_http_info(client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: MyCompanyServicesApi.get_system_mycompany_services ...' if @api_client.config.debugging
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.get_system_mycompany_services" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def get_system_mycompany_services_by_id_with_http_info(id, client_id, opts = {})
      @api_client.config.logger.debug 'Calling API: MyCompanyServicesApi.get_system_mycompany_services_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling MyCompanyServicesApi.get_system_mycompany_services_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.get_system_mycompany_services_by_id" if @api_client.config.client_side_validation && client_id.nil?
    ...
    def patch_system_mycompany_services_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      @api_client.config.logger.debug 'Calling API: MyCompanyServicesApi.patch_system_mycompany_services_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'patch_operation' is set
      raise ArgumentError, "Missing the required parameter 'patch_operation' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id" if @api_client.config.client_side_validation && patch_operation.nil?
    ...
    def put_system_mycompany_services_by_id_with_http_info(id, client_id, service, opts = {})
      @api_client.config.logger.debug 'Calling API: MyCompanyServicesApi.put_system_mycompany_services_by_id ...' if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id" if @api_client.config.client_side_validation && id.nil?
      # verify the required parameter 'client_id' is set
      raise ArgumentError, "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id" if @api_client.config.client_side_validation && client_id.nil?
      # verify the required parameter 'service' is set
      raise ArgumentError, "Missing the required parameter 'service' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id" if @api_client.config.client_side_validation && service.nil?
