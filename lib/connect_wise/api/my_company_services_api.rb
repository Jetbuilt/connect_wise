  ...
  class MyCompanyServicesApi
    ...
    def get_system_mycompany_services_with_http_info(client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.get_system_mycompany_services"
      end
    ...
    def get_system_mycompany_services_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MyCompanyServicesApi.get_system_mycompany_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.get_system_mycompany_services_by_id"
      end
    ...
    def patch_system_mycompany_services_by_id(id, client_id, patch_operation, opts = {})
      data, _status_code, _headers = patch_system_mycompany_services_by_id_with_http_info(id, client_id,
    ...
    def patch_system_mycompany_services_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        raise ArgumentError,
              "Missing the required parameter 'patch_operation' when calling MyCompanyServicesApi.patch_system_mycompany_services_by_id"
      end
    ...
    def put_system_mycompany_services_by_id_with_http_info(id, client_id, service, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        raise ArgumentError,
              "Missing the required parameter 'client_id' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id"
      end
      # verify the required parameter 'service' is set
      if @api_client.config.client_side_validation && service.nil?
        raise ArgumentError,
              "Missing the required parameter 'service' when calling MyCompanyServicesApi.put_system_mycompany_services_by_id"
      end
