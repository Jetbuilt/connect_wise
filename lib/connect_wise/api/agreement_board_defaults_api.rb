  ...
  class AgreementBoardDefaultsApi
    ...
    def delete_finance_agreements_by_parent_id_board_defaults_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementBoardDefaultsApi.delete_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.delete_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.delete_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # resource path
    ...
    def get_finance_agreements_by_parent_id_board_defaults_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults"
      end
      # resource path
    ...
    def get_finance_agreements_by_parent_id_board_defaults_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/boardDefaults/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_finance_agreements_by_parent_id_board_defaults_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.get_finance_agreements_by_parent_id_board_defaults_count"
      end
      # resource path
    ...
    def patch_finance_agreements_by_parent_id_board_defaults_by_id_with_http_info(id, parent_id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementBoardDefaultsApi.patch_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.patch_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.patch_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling AgreementBoardDefaultsApi.patch_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/boardDefaults/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def post_finance_agreements_by_parent_id_board_defaults_with_http_info(parent_id, client_id, board_default, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.post_finance_agreements_by_parent_id_board_defaults"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.post_finance_agreements_by_parent_id_board_defaults"
      end
      # verify the required parameter 'board_default' is set
      if @api_client.config.client_side_validation && board_default.nil?
        fail ArgumentError, "Missing the required parameter 'board_default' when calling AgreementBoardDefaultsApi.post_finance_agreements_by_parent_id_board_defaults"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/boardDefaults'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_finance_agreements_by_parent_id_board_defaults_by_id_with_http_info(id, parent_id, client_id, board_default, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementBoardDefaultsApi.put_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementBoardDefaultsApi.put_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementBoardDefaultsApi.put_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # verify the required parameter 'board_default' is set
      if @api_client.config.client_side_validation && board_default.nil?
        fail ArgumentError, "Missing the required parameter 'board_default' when calling AgreementBoardDefaultsApi.put_finance_agreements_by_parent_id_board_defaults_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/boardDefaults/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
