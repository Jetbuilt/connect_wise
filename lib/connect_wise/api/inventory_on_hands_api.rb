  ...
  class InventoryOnHandsApi
    ...
    def get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_with_http_info(parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand"
      end
      # resource path
    ...
    def get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_by_id"
      end
      # resource path
    ...
    def get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling InventoryOnHandsApi.get_procurement_warehouse_bins_by_parent_id_inventory_on_hand_count"
      end
      # resource path
