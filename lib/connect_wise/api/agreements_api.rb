  ...
  class AgreementsApi
    ...
    def delete_finance_agreements_by_id_with_http_info(id, client_id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.delete_finance_agreements_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.delete_finance_agreements_by_id"
      end
      # resource path
    ...
    def delete_finance_agreements_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.delete_finance_agreements_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementsApi.delete_finance_agreements_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.delete_finance_agreements_by_parent_id_configurations_by_id"
      end
      # resource path
    ...
    def get_finance_agreements_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements"
      end
      # resource path
    ...
    def get_finance_agreements_by_id_with_http_info(id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.get_finance_agreements_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def get_finance_agreements_by_parent_id_configurations_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations"
      end
      # resource path
    ...
    def get_finance_agreements_by_parent_id_configurations_by_id_with_http_info(id, parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/configurations/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def get_finance_agreements_by_parent_id_configurations_count_with_http_info(parent_id, client_id, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations_count"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements_by_parent_id_configurations_count"
      end
      # resource path
    ...
    def get_finance_agreements_count_with_http_info(client_id, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.get_finance_agreements_count"
      end
      # resource path
    ...
    def patch_finance_agreements_by_id_with_http_info(id, client_id, patch_operation, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.patch_finance_agreements_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.patch_finance_agreements_by_id"
      end
      # verify the required parameter 'patch_operation' is set
      if @api_client.config.client_side_validation && patch_operation.nil?
        fail ArgumentError, "Missing the required parameter 'patch_operation' when calling AgreementsApi.patch_finance_agreements_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def post_finance_agreements_with_http_info(client_id, agreement, opts = {})
      ...
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.post_finance_agreements"
      end
      # verify the required parameter 'agreement' is set
      if @api_client.config.client_side_validation && agreement.nil?
        fail ArgumentError, "Missing the required parameter 'agreement' when calling AgreementsApi.post_finance_agreements"
      end
      # resource path
      local_var_path = '/finance/agreements'
    ...
    def post_finance_agreements_by_parent_id_configurations_with_http_info(parent_id, client_id, configuration_reference, opts = {})
      ...
      # verify the required parameter 'parent_id' is set
      if @api_client.config.client_side_validation && parent_id.nil?
        fail ArgumentError, "Missing the required parameter 'parent_id' when calling AgreementsApi.post_finance_agreements_by_parent_id_configurations"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.post_finance_agreements_by_parent_id_configurations"
      end
      ...
      if @api_client.config.client_side_validation && configuration_reference.nil?
        fail ArgumentError, "Missing the required parameter 'configuration_reference' when calling AgreementsApi.post_finance_agreements_by_parent_id_configurations"
      end
      # resource path
      local_var_path = '/finance/agreements/{parentId}/configurations'.sub('{' + 'parentId' + '}', CGI.escape(parent_id.to_s))
    ...
    def put_finance_agreements_by_id_with_http_info(id, client_id, agreement, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AgreementsApi.put_finance_agreements_by_id"
      end
      # verify the required parameter 'client_id' is set
      if @api_client.config.client_side_validation && client_id.nil?
        fail ArgumentError, "Missing the required parameter 'client_id' when calling AgreementsApi.put_finance_agreements_by_id"
      end
      # verify the required parameter 'agreement' is set
      if @api_client.config.client_side_validation && agreement.nil?
        fail ArgumentError, "Missing the required parameter 'agreement' when calling AgreementsApi.put_finance_agreements_by_id"
      end
      # resource path
      local_var_path = '/finance/agreements/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
