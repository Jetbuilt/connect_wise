...
module ConnectWise
  class AgreementTypeWorkType
    attr_accessor :rate_type, :bill_time, :overage_rate_type, :id, :type, :work_type, :effective_date, :ending_date, :rate, :hours_min, :hours_max, :round_bill_hours, :overage_rate, :limit_to, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementTypeWorkType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
