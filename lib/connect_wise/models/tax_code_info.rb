...
module ConnectWise
  class TaxCodeInfo
    attr_accessor :id, :identifier, :description, :effective_date, :cancel_date, :default_flag, :level_one_rate, :level_two_rate, :level_three_rate, :level_four_rate, :level_five_rate, :level_six_rate, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::TaxCodeInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TaxCodeInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, identifier, description, effective_date, cancel_date, default_flag, level_one_rate, level_two_rate, level_three_rate, level_four_rate, level_five_rate, level_six_rate, _info].hash
    end
