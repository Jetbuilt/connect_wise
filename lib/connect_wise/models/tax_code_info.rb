...
module ConnectWise
  class TaxCodeInfo
    attr_accessor :id, :identifier, :description, :effective_date, :cancel_date, :default_flag, :level_one_rate,
                  :level_two_rate, :level_three_rate, :level_four_rate, :level_five_rate, :level_six_rate, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TaxCodeInfo` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TaxCodeInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, identifier, description, effective_date, cancel_date, default_flag, level_one_rate, level_two_rate,
       level_three_rate, level_four_rate, level_five_rate, level_six_rate, _info].hash
    end
