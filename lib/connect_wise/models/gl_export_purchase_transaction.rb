...
module ConnectWise
  class GLExportPurchaseTransaction
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::GLExportPurchaseTransaction` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::GLExportPurchaseTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.ship_to_company_account_number = attributes[:ship_to_company_account_number] if attributes.key?(:ship_to_company_account_number)
      ...
      self.purchase_header_taxable_flag = attributes[:purchase_header_taxable_flag] if attributes.key?(:purchase_header_taxable_flag)

      self.purchase_header_freight_taxable_flag = attributes[:purchase_header_freight_taxable_flag] if attributes.key?(:purchase_header_freight_taxable_flag)
      ...
      return unless (value = attributes[:purchase_detail_tax]).is_a?(Array)
