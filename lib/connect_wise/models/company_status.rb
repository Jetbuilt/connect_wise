...
module ConnectWise
  class CompanyStatus
    ...
    attr_accessor :id, :default_flag, :inactive_flag, :notify_flag, :disallow_saving_flag, :custom_note_flag, :cancel_open_tracks_flag, :track, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CompanyStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
