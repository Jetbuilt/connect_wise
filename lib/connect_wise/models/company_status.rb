...
module ConnectWise
  class CompanyStatus
    ...
    attr_accessor :id, :default_flag, :inactive_flag, :notify_flag, :disallow_saving_flag, :custom_note_flag,
                  :cancel_open_tracks_flag, :track, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CompanyStatus` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CompanyStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [name, id, default_flag, inactive_flag, notify_flag, disallow_saving_flag, notification_message,
       custom_note_flag, cancel_open_tracks_flag, track, _info].hash
    end
