...
module ConnectWise
  class TicketTask
    attr_accessor :id, :ticket_id, :notes, :closed_flag, :priority, :schedule, :code, :member, :resolution, :summary, :child_schedule_action, :child_ticket_id, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TicketTask`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, ticket_id, notes, closed_flag, priority, schedule, code, member, resolution, summary, child_schedule_action, child_ticket_id, _info].hash
    end
