...
module ConnectWise
  class TicketTask
    attr_accessor :id, :ticket_id, :notes, :closed_flag, :priority, :schedule, :code, :member, :resolution, :summary,
                  :child_schedule_action, :child_ticket_id, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TicketTask` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TicketTask`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, ticket_id, notes, closed_flag, priority, schedule, code, member, resolution, summary, child_schedule_action,
       child_ticket_id, _info].hash
    end
