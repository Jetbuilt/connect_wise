...
module ConnectWise
  class Commission
    attr_accessor :member, :id, :commission_percent, :date_start, :date_end, :location, :department, :company, :site,
                  :agreement, :project, :service_board, :ticket, :territory, :billing_method, :service_type, :project_board, :project_type, :agreement_type, :number_of_months, :product_category, :product_sub_category, :item, :commission_basis, :invoice_option, :services_flag, :agreements_flag, :products_flag, :my_opportunities_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Commission` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Commission`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      billing_method_validator = EnumAttributeValidator.new('String',
                                                            %w[Agreement CreditMemo DownPayment Miscellaneous Progress
                                                               Standard])
    ...
    def commission_basis=(commission_basis)
      ...
      unless validator.valid?(commission_basis)
        raise ArgumentError, "invalid value for \"commission_basis\", must be one of #{validator.allowable_values}."
      end
    ...
    def invoice_option=(invoice_option)
      ...
      unless validator.valid?(invoice_option)
        raise ArgumentError, "invalid value for \"invoice_option\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [member, id, commission_percent, date_start, date_end, location, department, company, site, agreement, project,
       service_board, ticket, territory, billing_method, service_type, project_board, project_type, agreement_type, number_of_months, product_category, product_sub_category, item, commission_basis, invoice_option, services_flag, agreements_flag, products_flag, my_opportunities_flag, _info].hash
    end
