...
module ConnectWise
  class TimeAccrualDetail
    ...
    attr_accessor :start_year, :end_year, :hours, :id, :time_accrual, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::TimeAccrualDetail` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TimeAccrualDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.time_accrual = attributes[:time_accrual] if attributes.key?(:time_accrual)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        hours == other.hours &&
        id == other.id &&
        time_accrual == other.time_accrual &&
        _info == other._info
    end
    ...
    def hash
      [accrual_type, start_year, end_year, hours, id, time_accrual, _info].hash
    end
