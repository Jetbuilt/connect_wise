...
module ConnectWise
  class GLExportInventoryTransferOffset
    attr_accessor :id, :document_type, :document_date, :account_number, :gl_class, :total, :memo, :description, :gl_type_id
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::GLExportInventoryTransferOffset` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::GLExportInventoryTransferOffset`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:gl_type_id)
