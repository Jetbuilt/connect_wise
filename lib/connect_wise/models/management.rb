...
module ConnectWise
  class Management
    attr_accessor :schedule_executive_summary_report_flag, :id, :run_time, :added_configuration_status, :deleted_configuration_status, :integrator_login, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Management`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [schedule_executive_summary_report_flag, id, run_time, added_configuration_status, deleted_configuration_status, integrator_login, executive_summary_report_schedule_day, executive_summary_report_schedule_hour, executive_summary_report_schedule_minute, _info].hash
    end
