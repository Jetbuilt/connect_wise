  ...
  class Management
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::Management` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Management`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'schedule_executive_summary_report_flag')
        self.schedule_executive_summary_report_flag = attributes[:'schedule_executive_summary_report_flag']
      end
      ...
      if attributes.key?(:'added_configuration_status')
        self.added_configuration_status = attributes[:'added_configuration_status']
      end

      if attributes.key?(:'deleted_configuration_status')
        self.deleted_configuration_status = attributes[:'deleted_configuration_status']
      end
