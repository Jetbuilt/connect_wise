...
module ConnectWise
  class Management
    attr_accessor :added_configuration_status, :deleted_configuration_status, :integrator_login, :schedule_executive_summary_report_flag, :id, :run_time, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::Management` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Management`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)

        h[k.to_sym] = v
      end

      self.added_configuration_status = (attributes[:added_configuration_status] if attributes.key?(:added_configuration_status))

      self.deleted_configuration_status = (attributes[:deleted_configuration_status] if attributes.key?(:deleted_configuration_status))

      self.integrator_login = (attributes[:integrator_login] if attributes.key?(:integrator_login))

      self.schedule_executive_summary_report_flag = (attributes[:schedule_executive_summary_report_flag] if attributes.key?(:schedule_executive_summary_report_flag))

      self.id = attributes[:id] if attributes.key?(:id)

      self.run_time = attributes[:run_time] if attributes.key?(:run_time)

      self.executive_summary_report_schedule_day = attributes[:executive_summary_report_schedule_day] if attributes.key?(:executive_summary_report_schedule_day)

      self.executive_summary_report_schedule_hour = attributes[:executive_summary_report_schedule_hour] if attributes.key?(:executive_summary_report_schedule_hour)

      self.executive_summary_report_schedule_minute = attributes[:executive_summary_report_schedule_minute] if attributes.key?(:executive_summary_report_schedule_minute)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "added_configuration_status", added_configuration_status cannot be nil.') if @added_configuration_status.nil?

      invalid_properties.push('invalid value for "deleted_configuration_status", deleted_configuration_status cannot be nil.') if @deleted_configuration_status.nil?

      invalid_properties.push('invalid value for "integrator_login", integrator_login cannot be nil.') if @integrator_login.nil?
    ...
    def hash
      [added_configuration_status, deleted_configuration_status, integrator_login, schedule_executive_summary_report_flag, id, run_time, executive_summary_report_schedule_day, executive_summary_report_schedule_hour, executive_summary_report_schedule_minute, _info].hash
    end
