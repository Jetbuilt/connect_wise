...
module ConnectWise
  class Invoice
    attr_accessor :type, :id, :status, :company, :bill_to_company, :ship_to_company, :account_number, :apply_to_type, :apply_to_id, :billing_site, :billing_site_address_line1, :billing_site_address_line2, :billing_site_city, :billing_site_state, :billing_site_zip, :billing_site_country, :shipping_site, :shipping_site_address_line1, :shipping_site_address_line2, :shipping_site_city, :shipping_site_state, :shipping_site_zip, :shipping_site_country, :billing_terms, :invoice_template, :add_to_batch_email_list, :date, :restrict_downpayment_flag, :territory_id, :top_comment, :bottom_comment, :taxable_flag, :tax_code, :internal_notes, :downpayment_previously_taxed_flag, :service_total, :override_down_payment_amount_flag, :currency, :due_date, :expense_total, :product_total, :previous_progress_applied, :service_adjustment_amount, :agreement_amount, :downpayment_applied, :subtotal, :total, :remaining_downpayment, :sales_tax, :adjustment_reason, :adjusted_by, :payments, :credits, :balance, :special_invoice_flag, :billing_setup_reference, :ticket, :project, :phase, :sales_order, :agreement, :_info, :custom_fields
