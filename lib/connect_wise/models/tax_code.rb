  ...
  class TaxCode
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TaxCode` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TaxCode`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def level_one_rate_type=(level_one_rate_type)
      ...
      unless validator.valid?(level_one_rate_type)
        raise ArgumentError, "invalid value for \"level_one_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_two_rate_type=(level_two_rate_type)
      ...
      unless validator.valid?(level_two_rate_type)
        raise ArgumentError, "invalid value for \"level_two_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_three_rate_type=(level_three_rate_type)
      ...
      unless validator.valid?(level_three_rate_type)
        raise ArgumentError,
              "invalid value for \"level_three_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_four_rate_type=(level_four_rate_type)
      ...
      unless validator.valid?(level_four_rate_type)
        raise ArgumentError, "invalid value for \"level_four_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_five_rate_type=(level_five_rate_type)
      ...
      unless validator.valid?(level_five_rate_type)
        raise ArgumentError, "invalid value for \"level_five_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_six_rate_type=(level_six_rate_type)
      ...
      unless validator.valid?(level_six_rate_type)
        raise ArgumentError, "invalid value for \"level_six_rate_type\", must be one of #{validator.allowable_values}."
      end
