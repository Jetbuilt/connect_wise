...
module ConnectWise
  class TaxCode
    ...
    attr_accessor :level_six_rate

    attr_accessor :level_six_rate_type

    attr_accessor :level_six_taxable_max
    ...
    attr_accessor :level_six_services_flag

    attr_accessor :level_six_expenses_flag

    attr_accessor :level_six_products_flag

    attr_accessor :level_six_apply_single_unit_flag

    attr_accessor :level_six_apply_single_unit_min

    attr_accessor :level_six_apply_single_unit_max
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::TaxCode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TaxCode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'invoice_caption')
        self.invoice_caption = attributes[:'invoice_caption']
      end
      ...
      if attributes.key?(:'display_on_invoice_flag')
        self.display_on_invoice_flag = attributes[:'display_on_invoice_flag']
      end

      if attributes.key?(:'canada_calculate_gst_flag')
        self.canada_calculate_gst_flag = attributes[:'canada_calculate_gst_flag']
      end

      if attributes.key?(:'cancel_date')
        self.cancel_date = attributes[:'cancel_date']
      end

      if attributes.key?(:'level_one_rate')
        self.level_one_rate = attributes[:'level_one_rate']
      end

      if attributes.key?(:'level_one_rate_type')
        self.level_one_rate_type = attributes[:'level_one_rate_type']
      end

      if attributes.key?(:'level_one_taxable_max')
        self.level_one_taxable_max = attributes[:'level_one_taxable_max']
      end

      if attributes.key?(:'level_one_caption')
        self.level_one_caption = attributes[:'level_one_caption']
      end

      if attributes.key?(:'level_one_tax_code_xref')
        self.level_one_tax_code_xref = attributes[:'level_one_tax_code_xref']
      end

      if attributes.key?(:'level_one_agency_xref')
        self.level_one_agency_xref = attributes[:'level_one_agency_xref']
      end

      if attributes.key?(:'level_one_services_flag')
        self.level_one_services_flag = attributes[:'level_one_services_flag']
      end

      if attributes.key?(:'level_one_expenses_flag')
        self.level_one_expenses_flag = attributes[:'level_one_expenses_flag']
      end

      if attributes.key?(:'level_one_products_flag')
        self.level_one_products_flag = attributes[:'level_one_products_flag']
      end

      if attributes.key?(:'level_one_apply_single_unit_flag')
        self.level_one_apply_single_unit_flag = attributes[:'level_one_apply_single_unit_flag']
      end

      if attributes.key?(:'level_one_apply_single_unit_min')
        self.level_one_apply_single_unit_min = attributes[:'level_one_apply_single_unit_min']
      end

      if attributes.key?(:'level_one_apply_single_unit_max')
        self.level_one_apply_single_unit_max = attributes[:'level_one_apply_single_unit_max']
      end

      if attributes.key?(:'level_two_rate')
        self.level_two_rate = attributes[:'level_two_rate']
      end

      if attributes.key?(:'level_two_rate_type')
        self.level_two_rate_type = attributes[:'level_two_rate_type']
      end

      if attributes.key?(:'level_two_taxable_max')
        self.level_two_taxable_max = attributes[:'level_two_taxable_max']
      end

      if attributes.key?(:'level_two_caption')
        self.level_two_caption = attributes[:'level_two_caption']
      end

      if attributes.key?(:'level_two_tax_code_xref')
        self.level_two_tax_code_xref = attributes[:'level_two_tax_code_xref']
      end

      if attributes.key?(:'level_two_agency_xref')
        self.level_two_agency_xref = attributes[:'level_two_agency_xref']
      end

      if attributes.key?(:'level_two_services_flag')
        self.level_two_services_flag = attributes[:'level_two_services_flag']
      end

      if attributes.key?(:'level_two_expenses_flag')
        self.level_two_expenses_flag = attributes[:'level_two_expenses_flag']
      end

      if attributes.key?(:'level_two_products_flag')
        self.level_two_products_flag = attributes[:'level_two_products_flag']
      end

      if attributes.key?(:'level_two_apply_single_unit_flag')
        self.level_two_apply_single_unit_flag = attributes[:'level_two_apply_single_unit_flag']
      end

      if attributes.key?(:'level_two_apply_single_unit_min')
        self.level_two_apply_single_unit_min = attributes[:'level_two_apply_single_unit_min']
      end

      if attributes.key?(:'level_two_apply_single_unit_max')
        self.level_two_apply_single_unit_max = attributes[:'level_two_apply_single_unit_max']
      end

      if attributes.key?(:'level_three_rate')
        self.level_three_rate = attributes[:'level_three_rate']
      end

      if attributes.key?(:'level_three_rate_type')
        self.level_three_rate_type = attributes[:'level_three_rate_type']
      end

      if attributes.key?(:'level_three_taxable_max')
        self.level_three_taxable_max = attributes[:'level_three_taxable_max']
      end

      if attributes.key?(:'level_three_caption')
        self.level_three_caption = attributes[:'level_three_caption']
      end

      if attributes.key?(:'level_three_tax_code_xref')
        self.level_three_tax_code_xref = attributes[:'level_three_tax_code_xref']
      end

      if attributes.key?(:'level_three_agency_xref')
        self.level_three_agency_xref = attributes[:'level_three_agency_xref']
      end

      if attributes.key?(:'level_three_services_flag')
        self.level_three_services_flag = attributes[:'level_three_services_flag']
      end

      if attributes.key?(:'level_three_expenses_flag')
        self.level_three_expenses_flag = attributes[:'level_three_expenses_flag']
      end

      if attributes.key?(:'level_three_products_flag')
        self.level_three_products_flag = attributes[:'level_three_products_flag']
      end

      if attributes.key?(:'level_three_apply_single_unit_flag')
        self.level_three_apply_single_unit_flag = attributes[:'level_three_apply_single_unit_flag']
      end

      if attributes.key?(:'level_three_apply_single_unit_min')
        self.level_three_apply_single_unit_min = attributes[:'level_three_apply_single_unit_min']
      end

      if attributes.key?(:'level_three_apply_single_unit_max')
        self.level_three_apply_single_unit_max = attributes[:'level_three_apply_single_unit_max']
      end

      if attributes.key?(:'level_four_rate')
        self.level_four_rate = attributes[:'level_four_rate']
      end

      if attributes.key?(:'level_four_rate_type')
        self.level_four_rate_type = attributes[:'level_four_rate_type']
      end

      if attributes.key?(:'level_four_taxable_max')
        self.level_four_taxable_max = attributes[:'level_four_taxable_max']
      end

      if attributes.key?(:'level_four_caption')
        self.level_four_caption = attributes[:'level_four_caption']
      end

      if attributes.key?(:'level_four_tax_code_xref')
        self.level_four_tax_code_xref = attributes[:'level_four_tax_code_xref']
      end

      if attributes.key?(:'level_four_agency_xref')
        self.level_four_agency_xref = attributes[:'level_four_agency_xref']
      end

      if attributes.key?(:'level_four_services_flag')
        self.level_four_services_flag = attributes[:'level_four_services_flag']
      end

      if attributes.key?(:'level_four_expenses_flag')
        self.level_four_expenses_flag = attributes[:'level_four_expenses_flag']
      end

      if attributes.key?(:'level_four_products_flag')
        self.level_four_products_flag = attributes[:'level_four_products_flag']
      end

      if attributes.key?(:'level_four_apply_single_unit_flag')
        self.level_four_apply_single_unit_flag = attributes[:'level_four_apply_single_unit_flag']
      end

      if attributes.key?(:'level_four_apply_single_unit_min')
        self.level_four_apply_single_unit_min = attributes[:'level_four_apply_single_unit_min']
      end

      if attributes.key?(:'level_four_apply_single_unit_max')
        self.level_four_apply_single_unit_max = attributes[:'level_four_apply_single_unit_max']
      end

      if attributes.key?(:'level_five_rate')
        self.level_five_rate = attributes[:'level_five_rate']
      end

      if attributes.key?(:'level_five_rate_type')
        self.level_five_rate_type = attributes[:'level_five_rate_type']
      end

      if attributes.key?(:'level_five_taxable_max')
        self.level_five_taxable_max = attributes[:'level_five_taxable_max']
      end

      if attributes.key?(:'level_five_caption')
        self.level_five_caption = attributes[:'level_five_caption']
      end

      if attributes.key?(:'level_five_tax_code_xref')
        self.level_five_tax_code_xref = attributes[:'level_five_tax_code_xref']
      end

      if attributes.key?(:'level_five_agency_xref')
        self.level_five_agency_xref = attributes[:'level_five_agency_xref']
      end

      if attributes.key?(:'level_five_services_flag')
        self.level_five_services_flag = attributes[:'level_five_services_flag']
      end

      if attributes.key?(:'level_five_expenses_flag')
        self.level_five_expenses_flag = attributes[:'level_five_expenses_flag']
      end

      if attributes.key?(:'level_five_products_flag')
        self.level_five_products_flag = attributes[:'level_five_products_flag']
      end

      if attributes.key?(:'level_five_apply_single_unit_flag')
        self.level_five_apply_single_unit_flag = attributes[:'level_five_apply_single_unit_flag']
      end

      if attributes.key?(:'level_five_apply_single_unit_min')
        self.level_five_apply_single_unit_min = attributes[:'level_five_apply_single_unit_min']
      end

      if attributes.key?(:'level_five_apply_single_unit_max')
        self.level_five_apply_single_unit_max = attributes[:'level_five_apply_single_unit_max']
      end

      if attributes.key?(:'level_six_rate')
        self.level_six_rate = attributes[:'level_six_rate']
      end

      if attributes.key?(:'level_six_rate_type')
        self.level_six_rate_type = attributes[:'level_six_rate_type']
      end

      if attributes.key?(:'level_six_taxable_max')
        self.level_six_taxable_max = attributes[:'level_six_taxable_max']
      end

      if attributes.key?(:'level_six_caption')
        self.level_six_caption = attributes[:'level_six_caption']
      end

      if attributes.key?(:'level_six_tax_code_xref')
        self.level_six_tax_code_xref = attributes[:'level_six_tax_code_xref']
      end

      if attributes.key?(:'level_six_agency_xref')
        self.level_six_agency_xref = attributes[:'level_six_agency_xref']
      end

      if attributes.key?(:'level_six_services_flag')
        self.level_six_services_flag = attributes[:'level_six_services_flag']
      end

      if attributes.key?(:'level_six_expenses_flag')
        self.level_six_expenses_flag = attributes[:'level_six_expenses_flag']
      end

      if attributes.key?(:'level_six_products_flag')
        self.level_six_products_flag = attributes[:'level_six_products_flag']
      end

      if attributes.key?(:'level_six_apply_single_unit_flag')
        self.level_six_apply_single_unit_flag = attributes[:'level_six_apply_single_unit_flag']
      end

      if attributes.key?(:'level_six_apply_single_unit_min')
        self.level_six_apply_single_unit_min = attributes[:'level_six_apply_single_unit_min']
      end

      if attributes.key?(:'level_six_apply_single_unit_max')
        self.level_six_apply_single_unit_max = attributes[:'level_six_apply_single_unit_max']
      end
      ...
      if attributes.key?(:'add_all_work_roles')
        self.add_all_work_roles = attributes[:'add_all_work_roles']
      end

      if attributes.key?(:'remove_all_work_roles')
        self.remove_all_work_roles = attributes[:'remove_all_work_roles']
      end

      if attributes.key?(:'expense_type_ids')
        if (value = attributes[:'expense_type_ids']).is_a?(Array)
          self.expense_type_ids = value
        end
      end

      if attributes.key?(:'add_all_expense_types')
        self.add_all_expense_types = attributes[:'add_all_expense_types']
      end

      if attributes.key?(:'remove_all_expense_types')
        self.remove_all_expense_types = attributes[:'remove_all_expense_types']
      end

      if attributes.key?(:'product_type_ids')
        if (value = attributes[:'product_type_ids']).is_a?(Array)
          self.product_type_ids = value
        end
      end

      if attributes.key?(:'add_all_product_types')
        self.add_all_product_types = attributes[:'add_all_product_types']
      end

      if attributes.key?(:'remove_all_product_types')
        self.remove_all_product_types = attributes[:'remove_all_product_types']
      end
    ...
    def valid?
      ...
      level_six_rate_type_validator = EnumAttributeValidator.new('String', ["Amount", "Percent"])
    ...
    def level_six_rate_type=(level_six_rate_type)
      validator = EnumAttributeValidator.new('String', ["Amount", "Percent"])
      unless validator.valid?(level_six_rate_type)
        fail ArgumentError, "invalid value for \"level_six_rate_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          level_six_rate == o.level_six_rate &&
          level_six_rate_type == o.level_six_rate_type &&
          level_six_taxable_max == o.level_six_taxable_max &&
          level_six_caption == o.level_six_caption &&
          level_six_tax_code_xref == o.level_six_tax_code_xref &&
          level_six_agency_xref == o.level_six_agency_xref &&
          level_six_services_flag == o.level_six_services_flag &&
          level_six_expenses_flag == o.level_six_expenses_flag &&
          level_six_products_flag == o.level_six_products_flag &&
          level_six_apply_single_unit_flag == o.level_six_apply_single_unit_flag &&
          level_six_apply_single_unit_min == o.level_six_apply_single_unit_min &&
          level_six_apply_single_unit_max == o.level_six_apply_single_unit_max &&
