  ...
  class IntegratorLogin
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::IntegratorLogin` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::IntegratorLogin`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'can_access_all_records_flag')
        self.can_access_all_records_flag = attributes[:'can_access_all_records_flag']
      end

      if attributes.key?(:'can_access_all_apis_flag')
        self.can_access_all_apis_flag = attributes[:'can_access_all_apis_flag']
      end
      ...
      if attributes.key?(:'date_inactivated')
        self.date_inactivated = attributes[:'date_inactivated']
      end

      if attributes.key?(:'inactivated_by')
        self.inactivated_by = attributes[:'inactivated_by']
      end

      if attributes.key?(:'service_ticket_api_flag')
        self.service_ticket_api_flag = attributes[:'service_ticket_api_flag']
      end
      ...
      if attributes.key?(:'service_board_callback_url')
        self.service_board_callback_url = attributes[:'service_board_callback_url']
      end

      if attributes.key?(:'service_board_legacy_callback_flag')
        self.service_board_legacy_callback_flag = attributes[:'service_board_legacy_callback_flag']
      end

      if attributes.key?(:'time_entry_api_flag')
        self.time_entry_api_flag = attributes[:'time_entry_api_flag']
      end
      ...
      if attributes.key?(:'time_entry_callback_url')
        self.time_entry_callback_url = attributes[:'time_entry_callback_url']
      end

      if attributes.key?(:'time_entry_legacy_callback_flag')
        self.time_entry_legacy_callback_flag = attributes[:'time_entry_legacy_callback_flag']
      end

      if attributes.key?(:'managed_services_api_flag')
        self.managed_services_api_flag = attributes[:'managed_services_api_flag']
      end

      if attributes.key?(:'managed_services_auto_child_flag')
        self.managed_services_auto_child_flag = attributes[:'managed_services_auto_child_flag']
      end

      if attributes.key?(:'managed_services_childing_flag')
        self.managed_services_childing_flag = attributes[:'managed_services_childing_flag']
      end

      if attributes.key?(:'contact_api_flag')
        self.contact_api_flag = attributes[:'contact_api_flag']
      end

      if attributes.key?(:'contact_callback_url')
        self.contact_callback_url = attributes[:'contact_callback_url']
      end

      if attributes.key?(:'contact_legacy_callback_flag')
        self.contact_legacy_callback_flag = attributes[:'contact_legacy_callback_flag']
      end

      if attributes.key?(:'company_api_flag')
        self.company_api_flag = attributes[:'company_api_flag']
      end

      if attributes.key?(:'company_callback_url')
        self.company_callback_url = attributes[:'company_callback_url']
      end

      if attributes.key?(:'company_legacy_callback_flag')
        self.company_legacy_callback_flag = attributes[:'company_legacy_callback_flag']
      end

      if attributes.key?(:'activity_api_flag')
        self.activity_api_flag = attributes[:'activity_api_flag']
      end

      if attributes.key?(:'activity_callback_url')
        self.activity_callback_url = attributes[:'activity_callback_url']
      end

      if attributes.key?(:'activity_legacy_callback_flag')
        self.activity_legacy_callback_flag = attributes[:'activity_legacy_callback_flag']
      end

      if attributes.key?(:'invoice_api_flag')
        self.invoice_api_flag = attributes[:'invoice_api_flag']
      end

      if attributes.key?(:'product_api_flag')
        self.product_api_flag = attributes[:'product_api_flag']
      end

      if attributes.key?(:'product_callback_url')
        self.product_callback_url = attributes[:'product_callback_url']
      end

      if attributes.key?(:'product_legacy_callback_flag')
        self.product_legacy_callback_flag = attributes[:'product_legacy_callback_flag']
      end

      if attributes.key?(:'opportunity_api_flag')
        self.opportunity_api_flag = attributes[:'opportunity_api_flag']
      end

      if attributes.key?(:'opportunity_callback_url')
        self.opportunity_callback_url = attributes[:'opportunity_callback_url']
      end

      if attributes.key?(:'opportunity_legacy_callback_flag')
        self.opportunity_legacy_callback_flag = attributes[:'opportunity_legacy_callback_flag']
      end

      if attributes.key?(:'opportunity_conversion_api_flag')
        self.opportunity_conversion_api_flag = attributes[:'opportunity_conversion_api_flag']
      end

      if attributes.key?(:'member_api_flag')
        self.member_api_flag = attributes[:'member_api_flag']
      end

      if attributes.key?(:'marketing_api_flag')
        self.marketing_api_flag = attributes[:'marketing_api_flag']
      end

      if attributes.key?(:'purchasing_api_flag')
        self.purchasing_api_flag = attributes[:'purchasing_api_flag']
      end

      if attributes.key?(:'purchasing_callback_url')
        self.purchasing_callback_url = attributes[:'purchasing_callback_url']
      end

      if attributes.key?(:'purchasing_legacy_callback_flag')
        self.purchasing_legacy_callback_flag = attributes[:'purchasing_legacy_callback_flag']
      end

      if attributes.key?(:'reporting_api_flag')
        self.reporting_api_flag = attributes[:'reporting_api_flag']
      end

      if attributes.key?(:'system_api_flag')
        self.system_api_flag = attributes[:'system_api_flag']
      end

      if attributes.key?(:'project_api_flag')
        self.project_api_flag = attributes[:'project_api_flag']
      end

      if attributes.key?(:'project_callback_url')
        self.project_callback_url = attributes[:'project_callback_url']
      end

      if attributes.key?(:'project_legacy_callback_flag')
        self.project_legacy_callback_flag = attributes[:'project_legacy_callback_flag']
      end

      if attributes.key?(:'configuration_api_flag')
        self.configuration_api_flag = attributes[:'configuration_api_flag']
      end

      if attributes.key?(:'configuration_auto_child_flag')
        self.configuration_auto_child_flag = attributes[:'configuration_auto_child_flag']
      end

      if attributes.key?(:'configuration_childling_flag')
        self.configuration_childling_flag = attributes[:'configuration_childling_flag']
      end

      if attributes.key?(:'configuration_callback_url')
        self.configuration_callback_url = attributes[:'configuration_callback_url']
      end

      if attributes.key?(:'configuration_legacy_callback_flag')
        self.configuration_legacy_callback_flag = attributes[:'configuration_legacy_callback_flag']
      end

      if attributes.key?(:'schedule_api_flag')
        self.schedule_api_flag = attributes[:'schedule_api_flag']
      end

      if attributes.key?(:'schedule_callback_url')
        self.schedule_callback_url = attributes[:'schedule_callback_url']
      end

      if attributes.key?(:'schedule_legacy_callback_flag')
        self.schedule_legacy_callback_flag = attributes[:'schedule_legacy_callback_flag']
      end

      if attributes.key?(:'agreement_api_flag')
        self.agreement_api_flag = attributes[:'agreement_api_flag']
      end

      if attributes.key?(:'agreement_callback_url')
        self.agreement_callback_url = attributes[:'agreement_callback_url']
      end

      if attributes.key?(:'agreement_callback_legacy_flag')
        self.agreement_callback_legacy_flag = attributes[:'agreement_callback_legacy_flag']
      end

      if attributes.key?(:'document_api_flag')
        self.document_api_flag = attributes[:'document_api_flag']
      end
