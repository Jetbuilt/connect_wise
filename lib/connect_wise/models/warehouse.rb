...
module ConnectWise
  class Warehouse
    ...
    attr_accessor :location, :department, :id, :company, :contact, :manager, :site, :location_default_flag,
                  :overall_default_flag, :inactive_flag, :locked_flag, :currency, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Warehouse` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Warehouse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [name, location, department, id, company, contact, manager, site, location_xref, location_default_flag,
       overall_default_flag, inactive_flag, locked_flag, currency, _info].hash
    end
