...
module ConnectWise
  class Warehouse
    ...
    attr_accessor :id, :company, :location, :contact, :department, :manager, :site, :location_default_flag, :overall_default_flag, :inactive_flag, :locked_flag, :currency, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Warehouse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
