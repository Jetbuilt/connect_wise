...
module ConnectWise
  class CompanyManagementSummary
    ...
    attr_accessor :id, :management_solution, :agreement, :snmp_machines, :total_workstations, :total_servers,
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CompanyManagementSummary` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CompanyManagementSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      device_type_validator = EnumAttributeValidator.new('String',
                                                         %w[WorkstationsAndServers BackupStats Servers Workstations])
    ...
    def group_identifier=(group_identifier)
      raise ArgumentError, 'group_identifier cannot be nil' if group_identifier.nil?
    ...
    def device_type=(device_type)
      ...
      unless validator.valid?(device_type)
        raise ArgumentError, "invalid value for \"device_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [group_identifier, id, management_solution, device_type, agreement, snmp_machines, total_workstations,
       total_servers, total_windows_servers, total_windows_workstations, total_managed_machines, servers_offline, servers_disk_space_low, failed_backup_jobs, total_notifications, successful_backup_jobs, server_availability, viruses_removed, spyware_items_removed, windows_patches_installed, disk_cleanups, disk_defragmentations, fully_patched_machines, missing_one_two_patches_machines, missing_three_five_patches_machines, missing_more_five_patches_machines, missing_unscanned_patches_machines, alerts_generated, internet_connectivity, disk_space_cleaned_mb, missing_security_patches, cpu_utilization, memory_utilization, company, _info].hash
    end
