  ...
  class PortalCalendar
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::PortalCalendar` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::PortalCalendar`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'adjust1_start')
        self.adjust1_start = attributes[:'adjust1_start']
      end

      if attributes.key?(:'adjust1_end')
        self.adjust1_end = attributes[:'adjust1_end']
      end

      if attributes.key?(:'adjust1_hours')
        self.adjust1_hours = attributes[:'adjust1_hours']
      end

      if attributes.key?(:'adjust2_start')
        self.adjust2_start = attributes[:'adjust2_start']
      end

      if attributes.key?(:'adjust2_end')
        self.adjust2_end = attributes[:'adjust2_end']
      end

      if attributes.key?(:'adjust2_hours')
        self.adjust2_hours = attributes[:'adjust2_hours']
      end

      if attributes.key?(:'adjust3_start')
        self.adjust3_start = attributes[:'adjust3_start']
      end

      if attributes.key?(:'adjust3_end')
        self.adjust3_end = attributes[:'adjust3_end']
      end

      if attributes.key?(:'adjust3_hours')
        self.adjust3_hours = attributes[:'adjust3_hours']
      end
