...
module ConnectWise
  class PortalCalendar
    attr_accessor :week_start, :id, :adjust1_start, :adjust1_end, :adjust1_hours, :adjust2_start, :adjust2_end,
                  :adjust2_hours, :adjust3_start, :adjust3_end, :adjust3_hours, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::PortalCalendar` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::PortalCalendar`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      week_start_validator = EnumAttributeValidator.new('String',
    ...
    def week_start=(week_start)
      ...
      unless validator.valid?(week_start)
        raise ArgumentError, "invalid value for \"week_start\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [week_start, id, adjust1_start, adjust1_end, adjust1_hours, adjust2_start, adjust2_end, adjust2_hours,
       adjust3_start, adjust3_end, adjust3_hours, _info].hash
    end
