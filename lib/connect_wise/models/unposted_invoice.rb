...
module ConnectWise
  class UnpostedInvoice
    attr_accessor :id, :billing_log_id, :location_id, :department_id, :company, :account_number, :bill_to_company, :bill_to_site, :ship_to_company, :ship_to_site, :invoice_number, :invoice_date, :invoice_type, :description, :billing_terms, :due_days, :due_date, :currency, :sub_total, :total, :invoice_taxable_flag, :tax_code, :item_taxable_flag, :sales_tax_amount, :state_tax_xref, :state_tax_amount, :county_tax_xref, :county_tax_amount, :city_tax_xref, :city_tax_amount, :country_tax_xref, :country_tax_amount, :composite_tax_xref, :composite_tax_amount, :level_six_tax_xref, :level_six_tax_amount, :created_by, :date_closed, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::UnpostedInvoice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
