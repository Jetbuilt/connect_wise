  ...
  class TimePeriodSetup
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::TimePeriodSetup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TimePeriodSetup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'period_apply_to')
        self.period_apply_to = attributes[:'period_apply_to']
      end
      ...
      if attributes.key?(:'number_future_periods')
        self.number_future_periods = attributes[:'number_future_periods']
      end
      ...
      if attributes.key?(:'days_past_end_date')
        self.days_past_end_date = attributes[:'days_past_end_date']
      end
      ...
      if attributes.key?(:'monthly_period_ends')
        self.monthly_period_ends = attributes[:'monthly_period_ends']
      end
      ...
      if attributes.key?(:'last_day_flag')
        self.last_day_flag = attributes[:'last_day_flag']
      end
    ...
    def valid?
      period_apply_to_validator = EnumAttributeValidator.new('String', ["Both", "Expense", "Time"])
    ...
    def period_apply_to=(period_apply_to)
      validator = EnumAttributeValidator.new('String', ["Both", "Expense", "Time"])
