...
module ConnectWise
  class TimePeriodSetup
    attr_accessor :period_apply_to, :year, :number_future_periods, :type, :first_period_end_date, :days_past_end_date, :id, :semi_monthly_last_day_flag, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::TimePeriodSetup` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TimePeriodSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.semi_monthly_first_period = attributes[:semi_monthly_first_period] if attributes.key?(:semi_monthly_first_period)

      self.semi_monthly_second_period = attributes[:semi_monthly_second_period] if attributes.key?(:semi_monthly_second_period)

      self.semi_monthly_last_day_flag = attributes[:semi_monthly_last_day_flag] if attributes.key?(:semi_monthly_last_day_flag)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "first_period_end_date", first_period_end_date cannot be nil.') if @first_period_end_date.nil?
    ...
    def period_apply_to=(period_apply_to)
      ...
      raise ArgumentError, "invalid value for \"period_apply_to\", must be one of #{validator.allowable_values}." unless validator.valid?(period_apply_to)
    ...
    def hash
      [period_apply_to, year, number_future_periods, type, first_period_end_date, days_past_end_date, id, description, monthly_period_ends, semi_monthly_first_period, semi_monthly_second_period, semi_monthly_last_day_flag, last_day_flag, _info].hash
    end
