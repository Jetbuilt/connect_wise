...
module ConnectWise
  class UnpostedProcurement
    attr_accessor :id, :description, :unposted_product_id, :location_id, :department_id, :procurement_type, :purchase_order, :purchase_date, :tracking_number, :billing_terms, :currency, :total, :tax_code, :item_taxable_flag, :purchase_order_taxable_flag, :state_tax_xref, :state_tax_amount, :county_tax_xref, :county_tax_amount, :city_tax_xref, :city_tax_amount, :country_tax_xref, :country_tax_amount, :composite_tax_xref, :composite_tax_amount, :level_six_tax_xref, :level_six_tax_amount, :tax_total, :customer, :vendor, :vendor_account_number, :vendor_invoice_number, :vendor_invoice_date, :tax_freight_flag, :freight_tax_total, :freight_cost, :date_closed, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::UnpostedProcurement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def procurement_type=(procurement_type)
      ...
      raise ArgumentError, "invalid value for \"procurement_type\", must be one of #{validator.allowable_values}." unless validator.valid?(procurement_type)
