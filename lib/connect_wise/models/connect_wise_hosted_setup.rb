...
module ConnectWise
  class ConnectWiseHostedSetup
    ...
    attr_accessor :type, :id, :pod_height, :toolbar_button_dialog_height, :toolbar_button_dialog_width,
                  :toolbar_button_icon_document_id, :disabled_flag, :location_ids, :locations_enabled_flag, :created_by, :date_created, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ConnectWiseHostedSetup` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ConnectWiseHostedSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [screen_id, description, url, type, id, client_id, origin, pod_height, toolbar_button_dialog_height,
       toolbar_button_dialog_width, toolbar_button_text, toolbar_button_tool_tip, toolbar_button_icon_document_id, disabled_flag, location_ids, locations_enabled_flag, created_by, date_created, _info].hash
    end
