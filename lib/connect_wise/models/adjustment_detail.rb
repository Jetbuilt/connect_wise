...
module ConnectWise
  class AdjustmentDetail
    attr_accessor :catalog_item, :warehouse, :warehouse_bin, :quantity_adjusted, :id, :quantity_on_hand, :unit_cost, :adjustment, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AdjustmentDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [catalog_item, warehouse, warehouse_bin, quantity_adjusted, id, description, quantity_on_hand, unit_cost, serial_number, adjustment, _info].hash
    end
