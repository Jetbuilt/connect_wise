...
module ConnectWise
  class Activity
    ...
    attr_accessor :assign_to, :id, :type, :company, :contact, :status, :opportunity, :ticket, :agreement, :campaign, :notes, :date_start, :date_end, :assigned_by, :schedule_status, :reminder, :where, :notify_flag, :mobile_guid, :currency, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Activity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, assign_to, id, type, company, contact, phone_number, email, status, opportunity, ticket, agreement, campaign, notes, date_start, date_end, assigned_by, schedule_status, reminder, where, notify_flag, mobile_guid, currency, _info, custom_fields].hash
    end
