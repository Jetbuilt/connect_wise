...
module ConnectWise
  class GLExportExpense
    attr_accessor :id, :document_date, :document_type, :ap_account_number, :ap_class, :account_number, :gl_class,
                  :gl_type_id, :memo, :description, :period_start_date, :period_end_date, :member, :vendor_number, :company, :company_account_number, :project, :currency, :total, :offset
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::GLExportExpense` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::GLExportExpense`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, document_date, document_type, ap_account_number, ap_class, account_number, gl_class, gl_type_id, memo,
       description, period_start_date, period_end_date, member, vendor_number, company, company_account_number, project, currency, total, offset].hash
    end
