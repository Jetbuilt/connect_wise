...
module ConnectWise
  class PhaseStatus
    ...
    attr_accessor :collapsed_flag

    attr_accessor :closed_flag

    attr_accessor :board_association_ids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::PhaseStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::PhaseStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'collapsed_flag')
        self.collapsed_flag = attributes[:'collapsed_flag']
      end
      ...
      if attributes.key?(:'board_association_ids')
        if (value = attributes[:'board_association_ids']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          collapsed_flag == o.collapsed_flag &&
          closed_flag == o.closed_flag &&
          board_association_ids == o.board_association_ids &&
