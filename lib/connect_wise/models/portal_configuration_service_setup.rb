...
module ConnectWise
  class PortalConfigurationServiceSetup
    attr_accessor :display_closed_tickets_option, :time_materials_ticket_template, :fixed_fee_ticket_template, :id, :service_type_flag, :service_sub_type_flag, :service_sub_type_item_flag, :status_flag, :site_name_flag, :entered_date_flag, :last_update_flag, :required_date_flag, :contact_flag, :assigned_resources_flag, :sla_info_flag, :service_board_flag, :budget_hours_flag, :actual_hours_flag, :approval_status_flag, :open_tasks_flag, :closed_tasks_flag, :enable_chat_assist_flag, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::PortalConfigurationServiceSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "time_materials_ticket_template", time_materials_ticket_template cannot be nil.') if @time_materials_ticket_template.nil?

      invalid_properties.push('invalid value for "fixed_fee_ticket_template", fixed_fee_ticket_template cannot be nil.') if @fixed_fee_ticket_template.nil?
