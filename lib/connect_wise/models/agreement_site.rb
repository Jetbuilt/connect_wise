...
module ConnectWise
  class AgreementSite
    attr_accessor :company, :id, :site, :agreement_id, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementSite`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [company, id, site, agreement_id, _info, custom_fields].hash
    end
