...
module ConnectWise
  class CompanySite
    ...
    attr_accessor :id, :state_reference, :country, :address_format, :tax_code, :entity_type, :expense_reimbursement, :primary_address_flag, :default_shipping_flag, :default_billing_flag, :default_mailing_flag, :inactive_flag, :bill_separate_flag, :mobile_guid, :calendar, :time_zone, :company, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::CompanySite` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CompanySite`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, id, address_line1, address_line2, city, state_reference, zip, country, address_format, phone_number, phone_number_ext, fax_number, tax_code, entity_type, expense_reimbursement, primary_address_flag, default_shipping_flag, default_billing_flag, default_mailing_flag, inactive_flag, bill_separate_flag, mobile_guid, calendar, time_zone, company, _info, custom_fields].hash
    end
