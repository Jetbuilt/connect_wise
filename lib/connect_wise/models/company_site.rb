...
module ConnectWise
  class CompanySite
    ...
    attr_accessor :id, :state_reference, :country, :address_format, :tax_code, :entity_type, :expense_reimbursement, :primary_address_flag, :default_shipping_flag, :default_billing_flag, :default_mailing_flag, :inactive_flag, :bill_separate_flag, :mobile_guid, :calendar, :time_zone, :company, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CompanySite`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
