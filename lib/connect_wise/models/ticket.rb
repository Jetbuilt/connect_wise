  ...
  class Ticket
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Ticket`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.escalation_start_date_utc = attributes[:escalation_start_date_utc] if attributes.key?(:escalation_start_date_utc)
      ...
      self.responded_skipped_minutes = attributes[:responded_skipped_minutes] if attributes.key?(:responded_skipped_minutes)
