...
module ConnectWise
  class AgreementWorkType
    attr_accessor :rate_type, :bill_time, :id, :work_type, :location, :location_id, :rate, :hours_max, :hours_min, :round_bill_hours, :overage_rate, :overage_rate_type, :agreement_limit, :site, :effective_date, :ending_date, :agreement, :agreement_id, :company, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::AgreementWorkType` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementWorkType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.agreement_limit = attributes[:agreement_limit] if attributes.key?(:agreement_limit)
    ...
    def overage_rate_type=(overage_rate_type)
      validator = EnumAttributeValidator.new('String', %w[AdjAmount Custom Multiplier])
      raise ArgumentError, "invalid value for \"overage_rate_type\", must be one of #{validator.allowable_values}." unless validator.valid?(overage_rate_type)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        agreement_limit == other.agreement_limit &&
        site == other.site &&
    ...
    def hash
      [rate_type, bill_time, id, work_type, location, location_id, rate, hours_max, hours_min, round_bill_hours, overage_rate, overage_rate_type, agreement_limit, site, effective_date, ending_date, agreement, agreement_id, company, _info].hash
    end
