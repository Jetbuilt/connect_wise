  ...
  class AgreementWorkType
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::AgreementWorkType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementWorkType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hours_max')
        self.hours_max = attributes[:'hours_max']
      end

      if attributes.key?(:'hours_min')
        self.hours_min = attributes[:'hours_min']
      end

      if attributes.key?(:'round_bill_hours')
        self.round_bill_hours = attributes[:'round_bill_hours']
      end
      ...
      if attributes.key?(:'overage_rate_type')
        self.overage_rate_type = attributes[:'overage_rate_type']
      end

      if attributes.key?(:'agreement_limit')
        self.agreement_limit = attributes[:'agreement_limit']
      end
      ...
      if attributes.key?(:'ending_date')
        self.ending_date = attributes[:'ending_date']
      end
