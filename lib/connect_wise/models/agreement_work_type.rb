...
module ConnectWise
  class AgreementWorkType
    attr_accessor :rate_type, :bill_time, :id, :work_type, :location, :location_id, :rate, :hours_max, :hours_min,
                  :round_bill_hours, :overage_rate, :overage_rate_type, :agreement_limit, :site, :effective_date, :ending_date, :agreement, :agreement_id, :company, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AgreementWorkType` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AgreementWorkType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [rate_type, bill_time, id, work_type, location, location_id, rate, hours_max, hours_min, round_bill_hours,
       overage_rate, overage_rate_type, agreement_limit, site, effective_date, ending_date, agreement, agreement_id, company, _info].hash
    end
