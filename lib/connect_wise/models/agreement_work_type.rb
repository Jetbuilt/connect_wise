...
module ConnectWise
  class AgreementWorkType
    attr_accessor :rate_type, :bill_time, :id, :work_type, :location_id, :rate, :hours_max, :hours_min, :round_bill_hours, :overage_rate, :overage_rate_type, :agreement_limit, :site, :effective_date, :ending_date, :agreement_id, :company, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementWorkType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [rate_type, bill_time, id, work_type, location_id, rate, hours_max, hours_min, round_bill_hours, overage_rate, overage_rate_type, agreement_limit, site, effective_date, ending_date, agreement_id, company, _info].hash
    end
