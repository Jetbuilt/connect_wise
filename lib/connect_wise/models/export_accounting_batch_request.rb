...
module ConnectWise
  class ExportAccountingBatchRequest
    ...
    attr_accessor :gl_interface_identifier, :thru_date, :location_id, :summarize_invoices, :included_invoice_ids, :excluded_invoice_ids, :included_expense_ids, :excluded_expense_ids, :included_product_ids, :excluded_product_ids
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ExportAccountingBatchRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless (value = attributes[:excluded_product_ids]).is_a?(Array)
