...
module ConnectWise
  class ExportAccountingBatchRequest
    ...
    attr_accessor :gl_interface_identifier, :thru_date, :location_id, :summarize_invoices, :included_invoice_ids,
                  :excluded_invoice_ids, :included_expense_ids, :excluded_expense_ids, :included_payment_ids, :included_product_ids, :excluded_product_ids
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ExportAccountingBatchRequest` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ExportAccountingBatchRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def summarize_invoices=(summarize_invoices)
      ...
      unless validator.valid?(summarize_invoices)
        raise ArgumentError, "invalid value for \"summarize_invoices\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [batch_identifier, gl_interface_identifier, thru_date, location_id, summarize_invoices, export_invoices_flag,
