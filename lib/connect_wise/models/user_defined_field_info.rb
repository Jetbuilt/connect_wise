...
module ConnectWise
  class UserDefinedFieldInfo
    ...
    attr_accessor :field_type_identifier, :entry_type_identifier, :required_flag, :display_on_screen_flag, :read_only_flag, :options, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::UserDefinedFieldInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
