...
module ConnectWise
  class ScheduleEntry
    attr_accessor :type, :id, :object_id, :member, :where, :date_start, :date_end, :reminder, :status, :span,
                  :done_flag, :acknowledged_flag, :owner_flag, :meeting_flag, :allow_schedule_conflicts_flag, :add_member_to_project_flag, :project_role_id, :mobile_guid, :acknowledged_date, :close_date, :notify_resource, :notification_sent, :notification_response, :hours, :start_time_set, :end_time_set, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ScheduleEntry` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ScheduleEntry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [type, id, object_id, name, member, where, date_start, date_end, reminder, status, span, done_flag,
       acknowledged_flag, owner_flag, meeting_flag, allow_schedule_conflicts_flag, add_member_to_project_flag, project_role_id, mobile_guid, acknowledged_date, close_date, notify_resource, notification_sent, notification_response, hours, start_time_set, end_time_set, _info].hash
    end
