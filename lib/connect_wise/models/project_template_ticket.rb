  ...
  class ProjectTemplateTicket
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ProjectTemplateTicket` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ProjectTemplateTicket`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:project_template_phase_id)
        self.project_template_phase_id = attributes[:project_template_phase_id]
      end
      ...
      if attributes.key?(:project_template_phase_cw_id)
        self.project_template_phase_cw_id = attributes[:project_template_phase_cw_id]
      end
    ...
    def hash
      [description, id, project_template_id, project_template_phase_id, line_number, connect_wise_id, parent_id,
