  ...
  class GLAccount
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::GLAccount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def valid?
      ...
      gl_type_validator = EnumAttributeValidator.new('String', %w[AP AR EE EI EO IA IT P PF R RA RD RE RP ST SD ET FT PT WP WR])
    ...
    def gl_type=(gl_type)
      validator = EnumAttributeValidator.new('String', %w[AP AR EE EI EO IA IT P PF R RA RD RE RP ST SD ET FT PT WP WR])
