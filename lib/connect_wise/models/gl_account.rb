  ...
  class GLAccount
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::GLAccount` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::GLAccount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    # @param [Object] mapped_type Value to be assigned
    def mapped_type=(mapped_type)
      raise ArgumentError, 'mapped_type cannot be nil' if mapped_type.nil?

      @mapped_type = mapped_type
    end

    # Custom attribute writer method with validation
    # @param [Object] mapped_record Value to be assigned
    def mapped_record=(mapped_record)
      raise ArgumentError, 'mapped_record cannot be nil' if mapped_record.nil?
    ...
    def hash
      [gl_type, mapped_type, mapped_record, id, segment1, segment2, segment3, segment4, segment5, segment6, segment7,
       segment8, segment9, segment10, cogs1, cogs2, cogs3, cogs4, cogs5, cogs6, cogs7, cogs8, cogs9, cogs10, product_id, inventory, sales_code, _info].hash
    end
