  ...
  class Agreement
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Agreement` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Agreement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def period_type=(period_type)
      ...
      unless validator.valid?(period_type)
        raise ArgumentError, "invalid value for \"period_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def agreement_status=(agreement_status)
      ...
      unless validator.valid?(agreement_status)
        raise ArgumentError, "invalid value for \"agreement_status\", must be one of #{validator.allowable_values}."
      end
