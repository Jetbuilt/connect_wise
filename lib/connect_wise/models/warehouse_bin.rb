...
module ConnectWise
  class WarehouseBin
    ...
    attr_accessor :warehouse, :id, :location, :department, :min_quantity, :max_quantity, :overflow_bin, :manager, :length, :width, :height, :weight, :default_flag, :inactive_flag, :quantity_on_hand, :company, :transfer_bin, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::WarehouseBin`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, warehouse, id, location, department, min_quantity, max_quantity, overflow_bin, manager, length, width, height, weight, default_flag, inactive_flag, quantity_on_hand, company, transfer_bin, _info].hash
    end
