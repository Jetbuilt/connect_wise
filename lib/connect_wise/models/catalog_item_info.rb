...
module ConnectWise
  class CatalogItemInfo
    attr_accessor :id, :identifier, :description, :inactive_flag, :product_class, :serialized_cost_flag, :price, :cost, :taxable_flag, :drop_ship_flag, :special_order_flag, :customer_description, :manufacturer_part_number, :vendor_sku, :billable_option, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::CatalogItemInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CatalogItemInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, identifier, description, inactive_flag, product_class, serialized_cost_flag, price, cost, taxable_flag, drop_ship_flag, special_order_flag, customer_description, manufacturer_part_number, vendor_sku, billable_option, _info].hash
    end
