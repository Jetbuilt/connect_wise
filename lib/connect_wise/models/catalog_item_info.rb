...
module ConnectWise
  class CatalogItemInfo
    attr_accessor :id, :identifier, :description, :inactive_flag, :product_class, :serialized_cost_flag, :price, :cost,
                  :taxable_flag, :drop_ship_flag, :special_order_flag, :customer_description, :manufacturer_part_number, :vendor_sku, :billable_option, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CatalogItemInfo` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CatalogItemInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, identifier, description, inactive_flag, product_class, serialized_cost_flag, price, cost, taxable_flag,
       drop_ship_flag, special_order_flag, customer_description, manufacturer_part_number, vendor_sku, billable_option, _info].hash
    end
