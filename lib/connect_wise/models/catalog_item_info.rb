...
module ConnectWise
  class CatalogItemInfo
    attr_accessor :id, :identifier, :description, :inactive_flag, :product_class, :serialized_cost_flag, :price, :cost, :taxable_flag, :drop_ship_flag, :special_order_flag, :customer_description, :manufacturer_part_number, :vendor_sku, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CatalogItemInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, identifier, description, inactive_flag, product_class, serialized_cost_flag, price, cost, taxable_flag, drop_ship_flag, special_order_flag, customer_description, manufacturer_part_number, vendor_sku, _info].hash
    end
