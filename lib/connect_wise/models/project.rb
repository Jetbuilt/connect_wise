...
module ConnectWise
  class Project
    attr_accessor :billing_method, :estimated_end, :estimated_start, :id, :_info, :actual_end, :actual_hours, :actual_start, :agreement, :billing_amount, :billing_terms, :bill_project_after_closed_flag, :bill_to_company, :bill_to_contact, :bill_to_site, :bill_unapproved_time_and_expense, :board, :budget_flag, :budget_hours, :company, :contact, :description, :currency, :downpayment, :percent_complete, :estimated_expense_revenue, :estimated_hours, :estimated_product_revenue, :estimated_time_revenue, :expense_approver, :include_dependencies_flag, :include_estimates_flag, :location, :department, :manager, :opportunity, :project_template_id, :restrict_down_payment_flag, :scheduled_end, :scheduled_hours, :scheduled_start, :ship_to_company, :ship_to_contact, :ship_to_site, :site, :status, :closed_flag, :time_approver, :type, :do_not_display_in_portal_flag, :billing_start_date, :estimated_time_cost, :estimated_expense_cost, :estimated_product_cost, :tax_code, :company_location, :custom_fields
