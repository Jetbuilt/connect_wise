...
module ConnectWise
  class DepartmentLocation
    attr_accessor :location, :id, :department, :department_manager, :dispatch, :service_manager, :duty_manager,
                  :ldap_config, :add_all_locations, :remove_all_locations, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::DepartmentLocation` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::DepartmentLocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [location, id, department, department_manager, dispatch, service_manager, duty_manager, ldap_config,
       add_all_locations, remove_all_locations, _info].hash
    end
