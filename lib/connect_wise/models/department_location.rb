...
module ConnectWise
  class DepartmentLocation
    attr_accessor :location, :id, :department, :department_manager, :dispatch, :service_manager, :duty_manager, :ldap_config, :add_all_locations, :remove_all_locations, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::DepartmentLocation` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::DepartmentLocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.dispatch = attributes[:dispatch] if attributes.key?(:dispatch)
      ...
      self.ldap_config = attributes[:ldap_config] if attributes.key?(:ldap_config)
    ...
    def hash
      [location, id, department, department_manager, dispatch, service_manager, duty_manager, ldap_config, add_all_locations, remove_all_locations, _info].hash
    end
