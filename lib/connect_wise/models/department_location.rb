...
module ConnectWise
  class DepartmentLocation
    attr_accessor :id, :location, :department, :department_manager, :dispatch, :service_manager, :duty_manager, :ldap_config, :add_all_locations, :remove_all_locations, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::DepartmentLocation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
