...
module ConnectWise
  class KnowledgeBaseArticle
    attr_accessor :title, :issue, :resolution, :id, :location_id, :business_unit_id, :board, :category_id,
                  :sub_category_id, :date_created, :created_by, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::KnowledgeBaseArticle` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::KnowledgeBaseArticle`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [title, issue, resolution, id, location_id, business_unit_id, board, category_id, sub_category_id, date_created,
       created_by, _info].hash
    end
