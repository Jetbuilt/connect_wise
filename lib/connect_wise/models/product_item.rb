...
module ConnectWise
  class ProductItem
    attr_accessor :catalog_item, :billable_option, :id, :sequence_number, :quantity, :unit_of_measure, :price, :cost, :ext_price, :ext_cost, :discount, :margin, :agreement_amount, :price_method, :agreement, :location, :business_unit, :vendor, :taxable_flag, :dropship_flag, :special_order_flag, :phase_product_flag, :cancelled_flag, :quantity_cancelled, :product_supplied_flag, :sub_contractor_ship_to_id, :sub_contractor_amount_limit, :recurring, :sla, :entity_type, :ticket, :project, :phase, :sales_order, :opportunity, :invoice, :warehouse_id, :warehouse_id_object, :warehouse_bin_id, :warehouse_bin_id_object, :calculated_price_flag, :calculated_cost_flag, :forecast_detail_id, :cancelled_by, :cancelled_date, :warehouse, :warehouse_bin, :purchase_date, :tax_code, :integration_x_ref, :list_price, :serial_number_ids, :serial_numbers, :company, :forecast_status, :product_class, :need_to_purchase_flag, :need_to_order_quantity, :minimum_stock_flag, :calculated_price, :calculated_cost, :invoice_grouping, :po_approved_flag, :uom, :add_components_flag, :ignore_pricing_schedules_flag, :asio_subscriptions_id, :_info, :bypass_forecast_update, :custom_fields
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProductItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [catalog_item, billable_option, id, description, sequence_number, quantity, unit_of_measure, price, cost, ext_price, ext_cost, discount, margin, agreement_amount, price_method, agreement, location_id, location, business_unit_id, business_unit, vendor, vendor_sku, taxable_flag, dropship_flag, special_order_flag, phase_product_flag, cancelled_flag, quantity_cancelled, cancelled_reason, customer_description, internal_notes, product_supplied_flag, sub_contractor_ship_to_id, sub_contractor_amount_limit, recurring, sla, entity_type, ticket, project, phase, sales_order, opportunity, invoice, warehouse_id, warehouse_id_object, warehouse_bin_id, warehouse_bin_id_object, calculated_price_flag, calculated_cost_flag, forecast_detail_id, cancelled_by, cancelled_date, warehouse, warehouse_bin, purchase_date, tax_code, integration_x_ref, list_price, serial_number_ids, serial_numbers, company, forecast_status, product_class, need_to_purchase_flag, need_to_order_quantity, minimum_stock_flag, ship_set, calculated_price, calculated_cost, invoice_grouping, po_approved_flag, uom, add_components_flag, ignore_pricing_schedules_flag, asio_subscriptions_id, _info, bypass_forecast_update, custom_fields].hash
    end
