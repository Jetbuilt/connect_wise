...
module ConnectWise
  class WorkflowActionUserDefinedField
    attr_accessor :id, :event_id, :action_id, :caption, :user_defined_field_id, :value, :overwrite_flag, :pod_description, :field_type_id, :entry_type_id, :required_flag, :inactive_flag, :_info
