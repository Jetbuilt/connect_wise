...
module ConnectWise
  class CatalogComponent
    attr_accessor :quantity, :catalog_item, :id, :sequence_number, :hide_price_flag, :hide_item_identifier_flag,
                  :hide_description_flag, :hide_quantity_flag, :hide_extended_price_flag, :parent_catalog_item, :price, :cost, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CatalogComponent` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CatalogComponent`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [quantity, catalog_item, id, sequence_number, hide_price_flag, hide_item_identifier_flag, hide_description_flag,
       hide_quantity_flag, hide_extended_price_flag, parent_catalog_item, price, cost, _info].hash
    end
