...
module ConnectWise
  class ChargeCode
    ...
    attr_accessor :id, :company, :location, :department, :bill_time, :expense_entry_flag, :allow_all_expense_type_flag, :time_entry_flag, :work_type, :work_role, :expense_type_ids, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::ChargeCode` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ChargeCode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
