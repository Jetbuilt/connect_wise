...
module ConnectWise
  class ChargeCode
    ...
    attr_accessor :company, :id, :location, :department, :bill_time, :expense_entry_flag, :allow_all_expense_type_flag, :time_entry_flag, :work_type, :work_role, :expense_type_ids, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ChargeCode`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, company, id, location, department, bill_time, expense_entry_flag, allow_all_expense_type_flag, time_entry_flag, work_type, work_role, integration_xref, expense_type_ids, _info].hash
    end
