...
module ConnectWise
  class Company
    ...
    attr_accessor :id, :status, :country, :territory, :market, :account_number, :default_contact, :date_acquired,
                  :sic_code, :parent_company, :annual_revenue, :number_of_employees, :year_established, :revenue_year, :ownership_type, :time_zone_setup, :lead_flag, :unsubscribe_flag, :calendar, :vendor_identifier, :tax_identifier, :tax_code, :billing_terms, :invoice_template, :pricing_schedule, :company_entity_type, :bill_to_company, :billing_site, :billing_contact, :invoice_delivery_method, :invoice_to_email_address, :invoice_cc_email_address, :deleted_flag, :date_deleted, :deleted_by, :mobile_guid, :facebook_url, :twitter_url, :linked_in_url, :currency, :territory_manager, :reseller_identifier, :is_vendor_flag, :site, :integrator_tags, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Company` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Company`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [identifier, name, id, status, address_line1, address_line2, city, state, zip, country, phone_number, fax_number,
