...
module ConnectWise
  class TaxCodeXRef
    ...
    attr_accessor :id, :default_flag, :level_one, :level_two, :level_three, :level_four, :level_five, :level_six, :tax_code, :taxable_levels, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TaxCodeXRef`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def level_one=(level_one)
      ...
      raise ArgumentError, "invalid value for \"level_one\", must be one of #{validator.allowable_values}." unless validator.valid?(level_one)
    ...
    def level_two=(level_two)
      validator = EnumAttributeValidator.new('String', %w[NonTaxable Taxable])
      raise ArgumentError, "invalid value for \"level_two\", must be one of #{validator.allowable_values}." unless validator.valid?(level_two)
    ...
    def level_three=(level_three)
      validator = EnumAttributeValidator.new('String', %w[NonTaxable Taxable])
      raise ArgumentError, "invalid value for \"level_three\", must be one of #{validator.allowable_values}." unless validator.valid?(level_three)
    ...
    def level_four=(level_four)
      validator = EnumAttributeValidator.new('String', %w[NonTaxable Taxable])
      raise ArgumentError, "invalid value for \"level_four\", must be one of #{validator.allowable_values}." unless validator.valid?(level_four)
    ...
    def level_five=(level_five)
      validator = EnumAttributeValidator.new('String', %w[NonTaxable Taxable])
      raise ArgumentError, "invalid value for \"level_five\", must be one of #{validator.allowable_values}." unless validator.valid?(level_five)
    ...
    def level_six=(level_six)
      validator = EnumAttributeValidator.new('String', %w[NonTaxable Taxable])
      raise ArgumentError, "invalid value for \"level_six\", must be one of #{validator.allowable_values}." unless validator.valid?(level_six)
