  ...
  class CatalogItem
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CatalogItem` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CatalogItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:auto_update_unit_cost_flag)
        self.auto_update_unit_cost_flag = attributes[:auto_update_unit_cost_flag]
      end

      if attributes.key?(:auto_update_unit_price_flag)
        self.auto_update_unit_price_flag = attributes[:auto_update_unit_price_flag]
      end
    ...
    def valid?
      ...
      price_attribute_validator = EnumAttributeValidator.new('String',
                                                             %w[FixedFee NotToExceed OverrideRate TimeAndMaterials])
    ...
    def price_attribute=(price_attribute)
      ...
      unless validator.valid?(price_attribute)
        raise ArgumentError, "invalid value for \"price_attribute\", must be one of #{validator.allowable_values}."
      end
    ...
    def recurring_cycle_type=(recurring_cycle_type)
      ...
      unless validator.valid?(recurring_cycle_type)
        raise ArgumentError, "invalid value for \"recurring_cycle_type\", must be one of #{validator.allowable_values}."
      end
