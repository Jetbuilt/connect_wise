...
module ConnectWise
  class PurchaseOrderLineItem
    ...
    attr_accessor :line_number, :product, :quantity, :unit_of_measure, :id, :backordered_flag, :canceled_by,
                  :canceled_flag, :closed_flag, :date_canceled, :date_canceled_utc, :display_internal_notes_flag, :expected_ship_date, :purchase_order_id, :received_quantity, :serial_numbers, :ship_date, :shipment_method, :tax, :unit_cost, :warehouse, :warehouse_bin, :date_received, :received_status, :_info, :ext_cost, :expected_arrival_date, :is_detach_available, :batched_flag, :unbatched_rec_id, :sales_order, :custom_fields
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::PurchaseOrderLineItem` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::PurchaseOrderLineItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      received_status_validator = EnumAttributeValidator.new('String',
                                                             %w[Waiting FullyReceived PartiallyReceiveCancelRest
    ...
    def received_status=(received_status)
      ...
      unless validator.valid?(received_status)
        raise ArgumentError, "invalid value for \"received_status\", must be one of #{validator.allowable_values}."
      end
