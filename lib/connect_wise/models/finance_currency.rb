...
module ConnectWise
  class FinanceCurrency
    ...
    attr_accessor :id, :display_id_flag, :display_symbol_flag, :currency_code, :negative_parentheses_flag,
                  :right_align, :number_of_decimals, :report_format, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::FinanceCurrency` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::FinanceCurrency`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [currency_identifier, name, id, symbol, display_id_flag, display_symbol_flag, currency_code, thousands_separator,
       decimal_separator, negative_parentheses_flag, right_align, number_of_decimals, report_format, _info].hash
    end
