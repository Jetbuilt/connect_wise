...
module ConnectWise
  class FinanceCurrency
    ...
    attr_accessor :id, :display_id_flag, :display_symbol_flag, :currency_code, :negative_parentheses_flag, :right_align, :number_of_decimals, :report_format, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::FinanceCurrency` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::FinanceCurrency`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.report_format = attributes[:report_format] if attributes.key?(:report_format)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "currency_identifier", currency_identifier cannot be nil.') if @currency_identifier.nil?
    ...
    def currency_identifier=(currency_identifier)
      raise ArgumentError, 'currency_identifier cannot be nil' if currency_identifier.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        report_format == other.report_format &&
        _info == other._info
    end
