  ...
  class ProjectTicket
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ProjectTicket` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ProjectTicket`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      self.schedule_start_date = attributes[:schedule_start_date] if attributes.key?(:schedule_start_date)

      self.schedule_end_date = attributes[:schedule_end_date] if attributes.key?(:schedule_end_date)
      ...
      if attributes.key?(:tasks) && (value = attributes[:tasks]).is_a?(Array)
        self.tasks = value
      end
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "phase", phase cannot be nil.') if @phase.nil?
    ...
    def phase=(phase)
      raise ArgumentError, 'phase cannot be nil' if phase.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        schedule_start_date == other.schedule_start_date &&
        schedule_end_date == other.schedule_end_date &&
    ...
    def hash
      [summary, phase, id, is_issue_flag, board, status, work_role, work_type, project, wbs_code, company, site,
       site_name, address_line1, address_line2, city, state_identifier, zip, country, contact, contact_name, contact_phone_number, contact_phone_extension, contact_email_address, type, sub_type, item, owner, priority, service_location, source, required_date, budget_hours, opportunity, agreement, agreement_type, knowledge_base_category_id, knowledge_base_sub_category_id, knowledge_base_link_id, knowledge_base_link_type, allow_all_clients_portal_view, customer_updated_flag, automatic_email_contact_flag, automatic_email_resource_flag, automatic_email_cc_flag, automatic_email_cc, closed_date, closed_by, closed_flag, actual_hours, approved, sub_billing_method, sub_billing_amount, sub_date_accepted, resources, bill_time, bill_expenses, bill_products, predecessor_type, predecessor_id, predecessor_closed_flag, lag_days, lag_nonworking_days_flag, estimated_start_date, location, department, duration, schedule_start_date, schedule_end_date, mobile_guid, currency, _info, tasks, initial_description, initial_internal_analysis, initial_resolution, contact_email_lookup, process_notifications, skip_callback, custom_fields].hash
    end
