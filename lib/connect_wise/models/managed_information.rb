...
module ConnectWise
  class ManagedInformation
    attr_accessor :management_solution_name, :managed_identifier, :type, :level, :child_configurations_matching_on,
                  :inactivate_configurations_matching_on, :inactive_configuration_status_id
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ManagedInformation` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ManagedInformation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [management_solution_name, managed_identifier, type, level, child_configurations_matching_on,
       inactivate_configurations_matching_on, inactive_configuration_status_id].hash
    end
