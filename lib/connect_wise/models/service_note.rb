...
module ConnectWise
  class ServiceNote
    attr_accessor :id, :ticket_id, :text, :detail_description_flag, :internal_analysis_flag, :resolution_flag,
                  :issue_flag, :member, :contact, :customer_updated_flag, :process_notifications, :date_created, :created_by, :internal_flag, :external_flag, :sentiment_score, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ServiceNote` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ServiceNote`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      self.sentiment_score = attributes[:sentiment_score] if attributes.key?(:sentiment_score)
    ...
    def hash
      [id, ticket_id, text, detail_description_flag, internal_analysis_flag, resolution_flag, issue_flag, member,
       contact, customer_updated_flag, process_notifications, date_created, created_by, internal_flag, external_flag, sentiment_score, _info].hash
    end
