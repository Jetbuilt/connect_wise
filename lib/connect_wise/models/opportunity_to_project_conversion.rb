...
module ConnectWise
  class OpportunityToProjectConversion
    attr_accessor :project_id, :name, :status, :location_id, :business_unit_id, :board, :manager, :estimated_start,
                  :estimated_end, :include_all_notes_flag, :include_all_documents_flag, :include_all_products_flag, :include_note_ids, :include_document_ids, :include_product_ids
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::OpportunityToProjectConversion` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::OpportunityToProjectConversion`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [project_id, name, status, location_id, business_unit_id, board, manager, estimated_start, estimated_end,
       include_all_notes_flag, include_all_documents_flag, include_all_products_flag, include_note_ids, include_document_ids, include_product_ids].hash
    end
