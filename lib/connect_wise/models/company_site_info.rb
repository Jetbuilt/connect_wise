...
module ConnectWise
  class CompanySiteInfo
    attr_accessor :id, :name, :address_line1, :address_line2, :city, :state_reference, :country, :zip, :address_format, :phone_number, :inactive_flag, :default_shipping_flag, :default_billing_flag, :primary_address_flag, :tax_code, :phone_number_ext, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::CompanySiteInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CompanySiteInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, name, address_line1, address_line2, city, state_reference, country, zip, address_format, phone_number, inactive_flag, default_shipping_flag, default_billing_flag, primary_address_flag, tax_code, phone_number_ext, _info].hash
    end
