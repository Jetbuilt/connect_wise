...
module ConnectWise
  class CompanySiteInfo
    attr_accessor :id, :name, :address_line1, :address_line2, :city, :state_reference, :country, :zip, :address_format,
                  :phone_number, :inactive_flag, :default_shipping_flag, :default_billing_flag, :primary_address_flag, :tax_code, :phone_number_ext, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CompanySiteInfo` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CompanySiteInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, name, address_line1, address_line2, city, state_reference, country, zip, address_format, phone_number,
       inactive_flag, default_shipping_flag, default_billing_flag, primary_address_flag, tax_code, phone_number_ext, _info].hash
    end
