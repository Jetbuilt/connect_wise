...
module ConnectWise
  class BoardInfo
    attr_accessor :id, :name, :location, :department, :project_flag, :inactive_flag, :closed_loop_discussions_flag, :closed_loop_internal_analysis_flag, :closed_loop_resolution_flag, :closed_loop_all_flag, :problem_sort, :internal_analysis_sort, :resolution_sort, :all_sort, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BoardInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
