...
module ConnectWise
  class BoardInfo
    attr_accessor :id, :name, :location, :department, :project_flag, :inactive_flag, :closed_loop_discussions_flag, :closed_loop_internal_analysis_flag, :closed_loop_resolution_flag, :closed_loop_all_flag, :override_billing_setup_flag, :bill_tickets_after_closed_flag, :bill_unapproved_time_expense_flag, :bill_time, :bill_expense, :bill_product, :problem_sort, :internal_analysis_sort, :resolution_sort, :all_sort, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::BoardInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BoardInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, name, location, department, project_flag, inactive_flag, closed_loop_discussions_flag, closed_loop_internal_analysis_flag, closed_loop_resolution_flag, closed_loop_all_flag, override_billing_setup_flag, bill_tickets_after_closed_flag, bill_unapproved_time_expense_flag, bill_time, bill_expense, bill_product, problem_sort, internal_analysis_sort, resolution_sort, all_sort, _info].hash
    end
