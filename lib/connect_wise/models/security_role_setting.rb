...
module ConnectWise
  class SecurityRoleSetting
    attr_accessor :id, :add_level, :edit_level, :delete_level, :inquire_level, :module_function_name,
                  :module_function_description, :my_all_flag, :module_function_identifier, :report_flag, :restrict_flag, :custom_flag, :module_description, :module_identifier, :module_name, :sort_order, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::SecurityRoleSetting` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::SecurityRoleSetting`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def add_level=(add_level)
      ...
      unless validator.valid?(add_level)
        raise ArgumentError, "invalid value for \"add_level\", must be one of #{validator.allowable_values}."
      end
    ...
    def edit_level=(edit_level)
      ...
      unless validator.valid?(edit_level)
        raise ArgumentError, "invalid value for \"edit_level\", must be one of #{validator.allowable_values}."
      end
    ...
    def delete_level=(delete_level)
      ...
      unless validator.valid?(delete_level)
        raise ArgumentError, "invalid value for \"delete_level\", must be one of #{validator.allowable_values}."
      end
    ...
    def inquire_level=(inquire_level)
      ...
      unless validator.valid?(inquire_level)
        raise ArgumentError, "invalid value for \"inquire_level\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, add_level, edit_level, delete_level, inquire_level, module_function_name, module_function_description,
       my_all_flag, module_function_identifier, report_flag, restrict_flag, custom_flag, module_description, module_identifier, module_name, sort_order, _info].hash
    end
