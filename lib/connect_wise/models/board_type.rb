...
module ConnectWise
  class BoardType
    ...
    attr_accessor :id, :category, :default_flag, :inactive_flag, :request_for_change_flag, :skill_category, :skill,
                  :board, :location, :department, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::BoardType` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::BoardType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def category=(category)
      ...
      unless validator.valid?(category)
        raise ArgumentError, "invalid value for \"category\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, id, category, default_flag, inactive_flag, request_for_change_flag, integration_xref, skill_category,
       skill, board, location, department, _info].hash
    end
