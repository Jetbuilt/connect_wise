...
module ConnectWise
  class BoardType
    ...
    attr_accessor :id, :category, :default_flag, :inactive_flag, :request_for_change_flag, :board, :location, :department, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BoardType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, id, category, default_flag, inactive_flag, request_for_change_flag, integration_xref, board, location, department, _info].hash
    end
