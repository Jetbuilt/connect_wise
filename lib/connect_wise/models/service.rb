...
module ConnectWise
  class Service
    attr_accessor :sr_notify, :schedule_span, :id, :hide_delimiter_flag, :allow_cc_flag, :allow_to_flag,
                  :calendar_setup, :header_color_disable_flag, :member_color_disable_flag, :contact_color_disable_flag, :unknown_color_disable_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Service` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Service`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      sr_notify_validator = EnumAttributeValidator.new('String',
                                                       %w[All NewAndClosedRequests ClosedRequestsOnly NewRequestsOnly
                                                          None])
    ...
    def sr_notify=(sr_notify)
      validator = EnumAttributeValidator.new('String',
                                             %w[All NewAndClosedRequests ClosedRequestsOnly NewRequestsOnly None])
      unless validator.valid?(sr_notify)
        raise ArgumentError, "invalid value for \"sr_notify\", must be one of #{validator.allowable_values}."
      end
    ...
    def schedule_span=(schedule_span)
      ...
      unless validator.valid?(schedule_span)
        raise ArgumentError, "invalid value for \"schedule_span\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [sr_notify, schedule_span, id, hide_delimiter_flag, allow_cc_flag, allow_to_flag, header_color, member_color,
       contact_color, unknown_color, calendar_setup, header_color_disable_flag, member_color_disable_flag, contact_color_disable_flag, unknown_color_disable_flag, _info].hash
    end
