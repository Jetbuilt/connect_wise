...
module ConnectWise
  class AgreementRecap
    attr_accessor :id, :adjustment_amount, :agreement_status, :name, :available_amount, :company_name, :is_unlimited,
                  :last_invoice_amount, :last_invoice_date, :last_invoice_number, :next_invoice_amount, :next_invoice_date, :overrun_amount, :remaining_amount, :starting_amount, :unbilled_overage_amount, :unbilled_periods, :used_amount
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AgreementRecap` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AgreementRecap`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, adjustment_amount, agreement_status, name, available_amount, company_name, is_unlimited,
       last_invoice_amount, last_invoice_date, last_invoice_number, next_invoice_amount, next_invoice_date, overrun_amount, remaining_amount, starting_amount, unbilled_overage_amount, unbilled_periods, used_amount].hash
    end
