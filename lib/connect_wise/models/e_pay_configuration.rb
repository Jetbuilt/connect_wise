...
module ConnectWise
  class EPayConfiguration
    ...
    attr_accessor :id, :location, :currency, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::EPayConfiguration` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::EPayConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "store_identifier", store_identifier cannot be nil.') if @store_identifier.nil?
    ...
    def hash
      [url, store_identifier, id, location, currency, encryption_key, initialization_vector, _info].hash
    end
