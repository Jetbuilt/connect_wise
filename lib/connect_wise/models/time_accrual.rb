...
module ConnectWise
  class TimeAccrual
    attr_accessor :id, :location, :vacation_available_type, :vacation_carryover_allowed_flag,
                  :vacation_carryover_limit, :sick_available_type, :sick_carryover_allowed_flag, :sick_carryover_limit, :pto_available_type, :pto_carryover_allowed_flag, :pto_carryover_limit, :holiday_available_type, :holiday_carryover_allowed_flag, :holiday_carryover_limit, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TimeAccrual` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TimeAccrual`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def vacation_available_type=(vacation_available_type)
      ...
      unless validator.valid?(vacation_available_type)
        raise ArgumentError,
              "invalid value for \"vacation_available_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def sick_available_type=(sick_available_type)
      ...
      unless validator.valid?(sick_available_type)
        raise ArgumentError, "invalid value for \"sick_available_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def pto_available_type=(pto_available_type)
      ...
      unless validator.valid?(pto_available_type)
        raise ArgumentError, "invalid value for \"pto_available_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def holiday_available_type=(holiday_available_type)
      ...
      unless validator.valid?(holiday_available_type)
        raise ArgumentError,
              "invalid value for \"holiday_available_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, location, vacation_flag, vacation_available_type, vacation_carryover_allowed_flag, vacation_carryover_limit,
       sick_flag, sick_available_type, sick_carryover_allowed_flag, sick_carryover_limit, pto_flag, pto_available_type, pto_carryover_allowed_flag, pto_carryover_limit, holiday_flag, holiday_available_type, holiday_carryover_allowed_flag, holiday_carryover_limit, _info].hash
    end
