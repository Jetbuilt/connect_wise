  ...
  class WorkflowAction
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::WorkflowAction` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::WorkflowAction`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:grand_parent_connect_wise_id)
        self.grand_parent_connect_wise_id = attributes[:grand_parent_connect_wise_id]
      end
    ...
    def attach_configurations_for=(attach_configurations_for)
      ...
      unless validator.valid?(attach_configurations_for)
        raise ArgumentError,
              "invalid value for \"attach_configurations_for\", must be one of #{validator.allowable_values}."
      end
