...
module ConnectWise
  class AgreementRecurringParameters
    attr_accessor :billing_cycle, :cycle_base, :a_gr_amount, :taxable, :children_amount, :additions_amount,
                  :total_amount, :a_gr_prorate, :bill_start_date, :tax_code, :terms, :prorate_flag, :invoice_prorated_additions_flag, :restrict_downpayment, :currency, :auto_invoice_flag, :user_defined_field_values
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AgreementRecurringParameters` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AgreementRecurringParameters`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [billing_cycle, cycle_base, a_gr_amount, taxable, children_amount, additions_amount, total_amount, a_gr_prorate,
       bill_start_date, tax_code, terms, prorate_flag, invoice_prorated_additions_flag, restrict_downpayment, currency, auto_invoice_flag, user_defined_field_values].hash
    end
