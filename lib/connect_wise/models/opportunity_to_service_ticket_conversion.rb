...
module ConnectWise
  class OpportunityToServiceTicketConversion
    attr_accessor :ticket_id, :summary, :include_all_notes_flag, :include_all_documents_flag,
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::OpportunityToServiceTicketConversion` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::OpportunityToServiceTicketConversion`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [ticket_id, summary, include_all_notes_flag, include_all_documents_flag, include_all_products_flag,
