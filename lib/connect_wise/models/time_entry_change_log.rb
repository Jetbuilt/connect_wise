...
module ConnectWise
  class TimeEntryChangeLog
    ...
    attr_accessor :company, :member, :work_type, :work_role, :agreement, :invoice, :ticket, :project, :phase,
                  :activity, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TimeEntryChangeLog` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TimeEntryChangeLog`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:agreement_adjustment_firm)
        self.agreement_adjustment_firm = attributes[:agreement_adjustment_firm]
      end

      if attributes.key?(:agreement_adjustment_total)
        self.agreement_adjustment_total = attributes[:agreement_adjustment_total]
      end
      ...
      if attributes.key?(:invoice_adjustment_total)
        self.invoice_adjustment_total = attributes[:invoice_adjustment_total]
      end
