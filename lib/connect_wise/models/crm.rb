...
module ConnectWise
  class Crm
    attr_accessor :account_manager_role, :technical_contact_role, :sales_rep_role, :id, :company_list_count,
                  :lock_probability_flag, :company_id_generation_flag, :exclude_spaces_flag, :default_year, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::Crm` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Crm`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [account_manager_role, technical_contact_role, sales_rep_role, id, company_list_count, lock_probability_flag,
       company_id_generation_flag, exclude_spaces_flag, field1_caption, field2_caption, field3_caption, field4_caption, field5_caption, field6_caption, field7_caption, field8_caption, field9_caption, field10_caption, primary_rep_caption, secondary_rep_caption, other1_caption, other2_caption, default_year, _info].hash
    end
