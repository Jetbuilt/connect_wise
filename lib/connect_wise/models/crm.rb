...
module ConnectWise
  class Crm
    attr_accessor :id, :company_list_count, :lock_probability_flag, :account_manager_role, :technical_contact_role, :sales_rep_role, :company_id_generation_flag, :exclude_spaces_flag, :default_year, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Crm`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
