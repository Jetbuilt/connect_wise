...
module ConnectWise
  class MySecurity
    attr_accessor :id, :add_level, :edit_level, :delete_level, :inquire_level, :module_function_name,
                  :module_function_description, :my_all_flag, :module_function_identifier, :report_flag, :restrict_flag, :custom_flag, :module_description, :module_identifier, :module_name, :sort_order, :member, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::MySecurity` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::MySecurity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, add_level, edit_level, delete_level, inquire_level, module_function_name, module_function_description,
       my_all_flag, module_function_identifier, report_flag, restrict_flag, custom_flag, module_description, module_identifier, module_name, sort_order, member, _info].hash
    end
