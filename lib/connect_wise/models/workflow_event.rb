...
module ConnectWise
  class WorkflowEvent
    attr_accessor :event_condition, :id, :name, :date_tested_utc, :test_records_matched, :connect_wise_id,
                  :parent_connect_wise_id, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::WorkflowEvent` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::WorkflowEvent`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def frequency_unit=(frequency_unit)
      ...
      unless validator.valid?(frequency_unit)
        raise ArgumentError, "invalid value for \"frequency_unit\", must be one of #{validator.allowable_values}."
      end
    ...
    def execution_time=(execution_time)
      ...
      unless validator.valid?(execution_time)
        raise ArgumentError, "invalid value for \"execution_time\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [event_condition, id, name, frequency_unit, frequency_of_execution, max_number_of_execution, execution_time,
       date_tested_utc, test_records_matched, connect_wise_id, parent_id, parent_connect_wise_id, _info].hash
    end
