  ...
  class WorkflowEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::WorkflowEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::WorkflowEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'event_condition')
        self.event_condition = attributes[:'event_condition']
      end
      ...
      if attributes.key?(:'frequency_unit')
        self.frequency_unit = attributes[:'frequency_unit']
      end

      if attributes.key?(:'frequency_of_execution')
        self.frequency_of_execution = attributes[:'frequency_of_execution']
      end

      if attributes.key?(:'max_number_of_execution')
        self.max_number_of_execution = attributes[:'max_number_of_execution']
      end
    ...
    def hash
      [event_condition, id, name, frequency_unit, frequency_of_execution, max_number_of_execution, execution_time, _info].hash
    end
