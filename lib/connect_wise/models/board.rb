...
module ConnectWise
  class Board
    ...
    attr_accessor :percentage_calculation

    attr_accessor :all_sort

    attr_accessor :mark_first_note_issue_flag

    attr_accessor :restrict_board_by_default_flag
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::Board` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Board`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sign_off_template')
        self.sign_off_template = attributes[:'sign_off_template']
      end

      if attributes.key?(:'send_to_contact_flag')
        self.send_to_contact_flag = attributes[:'send_to_contact_flag']
      end

      if attributes.key?(:'contact_template')
        self.contact_template = attributes[:'contact_template']
      end

      if attributes.key?(:'send_to_resource_flag')
        self.send_to_resource_flag = attributes[:'send_to_resource_flag']
      end

      if attributes.key?(:'resource_template')
        self.resource_template = attributes[:'resource_template']
      end
      ...
      if attributes.key?(:'show_dependencies_flag')
        self.show_dependencies_flag = attributes[:'show_dependencies_flag']
      end

      if attributes.key?(:'show_estimates_flag')
        self.show_estimates_flag = attributes[:'show_estimates_flag']
      end

      if attributes.key?(:'board_icon')
        self.board_icon = attributes[:'board_icon']
      end
      ...
      if attributes.key?(:'service_manager_member')
        self.service_manager_member = attributes[:'service_manager_member']
      end

      if attributes.key?(:'duty_manager_member')
        self.duty_manager_member = attributes[:'duty_manager_member']
      end

      if attributes.key?(:'oncall_member')
        self.oncall_member = attributes[:'oncall_member']
      end
      ...
      if attributes.key?(:'bill_expense')
        self.bill_expense = attributes[:'bill_expense']
      end

      if attributes.key?(:'bill_product')
        self.bill_product = attributes[:'bill_product']
      end

      if attributes.key?(:'auto_close_status')
        self.auto_close_status = attributes[:'auto_close_status']
      end
      ...
      if attributes.key?(:'discussions_locked_flag')
        self.discussions_locked_flag = attributes[:'discussions_locked_flag']
      end

      if attributes.key?(:'time_entry_locked_flag')
        self.time_entry_locked_flag = attributes[:'time_entry_locked_flag']
      end

      if attributes.key?(:'notify_email_from')
        self.notify_email_from = attributes[:'notify_email_from']
      end

      if attributes.key?(:'notify_email_from_name')
        self.notify_email_from_name = attributes[:'notify_email_from_name']
      end
      ...
      if attributes.key?(:'send_to_cc_flag')
        self.send_to_cc_flag = attributes[:'send_to_cc_flag']
      end
      ...
      if attributes.key?(:'percentage_calculation')
        self.percentage_calculation = attributes[:'percentage_calculation']
      end
    ...
    def valid?
      ...
      percentage_calculation_validator = EnumAttributeValidator.new('String', ["ActualHours", "Manual", "ClosedPhases", "ClosedTickets"])
    ...
    def percentage_calculation=(percentage_calculation)
      validator = EnumAttributeValidator.new('String', ["ActualHours", "Manual", "ClosedPhases", "ClosedTickets"])
      unless validator.valid?(percentage_calculation)
        fail ArgumentError, "invalid value for \"percentage_calculation\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          email_connector_never_reopen_by_days_closed_flag == o.email_connector_never_reopen_by_days_closed_flag &&
          email_connector_reopen_days_closed_limit == o.email_connector_reopen_days_closed_limit &&
          ...
          percentage_calculation == o.percentage_calculation &&
          all_sort == o.all_sort &&
          mark_first_note_issue_flag == o.mark_first_note_issue_flag &&
          restrict_board_by_default_flag == o.restrict_board_by_default_flag &&
          _info == o._info
    end
