...
module ConnectWise
  class GLCaption
    attr_accessor :id, :segment1type, :segment2type, :segment3type, :segment4type, :segment5type, :segment6type,
                  :segment7type, :segment8type, :segment9type, :segment10type, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::GLCaption` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::GLCaption`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def segment1type=(segment1type)
      ...
      unless validator.valid?(segment1type)
        raise ArgumentError, "invalid value for \"segment1type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment2type=(segment2type)
      ...
      unless validator.valid?(segment2type)
        raise ArgumentError, "invalid value for \"segment2type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment3type=(segment3type)
      ...
      unless validator.valid?(segment3type)
        raise ArgumentError, "invalid value for \"segment3type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment4type=(segment4type)
      ...
      unless validator.valid?(segment4type)
        raise ArgumentError, "invalid value for \"segment4type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment5type=(segment5type)
      ...
      unless validator.valid?(segment5type)
        raise ArgumentError, "invalid value for \"segment5type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment6type=(segment6type)
      ...
      unless validator.valid?(segment6type)
        raise ArgumentError, "invalid value for \"segment6type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment7type=(segment7type)
      ...
      unless validator.valid?(segment7type)
        raise ArgumentError, "invalid value for \"segment7type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment8type=(segment8type)
      ...
      unless validator.valid?(segment8type)
        raise ArgumentError, "invalid value for \"segment8type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment9type=(segment9type)
      ...
      unless validator.valid?(segment9type)
        raise ArgumentError, "invalid value for \"segment9type\", must be one of #{validator.allowable_values}."
      end
    ...
    def segment10type=(segment10type)
      ...
      unless validator.valid?(segment10type)
        raise ArgumentError, "invalid value for \"segment10type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, segment1, segment2, segment3, segment4, segment5, segment6, segment7, segment8, segment9, segment10,
       segment1type, segment2type, segment3type, segment4type, segment5type, segment6type, segment7type, segment8type, segment9type, segment10type, cogs1, cogs2, cogs3, cogs4, cogs5, cogs6, cogs7, cogs8, cogs9, cogs10, _info].hash
    end
