...
module ConnectWise
  class TemplatePhase
    attr_accessor :parent_phase, :id, :template_id, :description, :notes, :mark_as_milestone_flag, :bill_phase_separately, :wbs_code, :_info
    ...
    def self.openapi_types
      {
        parent_phase: :ProjectTemplatePhaseReference,
        id: :Integer,
        template_id: :Integer,
        description: :String,
        notes: :String,
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::TemplatePhase` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TemplatePhase`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [parent_phase, id, template_id, description, notes, mark_as_milestone_flag, bill_phase_separately, wbs_code, _info].hash
    end
