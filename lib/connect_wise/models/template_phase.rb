...
module ConnectWise
  class TemplatePhase
    attr_accessor :parent_phase, :id, :template_id, :description, :notes, :mark_as_milestone_flag,
                  :bill_phase_separately, :wbs_code, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::TemplatePhase` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::TemplatePhase`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [parent_phase, id, template_id, description, notes, mark_as_milestone_flag, bill_phase_separately, wbs_code,
       _info].hash
    end
