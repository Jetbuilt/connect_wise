...
module ConnectWise
  class CorporateStructure
    attr_accessor :fiscal_year_start, :base_currency, :id, :level_count, :president, :chief_operating_officer,
                  :controller, :dispatcher, :service_manager, :duty_manager, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CorporateStructure` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CorporateStructure`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      fiscal_year_start_validator = EnumAttributeValidator.new('String',
    ...
    def fiscal_year_start=(fiscal_year_start)
      ...
      unless validator.valid?(fiscal_year_start)
        raise ArgumentError, "invalid value for \"fiscal_year_start\", must be one of #{validator.allowable_values}."
      end
    ...
    def level_count=(level_count)
      ...
      unless validator.valid?(level_count)
        raise ArgumentError, "invalid value for \"level_count\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [fiscal_year_start, location_caption, group_caption, base_currency, id, level_count, level1_name, level2_name,
       level3_name, level4_name, level5_name, president, chief_operating_officer, controller, dispatcher, service_manager, duty_manager, _info].hash
    end
