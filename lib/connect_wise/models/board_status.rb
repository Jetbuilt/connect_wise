...
module ConnectWise
  class BoardStatus
    ...
    attr_accessor :id, :board, :sort_order, :display_on_board, :inactive, :closed_status, :time_entry_not_allowed, :round_robin_catchall, :default_flag, :escalation_status, :customer_portal_flag, :email_template, :status_indicator, :_info, :save_time_as_note
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BoardStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, id, board, sort_order, display_on_board, inactive, closed_status, time_entry_not_allowed, round_robin_catchall, default_flag, escalation_status, customer_portal_description, customer_portal_flag, email_template, status_indicator, custom_status_indicator_name, _info, save_time_as_note].hash
    end
