  ...
  class ProductType
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProductType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def type_xref=(type_xref)
      ...
      raise ArgumentError, "invalid value for \"type_xref\", must be one of #{validator.allowable_values}." unless validator.valid?(type_xref)
