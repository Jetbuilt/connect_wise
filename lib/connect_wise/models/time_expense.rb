...
module ConnectWise
  class TimeExpense
    attr_accessor :id, :tier1_approval_flag, :tier2_approval_flag, :disable_time_entry_flag, :require_time_note_flag, :require_expense_note_flag, :rounding_factor, :invoice_start, :default_special_invoice_type, :internal_company, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TimeExpense`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
