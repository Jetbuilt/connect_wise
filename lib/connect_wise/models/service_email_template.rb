...
module ConnectWise
  class ServiceEmailTemplate
    attr_accessor :type, :id, :service_survey, :service_board, :use_sender_flag, :body, :copy_sender_flag, :tasks_flag,
                  :resource_records_flag, :external_contact_notifications, :internal_contact_notifications, :service_status, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ServiceEmailTemplate` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ServiceEmailTemplate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String',
                                                  %w[Any Closed Invoice New SalesOrder PurchaseOrder RMA Specific])
    ...
    def hash
      [type, id, service_survey, service_board, use_sender_flag, first_name, last_name, email_address, subject, body,
       copy_sender_flag, tasks_flag, resource_records_flag, external_contact_notifications, internal_contact_notifications, service_status, _info].hash
    end
