...
module ConnectWise
  class Addition
    attr_accessor :bill_customer, :id, :product, :quantity, :less_included, :unit_price, :unit_cost, :effective_date, :cancelled_date, :taxable_flag, :purchase_item_flag, :special_order_flag, :agreement_id, :description, :billed_quantity, :uom, :ext_price, :ext_cost, :sequence_number, :margin, :prorate_cost, :prorate_price, :extended_prorate_cost, :extended_prorate_price, :prorate_current_period_flag, :opportunity, :agreement_status, :invoice_grouping, :_info, :custom_fields
