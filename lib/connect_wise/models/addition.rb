...
module ConnectWise
  class Addition
    attr_accessor :product, :bill_customer, :id, :quantity, :less_included, :unit_price, :unit_cost, :effective_date,
                  :cancelled_date, :taxable_flag, :purchase_item_flag, :special_order_flag, :agreement_id, :description, :billed_quantity, :uom, :ext_price, :ext_cost, :sequence_number, :margin, :prorate_cost, :prorate_price, :extended_prorate_cost, :extended_prorate_price, :prorate_current_period_flag, :opportunity, :agreement_status, :invoice_grouping, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Addition` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Addition`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def bill_customer=(bill_customer)
      ...
      unless validator.valid?(bill_customer)
        raise ArgumentError, "invalid value for \"bill_customer\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [product, bill_customer, id, quantity, less_included, unit_price, unit_cost, effective_date, cancelled_date,
       taxable_flag, serial_number, invoice_description, purchase_item_flag, special_order_flag, agreement_id, description, billed_quantity, uom, ext_price, ext_cost, sequence_number, margin, prorate_cost, prorate_price, extended_prorate_cost, extended_prorate_price, prorate_current_period_flag, opportunity, agreement_status, invoice_grouping, _info, custom_fields].hash
    end
