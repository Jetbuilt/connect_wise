...
module ConnectWise
  class EmailConnectorParsingRule
    attr_accessor :priority, :id, :parsing_style, :parsing_variable, :service_priority, :service_status, :service_type, :service_sub_type, :service_item, :service_board, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::EmailConnectorParsingRule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
