...
module ConnectWise
  class EmailConnectorParsingRule
    attr_accessor :priority, :parsing_variable, :id, :parsing_style, :service_priority, :service_status, :service_type,
                  :service_sub_type, :service_item, :service_board, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::EmailConnectorParsingRule` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::EmailConnectorParsingRule`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [priority, parsing_variable, search_term, id, parsing_style, service_priority, service_status, service_type,
       service_sub_type, service_item, service_board, _info].hash
    end
