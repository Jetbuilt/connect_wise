...
module ConnectWise
  class TicketStopwatch
    attr_accessor :status, :_info, :agreement, :billable_option, :business_unit_id, :date_entered, :end_time, :id, :internal_notes, :location_id, :member, :mobile_guid, :service_status, :start_time, :ticket, :ticket_mobile_guid, :total_pause_time, :work_role, :work_type, :show_notes_in_discussion_flag, :show_notes_in_internal_flag, :show_notes_in_resolution_flag, :email_notes_to_contact_flag, :email_notes_to_resources_flag
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TicketStopwatch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [status, _info, agreement, billable_option, business_unit_id, date_entered, end_time, id, internal_notes, location_id, member, mobile_guid, notes, service_status, start_time, ticket, ticket_mobile_guid, total_pause_time, work_role, work_type, show_notes_in_discussion_flag, show_notes_in_internal_flag, show_notes_in_resolution_flag, email_notes_to_contact_flag, email_notes_to_resources_flag].hash
    end
