...
module ConnectWise
  class UserDefinedField
    ...
    attr_accessor :field_type_identifier, :entry_type_identifier, :required_flag, :display_on_screen_flag,
                  :read_only_flag, :options, :business_unit_ids, :location_ids, :add_all_business_units, :remove_all_business_units, :add_all_locations, :remove_all_locations, :connect_wise_id, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::UserDefinedField` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::UserDefinedField`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [pod_id, caption, sequence_number, field_type_identifier, id, screen_id, help_text, number_decimals,
       entry_type_identifier, required_flag, display_on_screen_flag, read_only_flag, list_view_flag, button_url, options, business_unit_ids, location_ids, add_all_business_units, remove_all_business_units, add_all_locations, remove_all_locations, connect_wise_id, date_created, _info].hash
    end
