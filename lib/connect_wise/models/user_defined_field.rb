...
module ConnectWise
  class UserDefinedField
    ...
    attr_accessor :field_type_identifier, :entry_type_identifier, :required_flag, :display_on_screen_flag, :read_only_flag, :options, :business_unit_ids, :location_ids, :add_all_business_units, :remove_all_business_units, :add_all_locations, :remove_all_locations, :_info
