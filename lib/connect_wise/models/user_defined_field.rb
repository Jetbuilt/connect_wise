...
module ConnectWise
  class UserDefinedField
    ...
    attr_accessor :field_type_identifier, :entry_type_identifier, :required_flag, :display_on_screen_flag, :read_only_flag, :options, :business_unit_ids, :location_ids, :add_all_business_units, :remove_all_business_units, :add_all_locations, :remove_all_locations, :connect_wise_id, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::UserDefinedField`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def valid?
      ...
      field_type_identifier_validator = EnumAttributeValidator.new('String', %w[TextArea Button Currency Date Hyperlink IPAddress Checkbox Number Percent PhoneNumber Text Password])
    ...
    def field_type_identifier=(field_type_identifier)
      validator = EnumAttributeValidator.new('String', %w[TextArea Button Currency Date Hyperlink IPAddress Checkbox Number Percent PhoneNumber Text Password])
      raise ArgumentError, "invalid value for \"field_type_identifier\", must be one of #{validator.allowable_values}." unless validator.valid?(field_type_identifier)
    ...
    def entry_type_identifier=(entry_type_identifier)
      ...
      raise ArgumentError, "invalid value for \"entry_type_identifier\", must be one of #{validator.allowable_values}." unless validator.valid?(entry_type_identifier)
