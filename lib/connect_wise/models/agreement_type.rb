  ...
  class AgreementType
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AgreementType` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AgreementType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      self.employee_comp_not_exceed = if attributes.key?(:employee_comp_not_exceed)
                                        attributes[:employee_comp_not_exceed]
                                      end
      ...
      if attributes.key?(:invoice_prorated_additions_flag)
        self.invoice_prorated_additions_flag = attributes[:invoice_prorated_additions_flag]
      end
    ...
    def valid?
      ...
      application_cycle_validator = EnumAttributeValidator.new('String',
                                                               %w[Contract2Weeks Contract4Weeks ContractYear CalendarMonth CalendarQuarter CalendarWeek
    ...
    def employee_comp_rate=(employee_comp_rate)
      ...
      unless validator.valid?(employee_comp_rate)
        raise ArgumentError, "invalid value for \"employee_comp_rate\", must be one of #{validator.allowable_values}."
      end
    ...
    def employee_comp_not_exceed=(employee_comp_not_exceed)
      ...
      unless validator.valid?(employee_comp_not_exceed)
        raise ArgumentError,
              "invalid value for \"employee_comp_not_exceed\", must be one of #{validator.allowable_values}."
      end
    ...
    def invoicing_cycle=(invoicing_cycle)
      ...
      unless validator.valid?(invoicing_cycle)
        raise ArgumentError, "invalid value for \"invoicing_cycle\", must be one of #{validator.allowable_values}."
      end
    ...
    def prefix_suffix_option=(prefix_suffix_option)
      ...
      unless validator.valid?(prefix_suffix_option)
        raise ArgumentError, "invalid value for \"prefix_suffix_option\", must be one of #{validator.allowable_values}."
      end
    ...
    def application_units=(application_units)
      ...
      unless validator.valid?(application_units)
        raise ArgumentError, "invalid value for \"application_units\", must be one of #{validator.allowable_values}."
      end
    ...
    def application_cycle=(application_cycle)
      ...
      unless validator.valid?(application_cycle)
        raise ArgumentError, "invalid value for \"application_cycle\", must be one of #{validator.allowable_values}."
      end
