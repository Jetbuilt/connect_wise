...
module ConnectWise
  class MyAccount
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::MyAccount` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::MyAccount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.company_activity_tab_format = (attributes[:company_activity_tab_format] if attributes.key?(:company_activity_tab_format))

      self.invoice_time_tab_format = (attributes[:invoice_time_tab_format] if attributes.key?(:invoice_time_tab_format))

      self.invoice_screen_default_tab_format = (attributes[:invoice_screen_default_tab_format] if attributes.key?(:invoice_screen_default_tab_format))

      self.invoicing_display_options = (attributes[:invoicing_display_options] if attributes.key?(:invoicing_display_options))

      self.agreement_invoicing_display_options = (attributes[:agreement_invoicing_display_options] if attributes.key?(:agreement_invoicing_display_options))
      ...
      self.include_in_utilization_reporting_flag = attributes[:include_in_utilization_reporting_flag] if attributes.key?(:include_in_utilization_reporting_flag)
      ...
      self.allow_in_cell_entry_on_time_sheet = attributes[:allow_in_cell_entry_on_time_sheet] if attributes.key?(:allow_in_cell_entry_on_time_sheet)
      ...
      self.time_reminder_email_flag = attributes[:time_reminder_email_flag] if attributes.key?(:time_reminder_email_flag)
      ...
      self.hide_member_in_dispatch_portal_flag = attributes[:hide_member_in_dispatch_portal_flag] if attributes.key?(:hide_member_in_dispatch_portal_flag)
      ...
      self.calendar_sync_integration_flag = attributes[:calendar_sync_integration_flag] if attributes.key?(:calendar_sync_integration_flag)

      self.authentication_service_type = attributes[:authentication_service_type] if attributes.key?(:authentication_service_type)

      self.timebased_one_time_password_activated = attributes[:timebased_one_time_password_activated] if attributes.key?(:timebased_one_time_password_activated)
      ...
      self.auto_popup_quick_notes_with_stopwatch = attributes[:auto_popup_quick_notes_with_stopwatch] if attributes.key?(:auto_popup_quick_notes_with_stopwatch)

      self.signature = attributes[:signature] if attributes.key?(:signature)

      self.global_search_default_ticket_filter = attributes[:global_search_default_ticket_filter] if attributes.key?(:global_search_default_ticket_filter)

      self.global_search_default_sort = attributes[:global_search_default_sort] if attributes.key?(:global_search_default_sort)
      ...
      self.copy_shared_default_views = attributes[:copy_shared_default_views] if attributes.key?(:copy_shared_default_views)

      self.copy_column_layouts_and_filters = attributes[:copy_column_layouts_and_filters] if attributes.key?(:copy_column_layouts_and_filters)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "default_location", default_location cannot be nil.') if @default_location.nil?

      invalid_properties.push('invalid value for "default_department", default_department cannot be nil.') if @default_department.nil?
      ...
      invalid_properties.push('invalid value for "expense_approver", expense_approver cannot be nil.') if @expense_approver.nil?

      invalid_properties.push('invalid value for "hire_date", hire_date cannot be nil.') if @hire_date.nil?

      invalid_properties.push('invalid value for "sales_default_location", sales_default_location cannot be nil.') if @sales_default_location.nil?
    ...
    def valid?
      ...
      invoice_screen_default_tab_format_validator = EnumAttributeValidator.new('String', %w[ShowInvoicingTab ShowAgreementInvoicingTab])
      return false unless invoice_screen_default_tab_format_validator.valid?(@invoice_screen_default_tab_format)

      invoicing_display_options_validator = EnumAttributeValidator.new('String', %w[RemainOnInvoicingScreen ShowRecentInvoices])
      return false unless invoicing_display_options_validator.valid?(@invoicing_display_options)

      agreement_invoicing_display_options_validator = EnumAttributeValidator.new('String', %w[RemainOnInvoicingScreen ShowRecentInvoices])
      return false unless agreement_invoicing_display_options_validator.valid?(@agreement_invoicing_display_options)

      authentication_service_type_validator = EnumAttributeValidator.new('String', %w[AuthAnvil GoogleAuthenticator Email])
      return false unless authentication_service_type_validator.valid?(@authentication_service_type)

      global_search_default_ticket_filter_validator = EnumAttributeValidator.new('String', %w[OpenRecords ClosedRecords AllRecords])
      return false unless global_search_default_ticket_filter_validator.valid?(@global_search_default_ticket_filter)

      global_search_default_sort_validator = EnumAttributeValidator.new('String', %w[None LastUpdatedDesc LastUpdatedAsc CreatedDesc CreatedAsc])
      return false unless global_search_default_sort_validator.valid?(@global_search_default_sort)

      phone_integration_type_validator = EnumAttributeValidator.new('String', %w[TAPI SKYPE TEL CALLTO NONE])
    ...
    def default_email=(default_email)
      ...
      raise ArgumentError, "invalid value for \"default_email\", must be one of #{validator.allowable_values}." unless validator.valid?(default_email)
    ...
    def default_phone=(default_phone)
      validator = EnumAttributeValidator.new('String', %w[Office Mobile Home])
      raise ArgumentError, "invalid value for \"default_phone\", must be one of #{validator.allowable_values}." unless validator.valid?(default_phone)
    ...
    def company_activity_tab_format=(company_activity_tab_format)
      ...
      raise ArgumentError, "invalid value for \"company_activity_tab_format\", must be one of #{validator.allowable_values}." unless validator.valid?(company_activity_tab_format)
    ...
    def invoice_time_tab_format=(invoice_time_tab_format)
      validator = EnumAttributeValidator.new('String', %w[SummaryList DetailList])
      raise ArgumentError, "invalid value for \"invoice_time_tab_format\", must be one of #{validator.allowable_values}." unless validator.valid?(invoice_time_tab_format)
    ...
    def invoice_screen_default_tab_format=(invoice_screen_default_tab_format)
      ...
      raise ArgumentError, "invalid value for \"invoice_screen_default_tab_format\", must be one of #{validator.allowable_values}." unless validator.valid?(invoice_screen_default_tab_format)
    ...
    def invoicing_display_options=(invoicing_display_options)
      ...
      raise ArgumentError, "invalid value for \"invoicing_display_options\", must be one of #{validator.allowable_values}." unless validator.valid?(invoicing_display_options)
    ...
    def agreement_invoicing_display_options=(agreement_invoicing_display_options)
      validator = EnumAttributeValidator.new('String', %w[RemainOnInvoicingScreen ShowRecentInvoices])
      raise ArgumentError, "invalid value for \"agreement_invoicing_display_options\", must be one of #{validator.allowable_values}." unless validator.valid?(agreement_invoicing_display_options)
    ...
    def authentication_service_type=(authentication_service_type)
      ...
      raise ArgumentError, "invalid value for \"authentication_service_type\", must be one of #{validator.allowable_values}." unless validator.valid?(authentication_service_type)
    ...
    def global_search_default_ticket_filter=(global_search_default_ticket_filter)
      ...
      raise ArgumentError, "invalid value for \"global_search_default_ticket_filter\", must be one of #{validator.allowable_values}." unless validator.valid?(global_search_default_ticket_filter)
    ...
    def global_search_default_sort=(global_search_default_sort)
      validator = EnumAttributeValidator.new('String', %w[None LastUpdatedDesc LastUpdatedAsc CreatedDesc CreatedAsc])
      raise ArgumentError, "invalid value for \"global_search_default_sort\", must be one of #{validator.allowable_values}." unless validator.valid?(global_search_default_sort)
    ...
    def phone_integration_type=(phone_integration_type)
      ...
      raise ArgumentError, "invalid value for \"phone_integration_type\", must be one of #{validator.allowable_values}." unless validator.valid?(phone_integration_type)
