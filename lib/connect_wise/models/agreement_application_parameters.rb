...
module ConnectWise
  class AgreementApplicationParameters
    attr_accessor :application_unit, :application_limit, :application_limit_amount, :available_per, :covers_time_flag, :covers_expenses_flag, :covers_products_flag, :covers_tax_flag, :carryover_unused_flag, :carry_over_days, :allow_overruns_flag, :overrun_limit, :agreement_expires_flag, :charge_adjustments_flag, :prepay_flag, :agr_billing_cycle, :user_defined_field_values
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::AgreementApplicationParameters` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AgreementApplicationParameters`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.application_limit_amount = attributes[:application_limit_amount] if attributes.key?(:application_limit_amount)
    ...
    def hash
      [application_unit, application_limit, application_limit_amount, available_per, covers_time_flag, covers_expenses_flag, covers_products_flag, covers_tax_flag, carryover_unused_flag, carry_over_days, allow_overruns_flag, overrun_limit, agreement_expires_flag, charge_adjustments_flag, prepay_flag, agr_billing_cycle, user_defined_field_values].hash
    end
