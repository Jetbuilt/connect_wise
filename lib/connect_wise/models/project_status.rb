...
module ConnectWise
  class ProjectStatus
    ...
    attr_accessor :id, :default_flag, :inactive_flag, :no_time_flag, :closed_flag, :status_indicator, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::ProjectStatus` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProjectStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.no_time_flag = attributes[:no_time_flag] if attributes.key?(:no_time_flag)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        no_time_flag == other.no_time_flag &&
    ...
    def hash
      [name, id, default_flag, inactive_flag, no_time_flag, closed_flag, status_indicator, custom_status_indicator_name, _info].hash
    end
