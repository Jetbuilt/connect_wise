...
module ConnectWise
  class Other
    ...
    attr_accessor :id, :default_ldap, :contact_sync, :server_time_zone, :default_calendar, :default_address_format, :use_ssl_flag, :sync_leads_flag, :include_portal_link_flag, :use_expanded_format_time_flag, :use_expanded_format_activity_flag, :disable_z_admin_login_flag, :locale, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Other`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
