...
module ConnectWise
  class Other
    ...
    attr_accessor :server_time_zone, :default_calendar, :default_address_format, :locale, :id, :default_ldap,
                  :contact_sync, :use_ssl_flag, :sync_leads_flag, :include_portal_link_flag, :use_expanded_format_time_flag, :use_expanded_format_activity_flag, :disable_z_admin_login_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::Other` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Other`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def contact_sync=(contact_sync)
      ...
      unless validator.valid?(contact_sync)
        raise ArgumentError, "invalid value for \"contact_sync\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [default_from_address, portal_url_override, site_url, server_time_zone, default_calendar, default_address_format,
       locale, id, default_ldap, logo_path, contact_sync, use_ssl_flag, sync_leads_flag, include_portal_link_flag, use_expanded_format_time_flag, use_expanded_format_activity_flag, disable_z_admin_login_flag, update_member_time_zones_flag, _info].hash
    end
