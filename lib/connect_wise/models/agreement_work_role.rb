...
module ConnectWise
  class AgreementWorkRole
    attr_accessor :rate_type, :id, :work_role, :location_id, :location, :rate, :limit_to, :effective_date,
                  :ending_date, :agreement_id, :agreement, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AgreementWorkRole` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AgreementWorkRole`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [rate_type, id, work_role, location_id, location, rate, limit_to, effective_date, ending_date, agreement_id,
       agreement, _info].hash
    end
