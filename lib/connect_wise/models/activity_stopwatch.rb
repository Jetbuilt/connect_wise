...
module ConnectWise
  class ActivityStopwatch
    attr_accessor :activity_id, :member, :status, :activity_mobile_guid, :agreement, :billable_option,
                  :business_unit_id, :date_entered, :end_time, :id, :internal_notes, :location_id, :mobile_guid, :start_time, :total_pause_time, :work_role, :work_type, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ActivityStopwatch` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ActivityStopwatch`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [activity_id, member, status, activity_mobile_guid, agreement, billable_option, business_unit_id, date_entered,
       end_time, id, internal_notes, location_id, mobile_guid, notes, start_time, total_pause_time, work_role, work_type, _info].hash
    end
