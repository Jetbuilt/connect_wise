...
module ConnectWise
  class ActivityStopwatch
    attr_accessor :activity_id, :status, :_info, :activity_mobile_guid, :agreement, :billable_option, :business_unit_id, :date_entered, :end_time, :id, :internal_notes, :location_id, :member, :mobile_guid, :start_time, :total_pause_time, :work_role, :work_type
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ActivityStopwatch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
