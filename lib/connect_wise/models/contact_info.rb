...
module ConnectWise
  class ContactInfo
    attr_accessor :id, :first_name, :last_name, :communication_items, :default_phone_nbr, :default_phone_type, :default_flag, :company, :company_location, :site, :inactive_flag, :title, :types, :address_line1, :address_line2, :city, :state, :country, :zip, :department, :default_billing_flag, :facebook_url, :twitter_url, :linked_in_url, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::ContactInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ContactInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, first_name, last_name, communication_items, default_phone_nbr, default_phone_type, default_flag, company, company_location, site, inactive_flag, title, types, address_line1, address_line2, city, state, country, zip, department, default_billing_flag, facebook_url, twitter_url, linked_in_url, _info].hash
    end
