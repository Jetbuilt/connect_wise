...
module ConnectWise
  class PortalConfigurationProjectSetup
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::PortalConfigurationProjectSetup` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::PortalConfigurationProjectSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.time_material_budget_hrs_flag = attributes[:time_material_budget_hrs_flag] if attributes.key?(:time_material_budget_hrs_flag)

      self.time_material_scheduled_start_flag = attributes[:time_material_scheduled_start_flag] if attributes.key?(:time_material_scheduled_start_flag)

      self.time_material_scheduled_finish_flag = attributes[:time_material_scheduled_finish_flag] if attributes.key?(:time_material_scheduled_finish_flag)

      self.time_material_scheduled_hrs_flag = attributes[:time_material_scheduled_hrs_flag] if attributes.key?(:time_material_scheduled_hrs_flag)

      self.time_material_actual_start_flag = attributes[:time_material_actual_start_flag] if attributes.key?(:time_material_actual_start_flag)

      self.time_material_actual_finish_flag = attributes[:time_material_actual_finish_flag] if attributes.key?(:time_material_actual_finish_flag)

      self.time_material_actual_hrs_flag = attributes[:time_material_actual_hrs_flag] if attributes.key?(:time_material_actual_hrs_flag)

      self.time_material_bill_flag = attributes[:time_material_bill_flag] if attributes.key?(:time_material_bill_flag)

      self.time_material_status_flag = attributes[:time_material_status_flag] if attributes.key?(:time_material_status_flag)

      self.time_material_assigned_flag = attributes[:time_material_assigned_flag] if attributes.key?(:time_material_assigned_flag)

      self.fixed_fee_budget_hrs_flag = attributes[:fixed_fee_budget_hrs_flag] if attributes.key?(:fixed_fee_budget_hrs_flag)

      self.fixed_fee_scheduled_start_flag = attributes[:fixed_fee_scheduled_start_flag] if attributes.key?(:fixed_fee_scheduled_start_flag)

      self.fixed_fee_scheduled_finish_flag = attributes[:fixed_fee_scheduled_finish_flag] if attributes.key?(:fixed_fee_scheduled_finish_flag)

      self.fixed_fee_scheduled_hrs_flag = attributes[:fixed_fee_scheduled_hrs_flag] if attributes.key?(:fixed_fee_scheduled_hrs_flag)

      self.fixed_fee_actual_start_flag = attributes[:fixed_fee_actual_start_flag] if attributes.key?(:fixed_fee_actual_start_flag)

      self.fixed_fee_actual_finish_flag = attributes[:fixed_fee_actual_finish_flag] if attributes.key?(:fixed_fee_actual_finish_flag)

      self.fixed_fee_actual_hrs_flag = attributes[:fixed_fee_actual_hrs_flag] if attributes.key?(:fixed_fee_actual_hrs_flag)
      ...
      self.project_issue_budget_hrs_flag = attributes[:project_issue_budget_hrs_flag] if attributes.key?(:project_issue_budget_hrs_flag)

      self.project_issue_scheduled_start_flag = attributes[:project_issue_scheduled_start_flag] if attributes.key?(:project_issue_scheduled_start_flag)

      self.project_issue_scheduled_finish_flag = attributes[:project_issue_scheduled_finish_flag] if attributes.key?(:project_issue_scheduled_finish_flag)

      self.project_issue_scheduled_hrs_flag = attributes[:project_issue_scheduled_hrs_flag] if attributes.key?(:project_issue_scheduled_hrs_flag)

      self.project_issue_actual_start_flag = attributes[:project_issue_actual_start_flag] if attributes.key?(:project_issue_actual_start_flag)

      self.project_issue_actual_finish_flag = attributes[:project_issue_actual_finish_flag] if attributes.key?(:project_issue_actual_finish_flag)

      self.project_issue_actual_hrs_flag = attributes[:project_issue_actual_hrs_flag] if attributes.key?(:project_issue_actual_hrs_flag)

      self.project_issue_bill_flag = attributes[:project_issue_bill_flag] if attributes.key?(:project_issue_bill_flag)

      self.project_issue_status_flag = attributes[:project_issue_status_flag] if attributes.key?(:project_issue_status_flag)

      self.project_issue_assigned_flag = attributes[:project_issue_assigned_flag] if attributes.key?(:project_issue_assigned_flag)

      self.project_detail_total_hours_flag = attributes[:project_detail_total_hours_flag] if attributes.key?(:project_detail_total_hours_flag)
    ...
    def valid?
      ...
      only_display_validator = EnumAttributeValidator.new('String', %w[DoNotDisplay Closed30Days Closed60Days Closed90Days Closed120Days AllClosed])
    ...
    def only_display=(only_display)
      ...
      raise ArgumentError, "invalid value for \"only_display\", must be one of #{validator.allowable_values}." unless validator.valid?(only_display)
