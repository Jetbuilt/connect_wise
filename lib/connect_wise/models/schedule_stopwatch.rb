...
module ConnectWise
  class ScheduleStopwatch
    attr_accessor :member, :schedule_id, :status, :_info, :agreement, :billable_option, :business_unit_id,
                  :date_entered, :end_time, :id, :internal_notes, :location_id, :mobile_guid, :schedule_mobile_guid, :start_time, :total_pause_time, :work_role, :work_type
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ScheduleStopwatch` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ScheduleStopwatch`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [member, schedule_id, status, _info, agreement, billable_option, business_unit_id, date_entered, end_time, id,
       internal_notes, location_id, mobile_guid, notes, schedule_mobile_guid, start_time, total_pause_time, work_role, work_type].hash
    end
