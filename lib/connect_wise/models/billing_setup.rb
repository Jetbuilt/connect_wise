  ...
  class BillingSetup
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::BillingSetup` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::BillingSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def prefix_suffix_flag=(prefix_suffix_flag)
      ...
      unless validator.valid?(prefix_suffix_flag)
        raise ArgumentError, "invalid value for \"prefix_suffix_flag\", must be one of #{validator.allowable_values}."
      end
