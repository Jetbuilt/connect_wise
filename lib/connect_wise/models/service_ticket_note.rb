...
module ConnectWise
  class ServiceTicketNote
    ...
    attr_accessor :is_markdown_flag
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::ServiceTicketNote` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ServiceTicketNote`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_markdown_flag')
        self.is_markdown_flag = attributes[:'is_markdown_flag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ticket == o.ticket &&
          text == o.text &&
          is_markdown_flag == o.is_markdown_flag &&
