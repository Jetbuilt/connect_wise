...
module ConnectWise
  class ServiceTicketNote
    attr_accessor :id, :note_type, :ticket, :text, :is_markdown_flag, :detail_description_flag,
                  :internal_analysis_flag, :resolution_flag, :time_start, :time_end, :bundled_flag, :merged_flag, :issue_flag, :original_author, :created_by_parent_flag, :member, :contact, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ServiceTicketNote` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ServiceTicketNote`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, note_type, ticket, text, is_markdown_flag, detail_description_flag, internal_analysis_flag, resolution_flag,
       time_start, time_end, bundled_flag, merged_flag, issue_flag, original_author, created_by_parent_flag, member, contact, _info].hash
    end
