...
module ConnectWise
  class ServiceTicketNote
    attr_accessor :id, :note_type, :ticket, :text, :is_markdown_flag, :detail_description_flag, :internal_analysis_flag, :resolution_flag, :time_start, :time_end, :bundled_flag, :merged_flag, :issue_flag, :original_author, :member, :contact, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ServiceTicketNote`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, note_type, ticket, text, is_markdown_flag, detail_description_flag, internal_analysis_flag, resolution_flag, time_start, time_end, bundled_flag, merged_flag, issue_flag, original_author, member, contact, _info].hash
    end
