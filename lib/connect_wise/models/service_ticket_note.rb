...
module ConnectWise
  class ServiceTicketNote
    attr_accessor :id, :note_type, :ticket, :text, :is_markdown_flag, :detail_description_flag, :internal_analysis_flag, :resolution_flag, :time_start, :time_end, :bundled_flag, :merged_flag, :issue_flag, :original_author, :created_by_parent_flag, :member, :contact, :_info
    ...
    def self.attribute_map
      {
        ...
        ticket: :ticket,
        text: :text,
        is_markdown_flag: :isMarkdownFlag,
        ...
        created_by_parent_flag: :createdByParentFlag,
        member: :member,
        contact: :contact,
        _info: :_info
      }
    ...
    def self.openapi_types
      {
        ...
        created_by_parent_flag: :Boolean,
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::ServiceTicketNote` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ServiceTicketNote`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.is_markdown_flag = attributes[:is_markdown_flag] if attributes.key?(:is_markdown_flag)
      ...
      self.created_by_parent_flag = attributes[:created_by_parent_flag] if attributes.key?(:created_by_parent_flag)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ticket == other.ticket &&
        text == other.text &&
        is_markdown_flag == other.is_markdown_flag &&
        ...
        created_by_parent_flag == other.created_by_parent_flag &&
        member == other.member &&
    ...
    def hash
      [id, note_type, ticket, text, is_markdown_flag, detail_description_flag, internal_analysis_flag, resolution_flag, time_start, time_end, bundled_flag, merged_flag, issue_flag, original_author, created_by_parent_flag, member, contact, _info].hash
    end
