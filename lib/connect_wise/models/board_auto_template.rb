...
module ConnectWise
  class BoardAutoTemplate
    attr_accessor :type, :subtype, :item, :service_template, :id, :board, :summary_setting, :discussion_setting, :internal_analysis_setting, :resolution_setting, :tasks_setting, :documents_setting, :resources_setting, :budget_hours_setting, :finance_information_setting, :send_notes_as_email_setting, :impact_urgency_setting, :template_priority_setting, :auto_apply_flag, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BoardAutoTemplate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.template_priority_setting = attributes[:template_priority_setting] if attributes.key?(:template_priority_setting)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "service_template", service_template cannot be nil.') if @service_template.nil?
    ...
    def impact_urgency_setting=(impact_urgency_setting)
      validator = EnumAttributeValidator.new('String', %w[Append Overwrite Ignore])
      raise ArgumentError, "invalid value for \"impact_urgency_setting\", must be one of #{validator.allowable_values}." unless validator.valid?(impact_urgency_setting)
    ...
    def template_priority_setting=(template_priority_setting)
      validator = EnumAttributeValidator.new('String', %w[Append Overwrite Ignore])
      raise ArgumentError, "invalid value for \"template_priority_setting\", must be one of #{validator.allowable_values}." unless validator.valid?(template_priority_setting)
    ...
    def hash
      [type, subtype, item, service_template, id, board, summary_setting, discussion_setting, internal_analysis_setting, resolution_setting, tasks_setting, documents_setting, resources_setting, budget_hours_setting, finance_information_setting, send_notes_as_email_setting, impact_urgency_setting, template_priority_setting, auto_apply_flag, _info].hash
    end
