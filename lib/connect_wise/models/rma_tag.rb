...
module ConnectWise
  class RmaTag
    attr_accessor :product, :status, :location, :department, :returned_company, :rma_disposition, :id, :service_ticket,
                  :sales_order, :invoice, :project, :iv_description, :serial_number, :list_price, :unit_price, :returned_contact, :returned_contact_type, :returned_contact_phone, :returned_contact_extension, :returned_contact_email, :returned_contact_country, :returned_site, :purchased_company, :purchased_contact, :purchased_contact_type, :purchased_contact_phone, :purchased_contact_extension, :purchased_contact_email, :purchased_contact_country, :purchased_invoice_date, :purchased_vendor_action, :purchased_site, :warranty_company, :warranty_contact, :warranty_contact_type, :warranty_contact_phone, :warranty_contact_email, :warranty_contact_extension, :warranty_contact_country, :warranty_site, :repair_company, :repair_contact, :repair_contact_type, :repair_contact_phone, :repair_contact_extension, :repair_contact_email, :repair_contact_country, :repair_site, :drop_ship_flag, :ship_method, :shipping_date, :date_closed, :account_manager, :technical_contact, :currency, :closed_by, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::RmaTag` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::RmaTag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def list_invalid_properties
      ...
      if @returned_company.nil?
        invalid_properties.push('invalid value for "returned_company", returned_company cannot be nil.')
      end

      if @rma_disposition.nil?
        invalid_properties.push('invalid value for "rma_disposition", rma_disposition cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @returned_company.nil?
      return false if @rma_disposition.nil?
    ...
    def product_description=(product_description)
      raise ArgumentError, 'product_description cannot be nil' if product_description.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] returned_company Value to be assigned
    def returned_company=(returned_company)
      raise ArgumentError, 'returned_company cannot be nil' if returned_company.nil?

      @returned_company = returned_company
    end

    # Custom attribute writer method with validation
    # @param [Object] rma_disposition Value to be assigned
    def rma_disposition=(rma_disposition)
      raise ArgumentError, 'rma_disposition cannot be nil' if rma_disposition.nil?

      @rma_disposition = rma_disposition
    end
