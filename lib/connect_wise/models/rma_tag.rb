  ...
  class RmaTag
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::RmaTag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "returned_company", returned_company cannot be nil.') if @returned_company.nil?

      invalid_properties.push('invalid value for "rma_disposition", rma_disposition cannot be nil.') if @rma_disposition.nil?
