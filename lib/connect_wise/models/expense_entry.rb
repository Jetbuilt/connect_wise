...
module ConnectWise
  class ExpenseEntry
    attr_accessor :amount, :date, :id, :expense_report, :company, :charge_to_id, :type, :member, :payment_method, :classification, :billable_option, :location_id, :business_unit_id, :notes, :agreement, :invoice_amount, :mobile_guid, :taxes, :invoice, :currency, :status, :bill_amount, :agreement_amount, :odometer_start, :odometer_end, :ticket, :project, :phase, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ExpenseEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
