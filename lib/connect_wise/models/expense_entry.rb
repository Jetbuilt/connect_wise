...
module ConnectWise
  class ExpenseEntry
    attr_accessor :type, :amount, :date, :id, :expense_report, :company, :charge_to_id, :member, :payment_method, :classification, :billable_option, :location_id, :business_unit_id, :notes, :agreement, :invoice_amount, :mobile_guid, :taxes, :invoice, :currency, :status, :bill_amount, :agreement_amount, :odometer_start, :odometer_end, :ticket, :project, :phase, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::ExpenseEntry` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      acceptable_attribute_map = self.class.acceptable_attribute_map
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ExpenseEntry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [type, amount, date, id, expense_report, company, charge_to_id, charge_to_type, member, payment_method, classification, billable_option, location_id, business_unit_id, notes, agreement, invoice_amount, mobile_guid, taxes, invoice, currency, status, bill_amount, agreement_amount, odometer_start, odometer_end, ticket, project, phase, _info, custom_fields].hash
    end
