...
module ConnectWise
  class ServiceTask
    attr_accessor :id, :ticket_id, :notes, :closed_flag, :priority, :schedule, :code, :member, :resolution,
                  :child_schedule_action, :child_ticket_id, :summary, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ServiceTask` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ServiceTask`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def child_schedule_action=(child_schedule_action)
      ...
      unless validator.valid?(child_schedule_action)
        raise ArgumentError,
              "invalid value for \"child_schedule_action\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, ticket_id, notes, closed_flag, priority, schedule, code, member, resolution, child_schedule_action,
       child_ticket_id, summary, _info].hash
    end
