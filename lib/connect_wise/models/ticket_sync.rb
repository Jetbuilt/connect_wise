...
module ConnectWise
  class TicketSync
    ...
    attr_accessor :vendor_type, :integrator_login, :company, :url, :id, :user_name, :password, :psg, :problem_description_flag, :internal_analysis_flag, :resolution_flag, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::TicketSync`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, vendor_type, integrator_login, company, url, id, user_name, password, psg, problem_description_flag, internal_analysis_flag, resolution_flag, _info].hash
    end
