...
module ConnectWise
  class MenuEntry
    ...
    attr_accessor :new_window_flag, :id, :menu_location, :location_ids, :add_all_locations, :remove_all_locations, :small_menu_icon_id, :large_menu_icon_id, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::MenuEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [caption, link, new_window_flag, id, menu_location, location_ids, origin, client_id, add_all_locations, remove_all_locations, small_menu_icon_id, large_menu_icon_id, _info].hash
    end
