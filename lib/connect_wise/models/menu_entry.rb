  ...
  class MenuEntry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::MenuEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::MenuEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'new_window_flag')
        self.new_window_flag = attributes[:'new_window_flag']
      end
      ...
      if attributes.key?(:'menu_location')
        self.menu_location = attributes[:'menu_location']
      end
      ...
      if attributes.key?(:'small_menu_icon_id')
        self.small_menu_icon_id = attributes[:'small_menu_icon_id']
      end

      if attributes.key?(:'large_menu_icon_id')
        self.large_menu_icon_id = attributes[:'large_menu_icon_id']
      end
