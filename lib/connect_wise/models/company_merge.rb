  ...
  class CompanyMerge
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CompanyMerge` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CompanyMerge`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    # @param [Object] to_company_id Value to be assigned
    def to_company_id=(to_company_id)
      raise ArgumentError, 'to_company_id cannot be nil' if to_company_id.nil?
    ...
    def primary_address=(primary_address)
      ...
      unless validator.valid?(primary_address)
        raise ArgumentError, "invalid value for \"primary_address\", must be one of #{validator.allowable_values}."
      end
    ...
    def primary_contact=(primary_contact)
      ...
      unless validator.valid?(primary_contact)
        raise ArgumentError, "invalid value for \"primary_contact\", must be one of #{validator.allowable_values}."
      end
    ...
    def phone=(phone)
      ...
      unless validator.valid?(phone)
        raise ArgumentError, "invalid value for \"phone\", must be one of #{validator.allowable_values}."
      end
    ...
    def fax=(fax)
      ...
      unless validator.valid?(fax)
        raise ArgumentError, "invalid value for \"fax\", must be one of #{validator.allowable_values}."
      end
    ...
    def website=(website)
      ...
      unless validator.valid?(website)
        raise ArgumentError, "invalid value for \"website\", must be one of #{validator.allowable_values}."
      end
    ...
    def market=(market)
      ...
      unless validator.valid?(market)
        raise ArgumentError, "invalid value for \"market\", must be one of #{validator.allowable_values}."
      end
    ...
    def territory=(territory)
      ...
      unless validator.valid?(territory)
        raise ArgumentError, "invalid value for \"territory\", must be one of #{validator.allowable_values}."
      end
    ...
    def revenue=(revenue)
      ...
      unless validator.valid?(revenue)
        raise ArgumentError, "invalid value for \"revenue\", must be one of #{validator.allowable_values}."
      end
    ...
    def revenue_year=(revenue_year)
      ...
      unless validator.valid?(revenue_year)
        raise ArgumentError, "invalid value for \"revenue_year\", must be one of #{validator.allowable_values}."
      end
    ...
    def number_of_employees=(number_of_employees)
      ...
      unless validator.valid?(number_of_employees)
        raise ArgumentError, "invalid value for \"number_of_employees\", must be one of #{validator.allowable_values}."
      end
    ...
    def sic_code=(sic_code)
      ...
      unless validator.valid?(sic_code)
        raise ArgumentError, "invalid value for \"sic_code\", must be one of #{validator.allowable_values}."
      end
    ...
    def date_acquired=(date_acquired)
      ...
      unless validator.valid?(date_acquired)
        raise ArgumentError, "invalid value for \"date_acquired\", must be one of #{validator.allowable_values}."
      end
    ...
    def time_zone=(time_zone)
      ...
      unless validator.valid?(time_zone)
        raise ArgumentError, "invalid value for \"time_zone\", must be one of #{validator.allowable_values}."
      end
    ...
    def source_list=(source_list)
      ...
      unless validator.valid?(source_list)
        raise ArgumentError, "invalid value for \"source_list\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field1=(user_defined_field1)
      ...
      unless validator.valid?(user_defined_field1)
        raise ArgumentError, "invalid value for \"user_defined_field1\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field2=(user_defined_field2)
      ...
      unless validator.valid?(user_defined_field2)
        raise ArgumentError, "invalid value for \"user_defined_field2\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field3=(user_defined_field3)
      ...
      unless validator.valid?(user_defined_field3)
        raise ArgumentError, "invalid value for \"user_defined_field3\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field4=(user_defined_field4)
      ...
      unless validator.valid?(user_defined_field4)
        raise ArgumentError, "invalid value for \"user_defined_field4\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field5=(user_defined_field5)
      ...
      unless validator.valid?(user_defined_field5)
        raise ArgumentError, "invalid value for \"user_defined_field5\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field6=(user_defined_field6)
      ...
      unless validator.valid?(user_defined_field6)
        raise ArgumentError, "invalid value for \"user_defined_field6\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field7=(user_defined_field7)
      ...
      unless validator.valid?(user_defined_field7)
        raise ArgumentError, "invalid value for \"user_defined_field7\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field8=(user_defined_field8)
      ...
      unless validator.valid?(user_defined_field8)
        raise ArgumentError, "invalid value for \"user_defined_field8\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field9=(user_defined_field9)
      ...
      unless validator.valid?(user_defined_field9)
        raise ArgumentError, "invalid value for \"user_defined_field9\", must be one of #{validator.allowable_values}."
      end
    ...
    def user_defined_field10=(user_defined_field10)
      ...
      unless validator.valid?(user_defined_field10)
        raise ArgumentError, "invalid value for \"user_defined_field10\", must be one of #{validator.allowable_values}."
      end
    ...
    def billing_address=(billing_address)
      ...
      unless validator.valid?(billing_address)
        raise ArgumentError, "invalid value for \"billing_address\", must be one of #{validator.allowable_values}."
      end
    ...
    def billing_contact=(billing_contact)
      ...
      unless validator.valid?(billing_contact)
        raise ArgumentError, "invalid value for \"billing_contact\", must be one of #{validator.allowable_values}."
      end
    ...
    def tax_code=(tax_code)
      ...
      unless validator.valid?(tax_code)
        raise ArgumentError, "invalid value for \"tax_code\", must be one of #{validator.allowable_values}."
      end
    ...
    def account_number=(account_number)
      ...
      unless validator.valid?(account_number)
        raise ArgumentError, "invalid value for \"account_number\", must be one of #{validator.allowable_values}."
      end
    ...
    def billing_terms=(billing_terms)
      ...
      unless validator.valid?(billing_terms)
        raise ArgumentError, "invalid value for \"billing_terms\", must be one of #{validator.allowable_values}."
      end
    ...
    def notes=(notes)
      ...
      unless validator.valid?(notes)
        raise ArgumentError, "invalid value for \"notes\", must be one of #{validator.allowable_values}."
      end
    ...
    def sites=(sites)
      ...
      unless validator.valid?(sites)
        raise ArgumentError, "invalid value for \"sites\", must be one of #{validator.allowable_values}."
      end
    ...
    def activities=(activities)
      ...
      unless validator.valid?(activities)
        raise ArgumentError, "invalid value for \"activities\", must be one of #{validator.allowable_values}."
      end
    ...
    def opportunities=(opportunities)
      ...
      unless validator.valid?(opportunities)
        raise ArgumentError, "invalid value for \"opportunities\", must be one of #{validator.allowable_values}."
      end
    ...
    def services=(services)
      ...
      unless validator.valid?(services)
        raise ArgumentError, "invalid value for \"services\", must be one of #{validator.allowable_values}."
      end
    ...
    def projects=(projects)
      ...
      unless validator.valid?(projects)
        raise ArgumentError, "invalid value for \"projects\", must be one of #{validator.allowable_values}."
      end
    ...
    def contacts=(contacts)
      ...
      unless validator.valid?(contacts)
        raise ArgumentError, "invalid value for \"contacts\", must be one of #{validator.allowable_values}."
      end
    ...
    def documents=(documents)
      ...
      unless validator.valid?(documents)
        raise ArgumentError, "invalid value for \"documents\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [to_company_id, name, identifier, status, type, primary_address, primary_contact, phone, fax, website, market,
       territory, revenue, revenue_year, number_of_employees, sic_code, date_acquired, time_zone, source_list, user_defined_field1, user_defined_field2, user_defined_field3, user_defined_field4, user_defined_field5, user_defined_field6, user_defined_field7, user_defined_field8, user_defined_field9, user_defined_field10, billing_address, billing_contact, tax_code, account_number, billing_terms, notes, sites, activities, opportunities, services, projects, contacts, documents].hash
    end
