  ...
  class Opportunity
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Opportunity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "primary_sales_rep", primary_sales_rep cannot be nil.') if @primary_sales_rep.nil?
    ...
    def hash
      [name, primary_sales_rep, company, contact, id, expected_close_date, type, stage, status, priority, notes, probability, source, rating, campaign, secondary_sales_rep, location_id, business_unit_id, site, customer_po, pipeline_change_date, date_became_lead, closed_date, closed_by, total_sales_tax, ship_to_company, ship_to_contact, ship_to_site, bill_to_company, bill_to_contact, bill_to_site, billing_terms, tax_code, currency, company_location_id, technical_contact, _info, custom_fields].hash
    end
