...
module ConnectWise
  class Location
    attr_accessor :structure_level, :id, :owner_level_id, :manager, :reports_to, :time_zone_setup, :calendar, :override_country, :location_flag, :client_flag, :work_role_ids, :department_ids, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Location`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "structure_level", structure_level cannot be nil.') if @structure_level.nil?
