...
module ConnectWise
  class BatchEntry
    attr_accessor :id, :account_type, :name, :account_number, :debit, :credit, :cost, :item, :sales_code, :cost_of_goods_sold_account_number, :invoice, :purchase_order, :line_item, :transfer, :expense, :adjustment_detail, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::BatchEntry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.cost_of_goods_sold_account_number = attributes[:cost_of_goods_sold_account_number] if attributes.key?(:cost_of_goods_sold_account_number)
    ...
    def hash
      [id, account_type, name, account_number, debit, credit, cost, item, sales_code, cost_of_goods_sold_account_number, invoice, purchase_order, line_item, transfer, expense, adjustment_detail, _info].hash
    end
