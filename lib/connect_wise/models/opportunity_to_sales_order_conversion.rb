...
module ConnectWise
  class OpportunityToSalesOrderConversion
    attr_accessor :sales_order_id, :name, :include_all_notes_flag, :include_all_documents_flag,
                  :include_all_products_flag, :include_note_ids, :include_document_ids, :include_product_ids
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::OpportunityToSalesOrderConversion` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::OpportunityToSalesOrderConversion`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.sales_order_id = attributes[:sales_order_id] if attributes.key?(:sales_order_id)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        sales_order_id == other.sales_order_id &&
        name == other.name &&
    ...
    def hash
      [sales_order_id, name, include_all_notes_flag, include_all_documents_flag, include_all_products_flag,
       include_note_ids, include_document_ids, include_product_ids].hash
    end
