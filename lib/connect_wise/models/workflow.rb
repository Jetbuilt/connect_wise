...
module ConnectWise
  class Workflow
    ...
    attr_accessor :table_type, :id, :location, :department, :batch_interval, :batch_last_ran, :board, :connect_wise_id,
                  :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Workflow` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Workflow`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "table_type", table_type cannot be nil.') if @table_type.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] table_type Value to be assigned
    def table_type=(table_type)
      raise ArgumentError, 'table_type cannot be nil' if table_type.nil?
    ...
    def batch_frequency_unit=(batch_frequency_unit)
      ...
      unless validator.valid?(batch_frequency_unit)
        raise ArgumentError, "invalid value for \"batch_frequency_unit\", must be one of #{validator.allowable_values}."
      end
    ...
    def batch_schedule=(batch_schedule)
      ...
      unless validator.valid?(batch_schedule)
        raise ArgumentError, "invalid value for \"batch_schedule\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, table_type, id, location, department, activate_flag, batch_interval, batch_frequency_unit, batch_last_ran,
       batch_schedule, board, connect_wise_id, _info].hash
    end
