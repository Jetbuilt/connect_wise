...
module ConnectWise
  class Workflow
    ...
    attr_accessor :table_type, :id, :location, :department, :batch_interval, :batch_last_ran, :board, :connect_wise_id, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::Workflow`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [name, table_type, id, location, department, activate_flag, batch_interval, batch_frequency_unit, batch_last_ran, batch_schedule, board, connect_wise_id, _info].hash
    end
