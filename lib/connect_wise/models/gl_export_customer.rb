  ...
  class GLExportCustomer
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::GLExportCustomer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::GLExportCustomer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'state_tax_rate')
        self.state_tax_rate = attributes[:'state_tax_rate']
      end

      if attributes.key?(:'county_tax_rate')
        self.county_tax_rate = attributes[:'county_tax_rate']
      end

      if attributes.key?(:'city_tax_rate')
        self.city_tax_rate = attributes[:'city_tax_rate']
      end

      if attributes.key?(:'country_tax_rate')
        self.country_tax_rate = attributes[:'country_tax_rate']
      end

      if attributes.key?(:'composite_tax_rate')
        self.composite_tax_rate = attributes[:'composite_tax_rate']
      end
      ...
      if attributes.key?(:'state_tax_agency_xref')
        self.state_tax_agency_xref = attributes[:'state_tax_agency_xref']
      end

      if attributes.key?(:'county_tax_agency_xref')
        self.county_tax_agency_xref = attributes[:'county_tax_agency_xref']
      end

      if attributes.key?(:'city_tax_agency_xref')
        self.city_tax_agency_xref = attributes[:'city_tax_agency_xref']
      end

      if attributes.key?(:'country_tax_agency_xref')
        self.country_tax_agency_xref = attributes[:'country_tax_agency_xref']
      end

      if attributes.key?(:'composite_tax_agency_xref')
        self.composite_tax_agency_xref = attributes[:'composite_tax_agency_xref']
      end
