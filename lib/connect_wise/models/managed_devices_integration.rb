...
module ConnectWise
  class ManagedDevicesIntegration
    ...
    attr_accessor :login_by, :default_billing_level, :id, :management_it_setup_type, :default_location,
                  :default_department, :integrator_login, :match_on_serial_number_flag, :disable_new_cross_references_flag, :config_bill_customer_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ManagedDevicesIntegration` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ManagedDevicesIntegration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def login_by=(login_by)
      ...
      unless validator.valid?(login_by)
        raise ArgumentError, "invalid value for \"login_by\", must be one of #{validator.allowable_values}."
      end
    ...
    def default_billing_level=(default_billing_level)
      ...
      unless validator.valid?(default_billing_level)
        raise ArgumentError,
              "invalid value for \"default_billing_level\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, solution, login_by, default_billing_level, id, portal_url, global_login_username, global_login_password,
       management_it_setup_type, default_location, default_department, integrator_login, match_on_serial_number_flag, disable_new_cross_references_flag, config_bill_customer_flag, _info].hash
    end
