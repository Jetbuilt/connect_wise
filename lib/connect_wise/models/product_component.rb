...
module ConnectWise
  class ProductComponent
    attr_accessor :quantity, :id, :catalog_item, :hide_price_flag, :hide_item_identifier_flag, :hide_description_flag, :hide_quantity_flag, :hide_extended_price_flag, :vendor, :parent_product_item, :product_item, :price, :cost, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProductComponent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
