  ...
  class ProductComponent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::ProductComponent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProductComponent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'hide_price_flag')
        self.hide_price_flag = attributes[:'hide_price_flag']
      end
      ...
      if attributes.key?(:'hide_description_flag')
        self.hide_description_flag = attributes[:'hide_description_flag']
      end

      if attributes.key?(:'hide_quantity_flag')
        self.hide_quantity_flag = attributes[:'hide_quantity_flag']
      end
      ...
      if attributes.key?(:'parent_product_item')
        self.parent_product_item = attributes[:'parent_product_item']
      end

      if attributes.key?(:'product_item')
        self.product_item = attributes[:'product_item']
      end
    ...
    def hash
      [quantity, id, sequence_number, catalog_item, hide_price_flag, hide_item_identifier_flag, hide_description_flag, hide_quantity_flag, hide_extended_price_flag, vendor, parent_product_item, product_item, price, cost, _info].hash
    end
