...
module ConnectWise
  class CrmInfo
    attr_accessor :id, :account_manager_role, :technical_contact_role, :sales_rep_role, :field1_caption, :field2_caption, :field3_caption, :field4_caption, :field5_caption, :field6_caption, :field7_caption, :field8_caption, :field9_caption, :field10_caption, :primary_rep_caption, :secondary_rep_caption, :_info
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `ConnectWise::CrmInfo` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::CrmInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, account_manager_role, technical_contact_role, sales_rep_role, field1_caption, field2_caption, field3_caption, field4_caption, field5_caption, field6_caption, field7_caption, field8_caption, field9_caption, field10_caption, primary_rep_caption, secondary_rep_caption, _info].hash
    end
