...
module ConnectWise
  class AccountingPackageSetup
    attr_accessor :accounting_package, :id, :direct_transfer_flag, :include_invoices_flag, :invoice_format, :include_expenses_flag, :transfer_expenses_as_bill_flag, :expense_format, :suppress_memo_flag, :sync_payment_info_flag, :sync_wise_pay_payment_info_flag, :include_sales_tax_flag, :enable_tax_groups_flag, :zero_dollar_tax_amounts_flag, :include_items_flag, :inventory_soh_flag, :send_component_amount_flag, :send_uom_flag, :include_cogs_entries_flag, :include_cogs_drop_ship_flag, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::AccountingPackageSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
      ...
      self.sync_wise_pay_payment_info_flag = attributes[:sync_wise_pay_payment_info_flag] if attributes.key?(:sync_wise_pay_payment_info_flag)
      ...
      self.include_cogs_drop_ship_flag = attributes[:include_cogs_drop_ship_flag] if attributes.key?(:include_cogs_drop_ship_flag)
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      invalid_properties.push('invalid value for "accounting_package", accounting_package cannot be nil.') if @accounting_package.nil?
    ...
    def hash
      [accounting_package, id, direct_transfer_flag, include_invoices_flag, invoice_format, include_expenses_flag, transfer_expenses_as_bill_flag, expense_format, suppress_memo_flag, sync_payment_info_flag, sync_wise_pay_payment_info_flag, include_sales_tax_flag, enable_tax_groups_flag, zero_dollar_tax_amounts_flag, include_items_flag, inventory_soh_flag, send_component_amount_flag, send_uom_flag, include_cogs_entries_flag, include_cogs_drop_ship_flag, _info].hash
    end
