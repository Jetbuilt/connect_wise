...
module ConnectWise
  class AccountingPackageSetup
    attr_accessor :accounting_package, :id, :direct_transfer_flag, :include_invoices_flag, :invoice_format,
                  :include_expenses_flag, :transfer_expenses_as_bill_flag, :expense_format, :suppress_memo_flag, :sync_payment_info_flag, :sync_wise_pay_payment_info_flag, :include_sales_tax_flag, :enable_tax_groups_flag, :zero_dollar_tax_amounts_flag, :include_items_flag, :inventory_soh_flag, :send_component_amount_flag, :send_uom_flag, :include_cogs_entries_flag, :include_cogs_drop_ship_flag, :_info
    ...
    def self.attribute_map
      {
        ...
        sync_wise_pay_payment_info_flag: :syncWisePayPaymentInfoFlag,
    ...
    def self.openapi_types
      {
        ...
        sync_wise_pay_payment_info_flag: :Boolean,
    ...
    def self.openapi_nullable
      Set.new(%i[
                ...
                sync_wise_pay_payment_info_flag
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::AccountingPackageSetup` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::AccountingPackageSetup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:sync_wise_pay_payment_info_flag)
        self.sync_wise_pay_payment_info_flag = attributes[:sync_wise_pay_payment_info_flag]
      end
    ...
    def list_invalid_properties
      ...
      invalid_properties = []
      if @accounting_package.nil?
        invalid_properties.push('invalid value for "accounting_package", accounting_package cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @accounting_package.nil?
    ...
    # @param [Object] accounting_package Value to be assigned
    def accounting_package=(accounting_package)
      raise ArgumentError, 'accounting_package cannot be nil' if accounting_package.nil?
    ...
    def invoice_format=(invoice_format)
      ...
      unless validator.valid?(invoice_format)
        raise ArgumentError, "invalid value for \"invoice_format\", must be one of #{validator.allowable_values}."
      end
    ...
    def expense_format=(expense_format)
      ...
      unless validator.valid?(expense_format)
        raise ArgumentError, "invalid value for \"expense_format\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        sync_wise_pay_payment_info_flag == other.sync_wise_pay_payment_info_flag &&
    ...
    def hash
      [accounting_package, id, direct_transfer_flag, include_invoices_flag, invoice_format, include_expenses_flag,
       transfer_expenses_as_bill_flag, expense_format, suppress_memo_flag, sync_payment_info_flag, sync_wise_pay_payment_info_flag, include_sales_tax_flag, enable_tax_groups_flag, zero_dollar_tax_amounts_flag, include_items_flag, inventory_soh_flag, send_component_amount_flag, send_uom_flag, include_cogs_entries_flag, include_cogs_drop_ship_flag, _info].hash
    end
