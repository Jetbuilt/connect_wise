  ...
  class CustomReport
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CustomReport` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CustomReport`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      _module_validator = EnumAttributeValidator.new('String',
                                                     %w[Companies Finance Marketing Procurement Project Sales
                                                        ServiceDesk TimeExpense])
    ...
    # @param [Object] report_link Value to be assigned
    def report_link=(report_link)
      raise ArgumentError, 'report_link cannot be nil' if report_link.nil?
    ...
    def _module=(_module)
      validator = EnumAttributeValidator.new('String',
                                             %w[Companies Finance Marketing Procurement Project Sales ServiceDesk
                                                TimeExpense])
      unless validator.valid?(_module)
        raise ArgumentError, "invalid value for \"_module\", must be one of #{validator.allowable_values}."
      end
