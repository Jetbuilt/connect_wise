...
module ConnectWise
  class ChargeCodeInfo
    attr_accessor :id, :name, :location, :department, :expense_entry_flag, :allow_all_expense_type_flag,
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ChargeCodeInfo` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ChargeCodeInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, name, location, department, expense_entry_flag, allow_all_expense_type_flag, time_entry_flag, work_type,
       work_role, expense_type_ids, _info].hash
    end
