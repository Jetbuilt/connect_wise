...
module ConnectWise
  class ProcurementAdjustment
    ...
    attr_accessor :type, :id, :notes, :closed_flag, :closed_by, :closed_date, :adjustment_details, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::ProcurementAdjustment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [identifier, type, id, reason, notes, closed_flag, closed_by, closed_date, adjustment_details, _info].hash
    end
