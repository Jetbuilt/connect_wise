...
module ConnectWise
  class PortalConfiguration
    ...
    attr_accessor :default_flag, :company, :language, :board_ids, :agreement_type_ids, :config_type_ids, :location_ids,
                  :portal_image_copy_success_flag, :display_vendor_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::PortalConfiguration` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::PortalConfiguration`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      language_validator = EnumAttributeValidator.new('String',
                                                      %w[English Spanish French British Australian BrazilianPortuguese CanadianFrench German
                                                         NewZealand Dutch])
    ...
    def language=(language)
      ...
      unless validator.valid?(language)
        raise ArgumentError, "invalid value for \"language\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, id, default_flag, company, login_background_color, portal_background_color, menu_color, button_color,
       header_color, url, language, welcome_text, board_ids, agreement_type_ids, config_type_ids, location_ids, portal_image_copy_success_flag, display_vendor_flag, _info].hash
    end
