...
module ConnectWise
  class InvoiceCommission
    attr_accessor :id, :member, :percent, :split_percent, :adjustment, :net_amount, :amount, :invoice, :opportunity,
                  :agreement, :activity, :ticket, :project, :sales_order, :adjusted_by, :adjusted_date, :adjustment_reason, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::InvoiceCommission` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::InvoiceCommission`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, member, percent, split_percent, adjustment, net_amount, amount, invoice, opportunity, agreement, activity,
       ticket, project, sales_order, adjusted_by, adjusted_date, adjustment_reason, _info].hash
    end
