...
module ConnectWise
  class CurrencyReference
    attr_accessor :id, :symbol, :currency_code, :decimal_separator, :number_of_decimals, :thousands_separator,
                  :negative_parentheses_flag, :display_symbol_flag, :currency_identifier, :display_id_flag, :right_align, :name, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::CurrencyReference` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::CurrencyReference`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, symbol, currency_code, decimal_separator, number_of_decimals, thousands_separator,
       negative_parentheses_flag, display_symbol_flag, currency_identifier, display_id_flag, right_align, name, _info].hash
    end
