...
module ConnectWise
  class WorkflowTrigger
    attr_accessor :id, :name, :description, :has_options_flag, :has_operator_flag, :custom_field, :expected_type, :connect_wise_id, :parent_id, :parent_connect_wise_id, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::WorkflowTrigger`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, name, description, has_options_flag, has_operator_flag, custom_field, expected_type, connect_wise_id, parent_id, parent_connect_wise_id, _info].hash
    end
