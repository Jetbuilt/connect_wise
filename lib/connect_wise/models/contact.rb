  ...
  class Contact
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::Contact` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::Contact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      presence_validator = EnumAttributeValidator.new('String',
                                                      %w[NoAgent Online DoNotDisturb Away Offline])
    ...
    def gender=(gender)
      ...
      unless validator.valid?(gender)
        raise ArgumentError, "invalid value for \"gender\", must be one of #{validator.allowable_values}."
      end
    ...
    def presence=(presence)
      ...
      unless validator.valid?(presence)
        raise ArgumentError, "invalid value for \"presence\", must be one of #{validator.allowable_values}."
      end
