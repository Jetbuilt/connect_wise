...
module ConnectWise
  class ProjectWorkplanProjectPhase
    attr_accessor :id, :project_id, :description, :status, :parent_phase, :wbs_code, :mark_as_milestone_flag, :notes,
                  :start_date, :end_date, :budget_hours, :actual_hours, :billable_hours, :scheduled_hours, :scheduled_start, :scheduled_end, :scheduled_duration, :bill_phase_separately, :_info, :custom_fields
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ProjectWorkplanProjectPhase` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ProjectWorkplanProjectPhase`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def hash
      [id, project_id, description, status, parent_phase, wbs_code, mark_as_milestone_flag, notes, start_date,
       end_date, budget_hours, actual_hours, billable_hours, scheduled_hours, scheduled_start, scheduled_end, scheduled_duration, bill_phase_separately, _info, custom_fields].hash
    end
