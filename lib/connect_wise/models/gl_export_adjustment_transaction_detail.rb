...
module ConnectWise
  class GLExportAdjustmentTransactionDetail
    attr_accessor :gl_class, :description, :memo, :item, :quantity, :total, :cost, :cost_account_number,
                  :inventory_account_number, :account_number, :product_account_number
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::GLExportAdjustmentTransactionDetail` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::GLExportAdjustmentTransactionDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
      ...
      return unless attributes.key?(:product_account_number)
    ...
    def hash
      [gl_class, description, memo, item, quantity, total, cost, cost_account_number, inventory_account_number,
       account_number, product_account_number].hash
    end
