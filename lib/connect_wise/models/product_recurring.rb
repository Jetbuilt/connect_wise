...
module ConnectWise
  class ProductRecurring
    attr_accessor :recurring_revenue, :recurring_cost, :start_date, :bill_cycle_id, :bill_cycle, :cycles, :cycle_type,
                  :agreement_type
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ProductRecurring` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ProductRecurring`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def cycle_type=(cycle_type)
      ...
      unless validator.valid?(cycle_type)
        raise ArgumentError, "invalid value for \"cycle_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [recurring_revenue, recurring_cost, start_date, end_date, bill_cycle_id, bill_cycle, cycles, cycle_type,
       agreement_type].hash
    end
