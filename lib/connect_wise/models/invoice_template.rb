  ...
  class InvoiceTemplate
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::InvoiceTemplate` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::InvoiceTemplate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def valid?
      ...
      header_title_font_validator = EnumAttributeValidator.new('String',
                                                               %w[Regular RegularBold Large LargeBold ExtraLarge
                                                                  ExtraLargeBold])
    ...
    def header_logo_position=(header_logo_position)
      ...
      unless validator.valid?(header_logo_position)
        raise ArgumentError, "invalid value for \"header_logo_position\", must be one of #{validator.allowable_values}."
      end
    ...
    def header_address_position=(header_address_position)
      ...
      unless validator.valid?(header_address_position)
        raise ArgumentError,
              "invalid value for \"header_address_position\", must be one of #{validator.allowable_values}."
      end
    ...
    def header_title_position=(header_title_position)
      ...
      unless validator.valid?(header_title_position)
        raise ArgumentError,
              "invalid value for \"header_title_position\", must be one of #{validator.allowable_values}."
      end
    ...
    def header_title_font=(header_title_font)
      validator = EnumAttributeValidator.new('String',
                                             %w[Regular RegularBold Large LargeBold ExtraLarge ExtraLargeBold])
      unless validator.valid?(header_title_font)
        raise ArgumentError, "invalid value for \"header_title_font\", must be one of #{validator.allowable_values}."
      end
