...
module ConnectWise
  class WorkType
    ...
    attr_accessor :bill_time, :rate_type, :rate, :id, :hours_min, :hours_max, :round_bill_hours_to, :accrual_type,
                  :inactive_flag, :overall_default_flag, :activity_default_flag, :utilization_flag, :cost_multiplier, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::WorkType` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::WorkType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def accrual_type=(accrual_type)
      ...
      unless validator.valid?(accrual_type)
        raise ArgumentError, "invalid value for \"accrual_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, bill_time, rate_type, rate, id, hours_min, hours_max, round_bill_hours_to, accrual_type, inactive_flag,
       overall_default_flag, activity_default_flag, utilization_flag, cost_multiplier, integration_x_ref, add_all_agreement_exclusions, _info].hash
    end
