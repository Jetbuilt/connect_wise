  ...
  class WorkType
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ConnectWise::WorkType` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::WorkType`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'round_bill_hours_to')
        self.round_bill_hours_to = attributes[:'round_bill_hours_to']
      end

      if attributes.key?(:'accrual_type')
        self.accrual_type = attributes[:'accrual_type']
      end
      ...
      if attributes.key?(:'overall_default_flag')
        self.overall_default_flag = attributes[:'overall_default_flag']
      end

      if attributes.key?(:'activity_default_flag')
        self.activity_default_flag = attributes[:'activity_default_flag']
      end

      if attributes.key?(:'utilization_flag')
        self.utilization_flag = attributes[:'utilization_flag']
      end

      if attributes.key?(:'cost_multiplier')
      ...
      if attributes.key?(:'add_all_agreement_exclusions')
        self.add_all_agreement_exclusions = attributes[:'add_all_agreement_exclusions']
      end
