...
module ConnectWise
  class InvoicePayment
    attr_accessor :id, :type, :source, :invoice, :credit, :amount, :balance, :invoice_balance, :invoice_total,
                  :payment_date, :applied_by, :_info, :wise_pay_payment, :payment_sync_status, :payment_sync_date, :payment_account, :a_r_payment_account
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::InvoicePayment` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::InvoicePayment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def payment_sync_status=(payment_sync_status)
      ...
      unless validator.valid?(payment_sync_status)
        raise ArgumentError, "invalid value for \"payment_sync_status\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, type, source, invoice, credit, amount, balance, invoice_balance, invoice_total, payment_date, applied_by,
       _info, wise_pay_payment, payment_sync_status, gl_batch_id, payment_sync_date, payment_account, a_r_payment_account].hash
    end
