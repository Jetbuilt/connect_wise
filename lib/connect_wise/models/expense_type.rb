...
module ConnectWise
  class ExpenseType
    ...
    attr_accessor :amount_caption, :bill_expenses, :invoice_markup_option, :id, :reimbursement_rate,
                  :invoice_markup_amount, :advanced_amount_flag, :mileage_flag, :quantity_flag, :inactive_flag, :max_amount, :default_flag, :_info
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `ConnectWise::ExpenseType` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless acceptable_attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `ConnectWise::ExpenseType`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
    ...
    def invoice_markup_option=(invoice_markup_option)
      ...
      unless validator.valid?(invoice_markup_option)
        raise ArgumentError,
              "invalid value for \"invoice_markup_option\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [name, amount_caption, bill_expenses, invoice_markup_option, id, reimbursement_rate, invoice_markup_amount,
       advanced_amount_flag, mileage_flag, quantity_flag, inactive_flag, max_amount, integration_x_ref, default_flag, _info].hash
    end
