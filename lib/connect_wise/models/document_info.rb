...
module ConnectWise
  class DocumentInfo
    attr_accessor :id, :title, :file_name, :server_file_name, :owner, :link_flag, :image_flag, :public_flag, :html_template_flag, :read_only_flag, :size, :url_flag, :created_on_date, :document_type, :guid, :_info
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `ConnectWise::DocumentInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect unless acceptable_attribute_map.key?(k.to_sym)
    ...
    def hash
      [id, title, file_name, server_file_name, owner, link_flag, image_flag, public_flag, html_template_flag, read_only_flag, size, url_flag, created_on_date, document_type, guid, _info].hash
    end
