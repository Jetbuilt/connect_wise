...
describe 'ProjectsApi' do
  ...
  # unit tests for get_project_projects_by_id_project_workplan
  # Get ProjectWorkplan
  # @param id projectId
  # @param client_id
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_project_projects_by_id_project_workplan test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for post_project_projects_by_parent_id_apply_template_by_id
  # Post ApplyTemplate
  ...
  # @param [Hash] opts the optional parameters
  # @return [ProjectWorkplan]
  describe 'post_project_projects_by_parent_id_apply_template_by_id test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_project_projects_by_parent_id_apply_templates
  # Post ApplyTemplates
  # @param parent_id projectId
  # @param client_id
  # @param project_template List of Project Templates
  # @param [Hash] opts the optional parameters
  # @return [ProjectWorkplan]
  describe 'post_project_projects_by_parent_id_apply_templates test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
