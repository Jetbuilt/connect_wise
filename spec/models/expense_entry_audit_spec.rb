...
# Unit tests for ConnectWise::ExpenseEntryAudit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ConnectWise::ExpenseEntryAudit do
  let(:instance) { ConnectWise::ExpenseEntryAudit.new }

  describe 'test an instance of ExpenseEntryAudit' do
    it 'should create an instance of ExpenseEntryAudit' do
      expect(instance).to be_instance_of(ConnectWise::ExpenseEntryAudit)
    end
  end
